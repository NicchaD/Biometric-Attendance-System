...
namespace CustomControls
{
    internal class CheckBoxItem : ITemplate
    {
        ...
        public CheckBoxItem(bool editable, string parameterID)
        {
            readOnly = (editable == true) ? false : true;
            this.ControlID = parameterID;
        }

        /// <summary>
        /// Property to get / set the ID of the Checkbox
        /// </summary>
        ...
        void ITemplate.InstantiateIn(Control container)
        {
            ...
            box.ID = this.ControlID;	// To add the ID into Control.
        ...
        private void BindData(object sender, EventArgs e)
        {
            ...
            // Added By Srimurugan G
            // To Make the check box visible false, when the data is NULL
