...
' FileName			:	RefundRequestWebForm.aspx.vb
' Author Name		:	
' Employee ID		:	
' Email				:	
' Contact No		:	
...
'Aparna             05/02/2007          YREN-3019
'Aparna             21/04/2007          Changed calling of IDM -reports 
'Shubhrata          11/14/2007          YREN 2766             To change in the interest calculation as stated by George Brim on Nov 14th by email.
'Shubhrata          01/08/2007          NA                    To replace the hard coded value of 15000 by MaxPIAAmount as stated by Ragesh's email dated Jan 8th 2006
...
'Shubhrata          02/26/2007          YREN-3022             The Refund type should be PERS if TerminationPIA > MaxPiaAmount
'Shubhrata          03/02/2007          YREN-3118             The type of release blank should be determined by the sum of both funded and unfunded amount 
'Shubhrata          03/30/2007          YREN-3183             SPEC will be allowed only when member is vested done in accordance to mail by Mark Posey dated 29th Mar,2007
'Shubhrata          04/04/2007          NA                    Handled DBNUll condition in method LoadGeneralInfoToControls
'Shubhrata          04/09/2007          NA                    The tax rate for DISAB and SPEC should be between 20% and 100% as in the case of REG refunds--as per Mark Posey's email dated Apr 5th,2007
'Shubhrata          04/27/2007          YREN-3262             To call reports for HARD refund depending on various conditions as stated by George'e email dated 12thApr,2007.
'Aparna Samala      05/22/2007          YREN-3363-            Calling of report  Deferred Association Agreement form to be done only for vested person.
'Aparna Samala      05/22/2007          YREN-3262             Change in the calling of reports for Hardship
'Shubhrata          05/22/2007                                Plan Split Changes
'Aparna Samala      09/27/2007                              Not showing any error incase there is some prob in Reports
'Aparna Samala      11/26/2007                              Change in the Annuity Check 
'Shubhrata          01/30/2008                              'if person is non vested refund type = PERS 
'Shubhrata          01/31/2008         bug id 355(re-opened)
'Shubhrata          04/17/2008                              'New fund event status changes
'Shubhrata          05/19/2008         bug id 388           'to correct the spelling mistake in error message
'Shubhrata          05/22/2008         bug id 455           'ML will be non-terminated
'Priya              06/16/2008         NA                   'Changes made to treate Account type PE and RE like AE and RA as per mail send by Hafiz
...
'Priya              13-Jan-2009         YRS 5.0-637 and YRS 5.0-672         AC Account interest components.
'End Code Merge by Dilip on 07-05-2009
'Dilip              03/04/2009         NA                   Modification for New BA Account 
'07/20/2009			Nikunj Patel		Merged code received from Bangalore for BT-847, 849 and YRS 5.0-828, 829.
'07/21/2009			Ashish Srivastava	Merged code received from Bangalore for YRS5.0- 829.
'07/22/2009			Ashish Srivastava	Merged code received from Bangalore for YRS5.0- 829.
'08/25/2009         Sanjay Rawat        YRS 5.0-799 - Commented some parts of Refund Type 'REG and PERS'
'06/10/2009         Amit Nigam			Modified the code and created functions
'14/Sep/2009        Neeraj Singh      modified the code in function LoadGeneralInfoToControls for issue no. YRS 5.0-820
'23/Sep/2009        Neeraj SIngh      Modified fn ValidateBalanceInAccountsForVol for issue id YRS 5.0-868
'Amit Nigam            2009.09.25 	  Modified as per the additional partial request for the reports-Amit 25-09-2009
'29/Sep/2009        Neeraj Singh     modified the code in function LoadGeneralInfoToControls for issue no. YRS 5.0-820 for RDNP,PENP
'2009.09.29         Amit Nigam      Modified as per the additional partial request for the reports to display the message if the participant age is more then 70.5 and stop the generating withdrawal letter
'06/oct/2009        Amit Nigam      New Modification for Market Based Withdrawal
'13/Nov/2009        Parveen Kumar   Design Changes For Market Based Withdrawal
'16/Nov/2009        Parveen Kumar   Modifications  For Market Based Withdrawal
'17-02-2010         Amit Nigam     'Removed the if condition to fix the amount issues in case of partial offs
'15-03-2010         Amit Nigam      Added for Masking-Amit BT-469
'23-Mar-2010        Neeraj Singh    added new parameter in save request function.
'16-04-2010         Imran           Rounding Issue generated when partial checkbox check/uncheck.When partial amt is not set in TextboxPartialRetirement
'11/June/2010       Imran           Gemini:YRS 5.0-1108 -Display age in year with month format e.g.42Y/11M
'14/June/2010       Imran           BT:540 Age shoes wrong in withdrawal request screen.
'21/June/2010       Imran           BT:545 :Casting problem from decimal to string
'Neeraj Singh       06/jun/2010     Enhancement for .net 4.0
'Neeraj Singh       07/jun/2010     review changes done
'Imran              08/Dec/2010     BT:607  /YRS 5.0-1076:  Special/Disability withdrawals should not apply withdrawal rules
'IMran              14/Dec/2010     BT687/YRS 5.0-1228 : Remove unnecessary validation    
'Imran              10/Jan/2011     BT:694:  MRD Request - Phase 2  
'Imran              28/Jan/2011     BT:723-In Withdrawal Request page MRD refund type Check box enable & disable status shows wrong.
'Imran              28/Jan/2011     BT 725 :Net Amout shows wrong for MRD request in Withdrawal Request screen.
'Imran              04/Feb/2011     BT 734:Application not allowing to create Voluntary refund from Savings plan alone.
'Imran              29/Mar/2011     BT 735:handled blank message display on screen.
'Imran              30/Sep/2011     BT 936:Validation message for minimum balance required after partial or voluntary value should be pick from atsMetaConfiguration table.
'Imran              28/Nov/2011     BT 961:Taxable amount updating wrongly in atsrefrequestperplan table 
'Sanjeev            20/12/2011      BT-955: YRS 5.0-1482:Allow partial withdrawal by active person against Savings Plan
'Sanjeev            25/01/2012      BT-955: YRS 5.0-1482:Allow partial withdrawal by active person against Savings Plan
'Sanjeev            30/01/2012      BT-955: YRS 5.0-1482:Allow partial withdrawal by active person against Savings Plan
'Sanjeev            03/02/2012      BT-936: Validation message for minimum balance required after partial or voluntary value should be pick from atsMetaConfiguration table.
'Sanjeev            06/02/2012      Comment code Deleted By Sanjeev on 06/02/2012
'Sanjeev(SG)        2012.03.13      BT-1010: YRS 5.0-1552 - Withdrawals should include all prior year unsatisfied RMDs.
'Sanjeev(SG)        2012.03.23      BT-1012: YRS 5.0-1555: display message if termination befor 1/1/1996.
'Sanjeev(SG)        2012.06.01      BT-1012(Re-Opened): YRS 5.0-1555: display message if termination befor 1/1/1996.
'Sanjeev(SG)        2012.06.14      BT-1043: Additional requirement for gemini id YRS 5.0-1552.
'Sanjeev(SG)        2012.06.15      BT-1012(Re-Opened): YRS 5.0-1555: display message if termination befor 1/1/1996.
'Sanjeev(SG)        2012.07.18      BT-1053: YRS-1626: Withdrawal message for 70 1/2.
'Sanjeev(SG)        2013.01.29      BT-1671: Withdrawal screen - RMD not allowed if only YMCA side balance is available
'DInesh.k           2013.06.28      BT-1502: YRS 5.0-1746:Partial withdrawal not available if employed 
'Dinesh Kanojia(DK) 2013.10.23      BT-1502: YRS 5.0-1746:Include partial withdrawals - Re-Opened by Mark to allow partial withdrawal from TD account
'Sanjay R           2013.12.26      BT 2240:YRS 5.0-2226:modification to partial withdrawal processing
'Sanjay R           2013.03.21      BT2479/YRS 5.0-2226 : modification to partial withdrawal processing(Re-work)
'Shashank Patel     2015.01.12      BT-2737:Withdrawal observations
'Dinesh k           2015.02.15      BT:2804: YRS 5.0-2483:RL_2_FullRefundQDRO Letter not generating from YRS.
'Shashank P         2015.02.12      BT-1936/YRS 5.0-2011: No dollar limits on a disability or special withdrawal
'Anudeep A          2015.05.05      BT-2699:YRS 5.0-2441 : Modifications for 403b Loans 
'Sanjay S.          2015.06.25      BT 2903/YRS-AT-2542 - YRS bug discovered in which RMD (Required Minimum Distribution) records are being marked as eligible-yes for participants with pre-eligible (PE or RE) Fund statuses.
'Manthan Rajguru    2015.09.16      YRS-AT-2550: YRS data cleanup: copyright comments and namespace/reference (Changed the Namespace/reference from 'Infotech' to 'YMCARET')
'Pramod P pokale    2015.11.13      YRS-AT-2639: YRS enh: Withdrawals Phase2: Esign Sprint: Refund Process request prepopulate data if available - make it editable by ManagementTeam only
'Sanjay GS Rawat    2016.05.24      YRS-AT-2962 - YRS enh: Configurable Withdrawals project
'Manthan Rajguru    2016.06.16      YRS-AT-2962 - YRS enh: Configurable Withdrawals project
'Sanjay GS Rawat    2016.07.18      YRS-AT-3015 - YRS enh: Configurable Withdrawals project (YRSwebService/yrfWebsite)
'Pramod P. Pokale   2016.07.28      YRS-AT-3065 -  Hard error on partial withdrawal request. 
'Sanjay GS Rawat    2016.08.24      YRS-AT-3096 - YRS- Bug withdrawal process incorrectly updating refund type. 
'Chandra sekar      2016.09.23      YRS-AT-3164 - Support Request:special Hardship Withdrawal - how to allow contributions to continue temporarily
'Chandra sekar      2016.10.12      YRS-AT-3073 - YRS enh- Default RMD withdrawal requests to both plans (TrackIT 26866)
'Pramod P. Pokale   2016.11.21      YRS-AT-3146 - YRS enh: Fees - Partial Withdrawal Processing fee 
'Santosh Bura       2016.12.13      YRS-AT-3073 - YRS enh- Default RMD withdrawal requests to both plans (TrackIT 26866)
'Sanjay GS Rawat    2016.12.15      YRS-AT-3073 - YRS enh- Default RMD withdrawal requests to both plans (TrackIT 26866)
'Sanjay GS Rawat    2017.07.18      YRS-AT-3161 - YRS bug: Withdrawal process incorrectly updating refund type for QD participant 
'Jayaram (JT)       2018.08.27      YRS-AT-4058 - YRS enh:-correct error message for maximum withdrawal amount (TrackIT 34548)
'Santosh Bura       2018.08.27      YRS-AT-4058 - YRS enh:-correct error message for maximum withdrawal amount (TrackIT 34548)

'Sanjay GS Rawat    2019.04.08      YRS-AT-4055 - YRS enhnew aggregate YMCA and YMCA Legacy field on Withdrawal Request screen (TrackIt 34551)
'Shilpa N           2019.05.09      YRS-AT-4055 - YRS enhnew aggregate YMCA and YMCA Legacy field on Withdrawal Request screen (TrackIt 34551) 
'Shilpa N           2019.05.22      YRS-AT-4055 - Rework : To set visibility of Aggregate at Request(BA+Legacy) for active participants 
'Santosh Bura       2019.07.24      YRS-AT-2169 -  Hardship withdrawal must be available for non-participants
'***********************************************************************************************************************************
...
Public Class RefundRequestWebForm
...
#Region " Web Form Designer Generated Code "
    ...
    Dim objRefundRequest As New Refunds
...
#Region " Form Properties "
    ...
    Private Property AllowPartialRefund() As Boolean
        Get
            If Not Session("AllowPartialRefund") Is Nothing Then
                Return (CType(Session("AllowPartialRefund"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("AllowPartialRefund") = Value
        End Set
    End Property

    Private Property RetirementPlanForgrid() As Boolean
        Get
            If Not Session("RetirementPlanForgrid") Is Nothing Then
                Return (CType(Session("RetirementPlanForgrid"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("RetirementPlanForgrid") = Value
        End Set
    End Property
    Private Property SavingPlanforGrid() As Boolean
        Get
            If Not Session("SavingPlanforGrid") Is Nothing Then
                Return (CType(Session("SavingPlanforGrid"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("SavingPlanforGrid") = Value
        End Set
    End Property
    'Added By Ganesh for Partial Withdraw
    Private Property CalculatedDataTableSavingPlan() As DataTable
        Get
            If Not (Session("CalculatedDataTableSavingPlan")) Is Nothing Then
                Return (DirectCast(Session("CalculatedDataTableSavingPlan"), DataTable))
            Else
                Return Nothing
            End If
        End Get
        Set(ByVal Value As DataTable)
            Session("CalculatedDataTableSavingPlan") = Value
        End Set
    End Property
    ...
    Private Property NumRequestedAmountRetirement() As Decimal
        Get
            If Not Session("RequestedAmountRetirement") Is Nothing Then
                Return (CType(Session("RequestedAmountRetirement"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("RequestedAmountRetirement") = Value
        End Set
    End Property

    Private Property NumRequestedAmountSavings() As Decimal
        Get
            If Not Session("RequestedAmountSavings") Is Nothing Then
                Return (DirectCast(Session("RequestedAmountSavings"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("RequestedAmountSavings") = Value
        End Set
    End Property
    Private Property NumPercentageFactorofMoneyRetirementTemp() As Decimal
        Get
            If Not Session("NumPercentageFactorofMoneyRetirementTemp") Is Nothing Then
                Return (DirectCast(Session("NumPercentageFactorofMoneyRetirementTemp"), Decimal))
            Else
                Return 1.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("NumPercentageFactorofMoneyRetirementTemp") = Value
        End Set
    End Property
    Private Property NumPercentageFactorofMoneySavingsTemp() As Decimal
        Get
            If Not Session("NumPercentageFactorofMoneySavingsTemp") Is Nothing Then
                Return (DirectCast(Session("NumPercentageFactorofMoneySavingsTemp"), Decimal))
            Else
                Return 1.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("NumPercentageFactorofMoneySavingsTemp") = Value
        End Set
    End Property

    Private Property NumPercentageFactorofMoneyRetirement() As Decimal
        Get
            If Not Session("PercentageFactorofMoneyRetirement") Is Nothing Then
                Return (DirectCast(Session("PercentageFactorofMoneyRetirement"), Decimal))
            Else
                Return 1.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("PercentageFactorofMoneyRetirement") = Value
        End Set
    End Property

    Private Property NumPercentageFactorofMoneySavings() As Decimal
        Get
            If Not Session("PercentageFactorofMoneySavings") Is Nothing Then
                Return (DirectCast(Session("PercentageFactorofMoneySavings"), Decimal))
            Else
                Return 1.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("PercentageFactorofMoneySavings") = Value
        End Set
    End Property
    ...
    Private Property MinimumDistributionAmount() As Decimal
        Get
            If Not Session("MinimumDistributionAmount") Is Nothing Then
                Return (DirectCast(Session("MinimumDistributionAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property MinimumDistributionTaxRate() As Decimal
        Get
            If Not Session("MinimumDistributionTaxRate") Is Nothing Then
                Return (DirectCast(Session("MinimumDistributionTaxRate"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("MinimumDistributionTaxRate") = Value
        End Set
    End Property
    ...
    Private Property FederalTaxRate() As Decimal
        Get
            If Not Session("FederalTaxRate") Is Nothing Then
                Return (DirectCast(Session("FederalTaxRate"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("FederalTaxRate") = Value
        End Set
    End Property
    Private Property TaxWithheldRetirement() As Decimal
        Get
            If Not Session("TaxWithheldRetirement") Is Nothing Then
                Return (DirectCast(Session("TaxWithheldRetirement"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TaxWithheldRetirement") = Value
        End Set
    End Property
    Private Property TaxWithheldSavings() As Decimal
        Get
            If Not Session("TaxWithheldSavings") Is Nothing Then
                Return (DirectCast(Session("TaxWithheldSavings"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TaxWithheldSavings") = Value
        End Set
    End Property
    ...
    Private Property RefundExpiryDate() As Integer
        Get
            If Not Session("RefundExpiryDate") Is Nothing Then
                Return (DirectCast(Session("RefundExpiryDate"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property BAMaxLimit() As Decimal
        Get
            If Not Session("BAMaxLimit") Is Nothing Then
                Return (DirectCast(Session("BAMaxLimit"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("BAMaxLimit") = Value
        End Set
    End Property
    ...
    Private Property MaximumPIAAmount() As Decimal
        Get
            If Not Session("MaximumPIAAmount") Is Nothing Then
                Return (DirectCast(Session("MaximumPIAAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property MinimumPIAToRetire() As Decimal
        Get
            If Not Session("MinimumPIAToRetire") Is Nothing Then
                Return (DirectCast(Session("MinimumPIAToRetire"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("MinimumPIAToRetire") = Value
        End Set
    End Property
    ...
    Private Property NoRefundAllowed() As Boolean
        Get
            If Not Session("NoRefundAllowed") Is Nothing Then
                Return (CType(Session("NoRefundAllowed"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("NoRefundAllowed") = Value
        End Set
    End Property
    ...
    Private Property PersonAge() As Decimal
        Get
            If Not Session("PersonAge") Is Nothing Then
                Return (DirectCast(Session("PersonAge"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property PersonAgeatEndofYear() As Decimal
        Get
            If Not Session("PersonAgeatEndofYear") Is Nothing Then
                Return (DirectCast(Session("PersonAgeatEndofYear"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("PersonAgeatEndofYear") = Value
        End Set
    End Property
    ...
    Private Property TerminationPIA() As Decimal
        Get
            If Not Session("TerminationPIA") Is Nothing Then
                Return (DirectCast(Session("TerminationPIA"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property CurrentPIA() As Decimal
        Get
            If Not Session("CurrentPIA") Is Nothing Then
                Return (DirectCast(Session("CurrentPIA"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property BATermination() As Decimal
        Get
            If Not Session("BATermination") Is Nothing Then
                Return (DirectCast(Session("BATermination"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("BATermination") = Value
        End Set
    End Property
    'Added By ganeswar on july-21-2009
    Private Property CurrentBAAtRequest() As Decimal
        Get
            If Not Session("CurrentBAAtRequest") Is Nothing Then
                Return (DirectCast(Session("CurrentBAAtRequest"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("CurrentBAAtRequest") = Value
        End Set
    End Property
    'Added By ganeswar on july-21-2009
    ...
    Private Property BACurrent() As Decimal
        Get
            If Not Session("BACurrent") Is Nothing Then
                Return (DirectCast(Session("BACurrent"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("BACurrent") = Value
        End Set
    End Property
    ' BA Account YMCA PhaseV 08-04-2009 by Dilip
    ...
    Private Property YMCAAvailableAmount() As Decimal
        Get
            If Not Session("YMCAAvailableAmount") Is Nothing Then
                Return (DirectCast(Session("YMCAAvailableAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property VoluntryAmount() As Decimal
        Get
            If Not Session("VoluntryAmount") Is Nothing Then
                Return (DirectCast(Session("VoluntryAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property TDAccountAmount() As Decimal
        Get
            If Not Session("TDAccountAmount") Is Nothing Then
                Return (DirectCast(Session("TDAccountAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TDAccountAmount") = Value
        End Set
    End Property
    ...
    Private Property RefundType() As String
        Get
            If Not Session("RefundType") Is Nothing Then
                Return (DirectCast(Session("RefundType"), String))
            Else
                Return String.Empty
            End If
    ...
    Private Property SessionIsRefundPopupAllowed() As Boolean
        Get
            If Not (Session("IsRefundPopupAllowed")) Is Nothing Then
                Return (CType(Session("IsRefundPopupAllowed"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("IsRefundPopupAllowed") = Value
        End Set
    End Property
    ...
    Private Property IsTypeChoosen() As Boolean
        Get
            If Not Session("IsTypeChoosen") Is Nothing Then
                Return (CType(Session("IsTypeChoosen"), Boolean))
            Else
                Return False
            End If
        ...
        End Get
        Set(ByVal Value As Boolean)
            Session("IsTypeChoosen") = Value
        End Set
    End Property
    ''added by ruchi to keep track of the amount available
    Private Property CanRequest() As Boolean
        Get
            If Not Session("CanRequest") Is Nothing Then
                Return (CType(Session("CanRequest"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("CanRequest") = Value
        End Set
    End Property
    ...
    Private Property PlanChosen() As String
        Get
            If Not Session("PlanChosen") Is Nothing Then
                Return (DirectCast(Session("PlanChosen"), String))
            Else
                Return String.Empty
            End If
        ...
        End Get
        Set(ByVal Value As String)
            Session("PlanChosen") = Value
        End Set
    End Property
    Private Property RetirementPlan_TotalAmount() As Decimal
        Get
            If Not Session("RetirementPlan_TotalAmount") Is Nothing Then
                Return (DirectCast(Session("RetirementPlan_TotalAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("RetirementPlan_TotalAmount") = Value
        End Set
    End Property
    Private Property RetirementPlan_TotalAvailableAmount() As Decimal
        Get
            If Not Session("RetirementPlan_TotalAvailableAmount") Is Nothing Then
                Return (DirectCast(Session("RetirementPlan_TotalAvailableAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("RetirementPlan_TotalAvailableAmount") = Value
        End Set
    End Property
    Private Property SavingsPlan_TotalAvailableAmount() As Decimal
        Get
            If Not Session("SavingsPlan_TotalAvailableAmount") Is Nothing Then
                Return (DirectCast(Session("SavingsPlan_TotalAvailableAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("SavingsPlan_TotalAvailableAmount") = Value
        End Set
    End Property
    ...
    Private Property RetirementPlan_PersonTotalAmount() As Decimal
        Get
            If Not Session("RetirementPlan_PersonTotalAmount") Is Nothing Then
                Return (DirectCast(Session("RetirementPlan_PersonTotalAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("RetirementPlan_PersonTotalAmount") = Value
        End Set
    End Property
    Private Property RetirementPlan_PersonTotalAmountInitial() As Decimal
        Get
            If Not Session("RetirementPlan_PersonTotalAmountInitial") Is Nothing Then
                Return (DirectCast(Session("RetirementPlan_PersonTotalAmountInitial"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("RetirementPlan_PersonTotalAmountInitial") = Value
        End Set
    End Property
    Private Property SavingsPlan_TotalAmount() As Decimal
        Get
            If Not Session("SavingsPlan_TotalAmount") Is Nothing Then
                Return (DirectCast(Session("SavingsPlan_TotalAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("SavingsPlan_TotalAmount") = Value
        End Set
    End Property
    ...
    Private Property SavingsPlan_PersonTotalAmount() As Decimal
        Get
            If Not Session("SavingsPlan_PersonTotalAmount") Is Nothing Then
                Return (DirectCast(Session("SavingsPlan_PersonTotalAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("SavingsPlan_PersonTotalAmount") = Value
        End Set
    End Property
    Private Property SavingsPlan_PersonTotalAmountInitial() As Decimal
        Get
            If Not Session("SavingsPlan_PersonTotalAmountInitial") Is Nothing Then
                Return (DirectCast(Session("SavingsPlan_PersonTotalAmountInitial"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("SavingsPlan_PersonTotalAmountInitial") = Value
        End Set
    End Property
    ...
    Private Property AllowedRetirementPlan() As Boolean
        Get
            If Not Session("AllowedRetirementPlan") Is Nothing Then
                Return (CType(Session("AllowedRetirementPlan"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("AllowedRetirementPlan") = Value
        End Set
    End Property
    Private Property AllowedPersonalSideRefund() As Boolean
        Get
            If Not Session("AllowPersonalSideRefund") Is Nothing Then
                Return (CType(Session("AllowPersonalSideRefund"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("AllowPersonalSideRefund") = Value
        End Set
    End Property
    ...
    Private Property HardShipAllowed() As Boolean
        Get
            If Not Session("HardShipAllowed") Is Nothing Then
                Return (CType(Session("HardShipAllowed"), Boolean))
            Else
                Return False
            End If
        ...
        End Get
        Set(ByVal Value As Boolean)
            Session("HardShipAllowed") = Value
        End Set
    End Property

    Private Property CompulsoryRetirement() As Boolean
        Get
            If Not (Session("CompulsoryRetirement")) Is Nothing Then
                Return (CType(Session("CompulsoryRetirement"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("CompulsoryRetirement") = Value
        End Set
    End Property
    Private Property CompulsorySavings() As Boolean
        Get
            If Not (Session("CompulsorySavings")) Is Nothing Then
                Return (CType(Session("CompulsorySavings"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("CompulsorySavings") = Value
        End Set
    End Property
    'Shubhrata Plan Split Changes
    ...
    Private Property IsMessageCheck() As Boolean
        Get
            If Not Session("IsMessageCheck") Is Nothing Then
                Return (CType(Session("IsMessageCheck"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("IsMessageCheck") = Value
        End Set
    End Property
    'Added for validation the partial withdrawal requested amount -Amit 01 Sep 2009
    Private Property PartialMinLimit() As Decimal
        Get
            If Not Session("PartialMinLimit") Is Nothing Then
                Return (DirectCast(Session("PartialMinLimit"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("PartialMinLimit") = Value
        End Set
    End Property
    'Added for validation the partial withdrawal requested amount -Amit 01 Sep 2009
    ...
    Private Property RetirementPlanTotalAmount() As Decimal
        Get
            If Not Session("RetirementPlanTotalAmount") Is Nothing Then
                Return (DirectCast(Session("RetirementPlanTotalAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("RetirementPlanTotalAmount") = Value
        End Set
    End Property
    'Added the Property for the total available amount in the retirement plan-Amit 09-09-2009
    ...
    Private Property IsPartialRetirementAmountGivenTabOutDone() As Boolean
        Get
            If Not Session("IsPartialRetirementAmountGivenTabOutDone") Is Nothing Then
                Return (CType(Session("IsPartialRetirementAmountGivenTabOutDone"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("IsPartialRetirementAmountGivenTabOutDone") = Value
        End Set
    End Property

    Private Property IsPartialSavingsAmountGivenTabOutDone() As Boolean
        Get
            If Not Session("IsPartialSavingsAmountGivenTabOutDone") Is Nothing Then
                Return (CType(Session("IsPartialSavingsAmountGivenTabOutDone"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("IsPartialSavingsAmountGivenTabOutDone") = Value
        End Set
    End Property
    ...
    Private Property MarketBasedThreshold() As Decimal
        Get
            If Not Session("MarketBasedThreshold") Is Nothing Then
                Return (DirectCast(Session("MarketBasedThreshold"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("MarketBasedThreshold") = Value
        End Set
    End Property
    'Added the Property to check the threshold amount for market based withdrawal-Amit 10-01-2009
    'Added the Property to check the tab out fucntion took place or not-Amit 09-09-2009
    ...
    Private Property MarketBasedFirstInstPercentage() As Decimal
        Get
            If Not Session("MarketBasedFirstInstPercentage") Is Nothing Then
                Return (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("MarketBasedFirstInstPercentage") = Value
        End Set
    End Property
    Private Property MarketBasedDefferedPmtPercentage() As Decimal

        Get
            If Not Session("MarketBasedDefferedPmtPercentage") Is Nothing Then
                Return (DirectCast(Session("MarketBasedDefferedPmtPercentage"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("MarketBasedDefferedPmtPercentage") = Value
    ...
    Private Property AllowMarketBased() As Boolean
        Get
            If Not Session("AllowMarketBased") Is Nothing Then
                Return (CType(Session("AllowMarketBased"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("AllowMarketBased") = Value
        End Set
    End Property
    'Added the Property used to  check  wheteher market based withdrawal is allowed or not -Amit 10-01-2009
    ...
    Private Property AllowMarketBasedForRetirementPlan() As Boolean
        Get
            If Not Session("AllowMarketBasedForRetirementPlan") Is Nothing Then
                Return (CType(Session("AllowMarketBasedForRetirementPlan"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("AllowMarketBasedForRetirementPlan") = Value
        End Set
    End Property
    'Added the Property used to  check  wheteher market based withdrawal for Retirement Plan is allowed or not -Amit 10-26-2009
    ...
    Private Property AllowMarketBasedForSavingsPlan() As Boolean
        Get
            If Not Session("AllowMarketBasedForSavingsPlan") Is Nothing Then
                Return (CType(Session("AllowMarketBasedForSavingsPlan"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("AllowMarketBasedForSavingsPlan") = Value
        End Set
    End Property
    'Added the Property by Dilip on 02-12-2009
    Private Property Bool_NotIncludeAMMatched() As Boolean
        Get
            If Not Session("Bool_NotIncludeAMMatched") Is Nothing Then
                Return (CType(Session("Bool_NotIncludeAMMatched"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("Bool_NotIncludeAMMatched") = Value
        End Set
    End Property
    'Added the Property by Dilip on 02-12-2009
    'Added the Property by Dilip on 02-12-2009
    Private Property Bool_NotIncludeTMMatched() As Boolean
        Get
            If Not Session("Bool_NotIncludeTMMatched") Is Nothing Then
                Return (CType(Session("Bool_NotIncludeTMMatched"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("Bool_NotIncludeTMMatched") = Value
        End Set
    End Property
    'Added the Property by Dilip on 02-12-2009
    'Added the Property used to  check  wheteher market based withdrawal for Savings Plan is allowed or not -Amit 10-26-2009
    ...
    Private Property BothPlans() As Boolean
        Get
            If Not Session("BothPlans") Is Nothing Then
                Return (CType(Session("BothPlans"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("BothPlans") = Value
        End Set
    End Property
    ...
    Public Property CopyFinalDataSet() As DataSet
        Get
            If Not Session("CopyFinalDataSet") Is Nothing Then
                Return (DirectCast(Session("CopyFinalDataSet"), DataSet))
            End If
        End Get
        Set(ByVal value As DataSet)
            Session("CopyFinalDataSet") = value
        End Set
    End Property
    ...
    Private Property VoluntryAmount_Retirement_Initial() As Decimal
        Get
            If Not Session("VoluntryAmount_Retirement_Initial") Is Nothing Then
                Return (DirectCast(Session("VoluntryAmount_Retirement_Initial"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("VoluntryAmount_Retirement_Initial") = Value
        End Set
    End Property
    ...
    Private Property VoluntryAmount_Savings_Initial() As Decimal
        Get
            If Not Session("VoluntryAmount_Savings_Initial") Is Nothing Then
                Return (DirectCast(Session("VoluntryAmount_Savings_Initial"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("VoluntryAmount_Savings_Initial") = Value
        End Set
    End Property
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If Not Page.IsPostBack Then
                ...
                If Not Session("TermDateDataTabel") Is Nothing Then
                    l_TermDateDataTabel = CType(Session("TermDateDataTabel"), DataTable)
            ...
            Else
                ...
                If Session("PriorYearRMDRecords") = "Yes" Then
                    If Not Request.Form("Yes") Is Nothing Then
                        If Request.Form("Yes").Trim.ToUpper = "YES" AndAlso Session("PriorYearRMDRecords") = "Yes" Then
                            DoBtnSaveProcessing()
                            Session("PriorYearRMDRecords") = Nothing
                            Exit Sub
                        End If
                    End If
                End If
        ...
        Catch ex As Exception
            ...
            HelperFunctions.LogException("Page_Load-RefundRequestWebForm", ex)              ' SB | 2016.12.13 | YRS-AT-3073 | Handled Exception and it is been logged 
...
#Region "Functions"
        ...
        Try
            Select Case Me.RefundType.Trim.ToUpper
                ...
                Case Else
                    ...
                    Session("YMCAAvailableAmountInitial") = objRefundRequest.YMCAAvailableAmount
                    'we need this session to again set/reset the personal check box
                    ...
                    Session("HasPersonalMoney") = objRefundRequest.HasPersonalMoney
                    Session("RetirementAmountTotal") = Me.RetirementPlan_TotalAmount

                    Session("SavingsPlanAmountTotal") = Me.SavingsPlan_TotalAmount
                    Me.RetirementPlan_TotalAvailableAmount = Session("RetirementAmountTotal")
                    Me.SavingsPlan_TotalAvailableAmount = Session("SavingsPlanAmountTotal")
    ...
    Private Function LoadDefaults()
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("AccountContribution"), DataTable)
                    ...
                    Select Case l_string_FundStatus
                        ...
                        Case "QD"
                            ...
                            If Not Session("QDROParticipantAge") Is Nothing Then
                                l_QDROParticipantAge = DirectCast(Session("QDROParticipantAge"), Decimal)
                            End If
    ...
    Private Function LoadPIAAmountold()
        ...
        Try
            ...
            Me.TerminationPIA = DirectCast(Session("TerminationPIA"), Decimal)
            Me.CurrentPIA = DirectCast(Session("CurrentPIA"), Decimal)

            Me.BATermination = DirectCast(Session("BATermination"), Decimal)
            Me.BACurrent = DirectCast(Session("BACurrent"), Decimal)
            'Added by ganeswar sahoo on july 09
            Me.TextboxBATerminate.Text = DirectCast(Session("BATermination"), Decimal) ' FormatCurrency(Me.BATermination) ' FormatCurrency(Me.BATermination) ' CType(Session("BACurrent"), Decimal) '
            'Added by ganeswar sahoo on july 09
    ...
    Private Function LoadPIAAmount()
        Try
            ...
            Else
                ...
                Session("BACurrent") = l_decimal_BACurrent
                Session("BATermination") = l_decimal_BATermination
                'Added by ganeswar sahoo on july 09 for Gemini Issue
                Session("CurrentBAAtRequest") = l_decimal_BACurrentAtRequest
                Me.TextboxBATerminate.Text = DirectCast(Session("CurrentBAAtRequest"), Decimal)
                'Added by ganeswar sahoo on july 09 for Gemini Issue
                Me.TextboxTerminatePIA.Text = FormatCurrency(Me.TerminationPIA)
            End If
    ...
    Private Function DisplayAccountContribution(ByVal parameter_PlanType As String)
        ...
        Try
            ...
            '------ Added to implement WebServiece by pavan ---- Begin  -----------           
            CreateDisplayDatatables(DirectCast(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable), DirectCast(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable), Me.NumPercentageFactorofMoneySavings, Me.NumPercentageFactorofMoneyRetirement)
            ...
            '------ Added to implement WebServiece by pavan ---- Begin  -----------
            Session("DisplayConsolidatedTotal") = DataTableDisplayConsolidatedTotal
            '------ Added to implement WebServiece by pavan ---- END    -----------

            If Not Session("DisplayConsolidatedTotal") Is Nothing Then
                l_DataTable = DirectCast(Session("DisplayConsolidatedTotal"), DataTable)
                Session("InitialDisplayConsolidatedTotal") = l_DataTable
            ...
            Select Case parameter_PlanType
                Case "Retirement"
                    ...
                    Session("DisplayRetirementPlanAcctContribution") = l_DataTable_RetirementPlanAcctContribution
                ...
                Case "Savings", "Both"
                    ...
                    Session("DisplaySavingsPlanAcctContribution") = l_DataTable_SavingsPlanAcctContribution

            End Select

            Me.SetSelectedIndex(Me.DatagridConsolidateTotal, l_DataTable)
            Session("DisplayConsolidatedTotal") = l_DataTable
            ' For display
        Catch
            Throw
        End Try
    ...
    Private Function DisplayCopyAccountContributionTable(ByVal string_PlanType As String)
        ...
        Try
            ...
            Select Case string_PlanType
                Case "Retirement"
                    If Not Session("DisplayRetirementPlanAcctContribution") Is Nothing Then
                        ...
                        If l_DataTable_DisplayRetirementPlanAcctContribution Is Nothing Then
                            l_DataTable_DisplayRetirementPlanAcctContribution = DirectCast(Session("DisplayRetirementPlanAcctContribution"), DataTable)
                        End If
                    End If
                    If Not l_DataTable_DisplayRetirementPlanAcctContribution Is Nothing Then
                        ...
                        Next
                    End If
                    Session("Calculated_DisplayRetirementPlanAcctContribution") = l_CalculationDataTable_Display_DisplayRetirementPlan
                Case "Savings"
                    'Get the Calculated Data Table for Savings Plan

                    If Not Session("DisplaySavingsPlanAcctContribution") Is Nothing Then
                        ...
                        If l_DataTable_DisplaySavingsPlanAcctContribution Is Nothing Then
                            l_DataTable_DisplaySavingsPlanAcctContribution = DirectCast(Session("DisplaySavingsPlanAcctContribution"), DataTable)
                        End If
                    ...
                    If Not l_DataTable_DisplaySavingsPlanAcctContribution Is Nothing Then
                        ...
                        Next
                    End If
                    Session("Calculated_DisplaySavingsPlanAcctContribution") = l_CalculationDataTable_Display_DisplaySavingsPlan
            End Select
            ...
            If Session("OnlyRetirementPlan") = True Or Session("BothPlans") = True Then
                If Not l_CalculationDataTable_Display_DisplayRetirementPlan Is Nothing Then
            ...
            If Session("OnlySavingsPlan") = True Or Session("BothPlans") = True Then
                If Not l_DataTable_DisplaySavingsPlanAcctContribution Is Nothing Then
            ...
            Session("CalculatedDataTableDisplay") = l_DataTable_DisplayConsolidatedAcctContributions
        Catch
            Throw
        End Try
    End Function
    ...
    Private Function CopyAccountContributionTable()
        ...
        Try
            'Get the Calculated Data Table for Retirement Plan
            If Not Session("RetirementPlanAcctContribution") Is Nothing Then
                l_DataTable_RetirementPlanAcctContribution = DirectCast(Session("RetirementPlanAcctContribution"), DataTable)
            End If
            If Not l_DataTable_RetirementPlanAcctContribution Is Nothing Then
            ...
            End If
            'Get the Calculated Data Table for Savings Plan
            If Not Session("SavingsPlanAcctContribution") Is Nothing Then
                l_DataTable_SavingsPlanAcctContribution = DirectCast(Session("SavingsPlanAcctContribution"), DataTable)
            End If
            If Not l_DataTable_SavingsPlanAcctContribution Is Nothing Then
            ...
            Session("Calculated_RetirementPlanAcctContribution") = l_CalculationDataTable_RetirementPlan
            Session("Calculated_SavingsPlanAcctContribution") = l_CalculationDataTable_SavingsPlan
            Session("CalculatedDataTable") = l_DataTable_ConsolidatedAcctContributions
        Catch
            Throw
        End Try
    End Function
    ...
    Private Function LoadAccountContribution()
        ...
        Dim l_DataTable_SavingsPlanAcctContribution As DataTable
        Try
            If Not Session("AccountContribution") Is Nothing Then
                l_DataTable = DirectCast(Session("AccountContribution"), DataTable)
                Session("InitialAccountContribution") = l_DataTable
        ...
        Try
            ...
            Else
                ...
                For cnt = 0 To parameterDataTable.Rows.Count - 1
                    ...
                    ElseIf parameterDataTable.Rows(cnt)("AccountType").ToString = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)" Then
    ...
    Private Function LoadCalculatedTable1(ByVal parameterCalledBy As String)
        ...
        Try
            If parameterCalledBy = "IsRetirement" Then
                If Not Session("Calculated_RetirementPlanAcctContribution") Is Nothing Then
                    l_CalculatedDataTable = DirectCast(Session("Calculated_RetirementPlanAcctContribution"), DataTable)
                End If
            ElseIf parameterCalledBy = "IsSavings" Then
                If Not Session("Calculated_SavingsPlanAcctContribution") Is Nothing Then
                    l_CalculatedDataTable = DirectCast(Session("Calculated_SavingsPlanAcctContribution"), DataTable)
                End If
            ElseIf parameterCalledBy = "IsConsolidated" Then
                If Not Session("CalculatedDataTable") Is Nothing Then
                    l_CalculatedDataTable = DirectCast(Session("CalculatedDataTable"), DataTable)
                End If
            End If
    ...
    Private Function LoadCalculatedTable(ByVal parameterCalledBy As String)
        ...
        Try
            ...
            Select Case parameterCalledBy
                Case "IsRetirement"
                    RemoveMarketBasedRecords(parameterCalledBy, CType(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable))
                    If Not Session("Calculated_DisplayRetirementPlanAcctContribution") Is Nothing Then
                        l_CalculatedDataTable = DirectCast(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable)
                    End If
                ...
                Case "IsSavings"
                    RemoveMarketBasedRecords(parameterCalledBy, CType(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable))
                    If Not Session("Calculated_DisplaySavingsPlanAcctContribution") Is Nothing Then
                        l_CalculatedDataTable = DirectCast(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable)
                    End If
    ...
    Private Function MakeValuntryCalculationTable()
        ...
        Try
            ...
            l_CalculatedDataTable = Session("Calculated_DisplaySavingsPlanAcctContribution")
    ...
    Private Function MakeValuntryCalculationTableForDisplay(ByVal parameterIndex As Integer, ByVal parameterIsSelected As Boolean, ByVal parameterCalledBy As String, Optional ByVal parameterSelectAccounts As Boolean = False)
        ...
        Try
            ...
            Select Case parameterCalledBy
                ...
                Case "IsRetirement"
                    l_CalculatedDataTable = Session("Calculated_DisplayRetirementPlanAcctContribution")
                    If parameterIndex < 0 Then Return 0
    ...
    Private Function CalculateTotal(ByVal parameterCalledBy As String)
        ...
        Try
            ...
            If Not l_CalculatedDataTable Is Nothing Then
                ...
                If parameterCalledBy = "IsRetirement" Then
                    Session("Calculated_RetirementPlanAcctContribution") = l_CalculatedDataTable
                    'Comment code Deleted By Sanjeev on 06/02/2012
                ElseIf parameterCalledBy = "IsSavings" Then
                    Session("Calculated_SavingsPlanAcctContribution") = l_CalculatedDataTable
                    'Comment code Deleted By Sanjeev on 06/02/2012
                ElseIf parameterCalledBy = "IsConsolidated" Then
                    Session("CalculatedDataTable") = l_CalculatedDataTable
                End If
    ...
    Public Function CreateFinalDataset1()
        ...
        Try
            ...
            If Not Session("RetirementPlanAcctContribution") Is Nothing Then
                l_datatable_RetirementAccount = DirectCast(Session("RetirementPlanAcctContribution"), DataTable)
                'l_string_ymcaid = l_datatable_RetirementAccount.Rows(0)("ymcaid")
            End If
            If Not Session("CalculatedDataTable") Is Nothing Then
                l_datatable_Final = DirectCast(Session("CalculatedDataTable"), DataTable).Clone
                l_datatable = DirectCast(Session("CalculatedDataTable"), DataTable)
                l_string_ymcaid = l_datatable.Rows(0)("ymcaid").ToString()

            End If

            If Not Session("CalculatedDataTableDisplay") Is Nothing Then
                l_datatable_DisplayFinal = DirectCast(Session("CalculatedDataTableDisplay"), DataTable)
            ...
            Session("CalculatedDataTable") = l_datatable_Final
        ...
        Try
            ...
            If Not Session("CalculatedDataTableDisplay") Is Nothing Then
                ...
                If Me.RefundType <> "PART" And blnSavingsPlan = False And blnRetirementPlan = False Then
                    ...
                    l_datatable_RetirementAccount = CType(Session("RetirementPlanAcctContribution"), DataTable)
                    l_datatable_DisplayFinal = CType(Session("CalculatedDataTableDisplay"), DataTable)

                ElseIf blnRetirementPlan = True Then

                    l_datatable_RetirementAccount = GetPartialRetirementDatatable(CType(Session("RetirementPlanAcctContribution"), DataTable))
                    l_datatable_DisplayFinal = GetPartialVOlDatatable(CType(Session("CalculatedDataTableDisplay"), DataTable), True, False, 1) 'Me.NumPercentageFactorofMoneyRetirement)

                ElseIf blnSavingsPlan = True Then
                    l_datatable_DisplayFinal = GetPartialVOlDatatable(CType(Session("CalculatedDataTableDisplay"), DataTable), False, True, 1) 'Me.NumPercentageFactorofMoneySavings
                End If
            ...
            ElseIf blnRetirementPlan = True Then
                l_datatable_Final.AcceptChanges()
                Me.Session("CalculatedDataTableRetirementPlan") = l_datatable_Final
                objRefundRequest.CalculateTotalForDisplay(l_datatable_Final, False)
            ElseIf blnSavingsPlan = True Then
                l_datatable_Final.AcceptChanges()
                Me.Session("CalculatedDataTableSavingPlan") = l_datatable_Final
    ...
    Private Function CalculateTotalForDisplay(ByVal parameterCalledBy As String)
        ...
        Try
            ...
            ElseIf parameterCalledBy = "IsConsolidated" Then
                If Not Session("CalculatedDataTableDisplay") Is Nothing Then
                    l_CalculatedDataTable = DirectCast(Session("CalculatedDataTableDisplay"), DataTable)
                    'Code Added by Dinesh on 30/07/2013
                    l_CalculatedDataTable = objRefundRequest.CalculateTotalForDisplay(l_CalculatedDataTable, True)
                End If
            End If
            ...
            If Not l_CalculatedDataTable Is Nothing Then
                ...
                If parameterCalledBy = "IsRetirement" Then
                    Session("Calculated_DisplayRetirementPlanAcctContribution") = l_CalculatedDataTable
                    ...
                    End If
                ElseIf parameterCalledBy = "IsSavings" Then
                    Session("Calculated_DisplaySavingsPlanAcctContribution") = l_CalculatedDataTable
                ...
                ElseIf parameterCalledBy = "IsConsolidated" Then
                    Session("CalculatedDataTableDisplay") = l_CalculatedDataTable
    ...
    Private Function CheckForDistributionDate() As Boolean
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("Member Employment"), DataTable)
    ...
    Public Function CallReports() As String
        ...
        Try
            ...
            Session("R_ReportToLoad") = Nothing
            ...
            For Each RefRequestId As String In RefRequestIds
                ...
                If Me.RefundType = "HARD" Then
                    ...
                    If Not Session("l_dataTable_AccountContribution_NonFunded") Is Nothing Then
                        l_dataTable_AccountContribution_NonFunded = DirectCast(Session("l_dataTable_AccountContribution_NonFunded"), DataTable)
                        ...
                        Session("AccountContribution_NonFunded_Total") = Session("AccountContribution_NonFunded_Total") + l_decimal_Total
                    End If
                End If
                ...
                If Me.RefundType.Trim() = "HARD" Then
                    If Not Session("TotalAmtForReleaseBlnk") Is Nothing Then
                        'l_double_totalamtforreleaseblnk = Convert.ToDouble(Session("TotalAmtForReleaseBlnk"))
                        l_double_totalamtforreleaseblnk = l_double_totalamtforreleaseblnk + Convert.ToDouble(Session("TotalAmtForReleaseBlnk"))
                    End If
                Else
                ...
                If Not Session("AccountContribution_NonFunded_Total") Is Nothing Then
                    ...
                    l_double_totalamtforreleaseblnk = l_double_totalamtforreleaseblnk + Convert.ToDouble(Session("AccountContribution_NonFunded_Total"))
                End If
            Next
            ...
            dsPersonDetails = DirectCast(Session("PersonInformation"), DataSet)
            ...
            Select Case sRefundType
                ...
                Case "HARD"
                    ...
                    If CType(Me.TDAccountAmount, Double) > 0.0 Then
                        ...
                        If CType(Session("ReportHWL5"), Boolean) = True Then
                            l_StringReportName = "HWL_5_TDAndOtherAcc.rpt"
                            Session("ReportHWL5") = Nothing
                        Else
        ...
        Catch ex As Exception
            ...
            HelperFunctions.LogException("RefundRequestWebForm-CallReports", ex)
    ...
    Private Function GetDestinationFolderName() As String
        ...
        Catch ex As Exception
            HelperFunctions.LogException("RefundRequestWebForm-GetDestinationFolderName", ex)
    ...
    Private Function GenerateFileName(ByVal p_StringIndex As String) As String
        ...
        Catch ex As Exception
            HelperFunctions.LogException("RefundRequestWebForm-GenerateFileName", ex)
            Return ""
        End Try
    End Function
    ...
    Private Function CreatePersIdxForTower(ByVal p_StringFilePath As String, ByVal p_StringIndexFileName As String, ByVal p_StringFundId As String, ByVal p_StringSSNo As String, ByVal p_StringFirstName As String, ByVal p_StringMiddleName As String, ByVal p_StringLastName As String, ByVal p_StringLevel As String, ByVal p_StringDocCode As String, ByVal p_StringStaffFL As String, ByVal p_StringTabCode As String) As Boolean
        ...
        Try
            ...
            Return True
        Catch ex As Exception
            HelperFunctions.LogException("RefundRequestWebForm-CreatePersIdxForTower", ex)
            If l_BoolFileOpened = True Then l_StreamWriter.Close()
            Return False
        End Try
    End Function
    ...
    Public Function FormatCurrency(ByVal paramNumber As Decimal) As String
        ...
        Catch ex As Exception
            HelperFunctions.LogException("RefundRequestWebForm-FormatCurrency", ex)
            Return paramNumber
        End Try
    ...
    Private Function GetConsolidatedTotal()
        ...
        Try
            l_dt_GetConsolidatedTotal = DirectCast(Session("DisplayConsolidatedTotal"), DataTable)
            l_dt_DisplayRetirementPlan = DirectCast(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable)
            l_dt_DisplaySavingsPlan = DirectCast(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable)
    ...
    Private Function MakeDisplayCalculationDataTables(ByVal NeedRetirementPlan As Boolean, ByVal NeedSavingsPlan As Boolean)
        ...
        Try
            l_dt_ConsolidatedDataTable = DirectCast(Session("CalculatedDataTableDisplay"), DataTable).Clone()
            If NeedRetirementPlan = True Then
                l_dt_RetPlanCalculatedDataTable = DirectCast(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable)
            ...
            If NeedSavingsPlan = True Then
                l_dt_SavingsPlanCalculatedDataTable = DirectCast(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable)
            ...
            End If
            Session("CalculatedDataTableDisplay") = l_dt_ConsolidatedDataTable
            Me.DatagridConsolidateTotal.DataSource = l_dt_ConsolidatedDataTable
            Me.Session("CalculatedDataTableRetirementPlan") = l_dt_ConsolidatedDataTable
            Me.Session("CalculatedDataTableSavingPlan") = l_dt_ConsolidatedDataTable
            Me.DatagridConsolidateTotal.DataBind()
    ...
    Public Function BindFinalDatagrid()
        ...
        Try
            MarketAccountType = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)"
            'Added By Parveen for Design Changes For Market Based Withdrawal on 13/Nov/2009
            If Not Session("CalculatedDataTableDisplay") Is Nothing Then
                l_datatable = DirectCast(Session("CalculatedDataTableDisplay"), DataTable)
                If l_datatable.Rows.Count > 0 Then
        ...
        Try
            ...
            If Not Me.SessionStatusType = String.Empty Then
                If Me.IsTerminated = True Then
                    ...
                    Session("AnnuityExists") = l_Dataset_AnnuityDetails
                    'by Aparna 14/11/2007
                End If
            End If
    ...
    Public Function ValidateAnnuityCheck1(ByVal parameterCalledBy As String) As Boolean
        ...
        Try
            ...
            If Not Session("AnnuityExists") Is Nothing Then
                'if 0 then annuity doesnt exist ,if 1 then it exists
                l_integer_Annuity = DirectCast(Session("AnnuityExists"), Integer)
                ...
                If l_integer_Annuity = 0 Then
                    If parameterCalledBy = "IsRetirement" Then
                        ...
                        End If
                    ElseIf parameterCalledBy = "IsSavings" Then
                        l_decimal_Savingstotal = CType(Session("SavingsPlanAmountTotal"), Decimal)
    ...
    Public Function IsAnnuityExists(ByVal parameterCalledBy As String) As Boolean
        ...
        Try
            ...
            If Not Session("AnnuityExists") Is Nothing Then
                l_datasetAnnuityCheck = DirectCast(Session("AnnuityExists"), DataSet)
    ...
    Public Function ValidateAnnuityExistsORMinimumPIAtoRetire(ByVal parameterCalledBy As String) As Boolean
        ...
        Try
            ...
            ElseIf l_bool_AnnuityExists = False And parameterCalledBy = "IsSavings" Then
                ' l_decimal_Savingstotal = CType(Session("SavingsPlanAmountTotal"), Decimal)
                'Start : AA:05.11.2015 BT-2699 - YRS 5.0-2411: Added to exclude ln and ld accounts while validating
                dtSavingsPlanAccount = Session("SavingsPlanAcctContribution")
                If dtSavingsPlanAccount.Select("AccountType = 'LN' OR AccountType = 'LD'").Count > 0 Then
                    isLNLDExists = True
                End If
                l_decimal_Savingstotal = CType(Session("SavingsTotal"), Decimal)
                If Me.SavingsPlan_TotalAmount > 0 Then
    ...
    Private Function ValidateBalanceInAccountsForVol(Optional ByVal parameterCompulsoryVol As Boolean = False) As String
        Try
            ...
            If Not Session("FinalDataSet") Is Nothing Then
                FinalDataSet = Session("FinalDataSet")
    ...
    Private Function EnableDisablePartialCheckBox()
        ...
        '------ Added to implement WebServiece by pavan ---- Begin  -----------
        l_DataTable = DirectCast(Session("MemberRefundRequestDetails"), DataTable)
        '------ Added to implement WebServiece by pavan ---- END    -----------
        If Not l_DataTable Is Nothing Then
    ...
    Private Function SetcheckboxPartialRetirement()
        Try
            ...
            If CType(Session("VoluntryAmount_Retirement_Initial"), Decimal) < 0.01 Then
                Me.CheckboxVoluntryAccounts.Enabled = False
            Else
                Me.CheckboxVoluntryAccounts.Enabled = True
            End If

            If CType(Session("VoluntryAmount_Savings_Initial"), Decimal) < 0.01 Then
                Me.CheckboxSavingsVoluntary.Enabled = False
                Me.CheckboxSavingsVoluntary.Checked = False
            Else
                Me.CheckboxSavingsPlan.Enabled = True
...
#End Region
    ...
    Private Function ClearSession() As Boolean
        Try
            Session("VoluntaryAmountInitial") = Nothing
            Session("YMCAAvailableAmountInitial") = Nothing
            Session("VoluntryAmount_Savings_Initial") = Nothing
            Session("VoluntryAmount_Retirement_Initial") = Nothing
            Session("HardNotAllowed") = Nothing
            Session("OnlySavingsPlan") = Nothing
            Session("OnlyRetirementPlan") = Nothing
            Session("RetirementAmountTotal") = Nothing
            Session("SavingsPlanAmountTotal") = Nothing
            Session("HasPersonalMoney") = Nothing
            Session("CompulsorySavings") = Nothing
            Session("CompulsoryRetirement") = Nothing
            Session("FederalTaxRate") = Nothing 'Manthan | 2016.06.16 | YRS-AT-2962 | Setting session value to nothing
    ...
    Private Function PartialDisplayCopyAccountContributionTable()
        ...
        Try
            ...
            If Not Session("DisplayRetirementPlanAcctContribution") Is Nothing Then
                l_DataTable_DisplayRetirementPlanAcctContribution = objRefundRequest.DataTableDisplayRetirementPlan
                If l_DataTable_DisplayRetirementPlanAcctContribution Is Nothing Then
                    l_DataTable_DisplayRetirementPlanAcctContribution = CType(Session("DisplayRetirementPlanAcctContribution"), DataTable)
                End If
            End If
            If Not l_DataTable_DisplayRetirementPlanAcctContribution Is Nothing Then
            ...
            Select Case string_WithdrawalType
                ...
                Case "VolRet"
                    ...
                    If parameter_checked = True Then
                        ...
                        '------ Added to implement WebServiece by pavan ---- Begin  -----------
                        Session("Calculated_DisplayRetirementPlanAcctContribution") = Session("VoluntryRetirementDatatable")
                        '------ Added to implement WebServiece by pavan ---- END    -----------
                        Me.DisplayAccountContribution("Retirement")
                        '------ Commented for WebServiece by pavan ---- Begin  -----------
                ...
                Case "VolSav"
                    ...
                    If parameter_checked = True Then
                        If Session("VoluntryAmount_Savings_Initial") > 0 Then
                            Me.CheckboxSavingsVoluntary.Checked = True
                        End If
                        Me.IsTypeChoosen = True
                        Me.CheckboxSavingsPlan.Enabled = True
                ...
                Case "Hardship"
                    ...
                    If parameter_checked = True Then
                        ...
                        '------ Added to implement WebServiece by pavan ---- END    -----------
                        '------ Added to implement WebServiece by pavan ---- Begin  -----------
                        Session("Calculated_DisplaySavingsPlanAcctContribution") = Session("HardshipDatatable")
                        '------ Added to implement WebServiece by pavan ---- END    -----------
                        Me.NumPercentageFactorofMoneySavings = 1.0
                        Me.DisplayAccountContribution("Savings")
                        'Me.DisplayCopyAccountContributionTable("Retirement")
                        ...
                        If parameter_Type = "S" Then
                            If CType(Session("VoluntryAmount_Retirement_Initial"), Decimal) > 0 Then
                                Me.CheckboxVoluntryAccounts.Checked = True
                                Me.CheckboxVoluntryAccounts.Enabled = False
    ...
    Private Function AllowVoluntaryWithdrawalOnRetirement()
        Try
            If Session("VoluntryAmount_Retirement_Initial") > 0 Then
    ...
    Private Function SetVisiblityofTextBoxesAsPerPlan()
        Try
            ...
            If CheckboxRegular.Checked = True Or _
                ...
                fillNetValuesforAddedControls(Me.Session("Calculated_DisplayRetirementPlanAcctContribution"))
            ...
            And Not TextboxPartialSavings.Text = String.Empty) Then
                fillNetValuesforAddedControlsSavings(Me.Session("Calculated_DisplaySavingsPlanAcctContribution"))
    ...
    Private Function SetCheckBoxOnLoad1()
        ...
        Try
            ...
            Else
                ...
                '******************************************
                If CType(Session("VoluntaryAmountInitial"), Decimal) < 0.01 Then
                    Me.CheckboxVoluntryAccounts.Enabled = False
                Else
                    Me.CheckboxVoluntryAccounts.Enabled = True
                End If
            ...
            If Me.SavingsPlan_TotalAmount <= 0 Then
                ...
                Me.CheckboxSavingsPlan.Enabled = False
                Session("OnlySavingsPlan") = Nothing
                Session("BothPlans") = Nothing
                Session("OnlyRetirementPlan") = True
            ...
            If Me.TerminationPIA >= Me.MaximumPIAAmount And Me.IsVested = True And (Me.RetirementPlan_PersonTotalAmount + Me.SavingsPlan_PersonTotalAmount) = 0 Then
                ...
                Dim l_DataTable As New DataTable
                Dim l_DataRow As DataRow
                l_DataTable = Session("PersonInformation").Tables("Member Employment")
                If l_DataTable.Rows.Count > 0 Then
...
#Region " Save Refund "
    ...
    Private Function SaveRefund() As Boolean
        ...
        Try
            ...
            If Not (Session("Calculated_DisplayRetirementPlanAcctContribution_Final") Is Nothing And Session("Calculated_DisplaySavingsPlanAcctContribution_Final") Is Nothing) Then
                dt_Retirement = DirectCast(Session("Calculated_DisplayRetirementPlanAcctContribution_Final"), DataTable)
                dt_Savings = DirectCast(Session("Calculated_DisplaySavingsPlanAcctContribution_Final"), DataTable)
            Else
                dt_Retirement = DirectCast(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable)
                dt_Savings = DirectCast(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable)
            End If
            ...
            If CheckboxMRDRetirement.Checked Or CheckboxMRDRetirementCurrentYear.Checked Or CheckboxMRDSavings.Checked Or CheckboxMRDSavingsCurrentYear.Checked Then
                If FinalDataSet Is Nothing Then
                    Me.FinalDataSet = Session("FinalDataSet")
                End If
            ...
            Else
                ...
                objWebServiceReturn = objService.SaveRefundRequestForYRS(SaveArraylistPropertys(ArraySlectedRetirementAccounts, ArraySlectedSavingsAccounts), True)
            ...
            'Comment code Deleted By Sanjeev on 06/02/2012
            Session("TotalAmtForReleaseBlnk") = Nothing
            'Comment code Deleted By Sanjeev on 06/02/2012
...
#Region " Minimum Distribution "
    ...
    Private Function GetAccountBreakDownType(ByVal parameterAccountType As String, ByVal parameterPersonal As Boolean, ByVal parameterYMCA As Boolean, ByVal parameterPreTax As Boolean, ByVal parameterPostTax As Boolean) As String
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("AccountBreakDown"), DataTable)
...
#Region " Refund Functions "
    ...
    Private Function refundActions(ByVal parameterCalledBy As String)
        ...
        Try
            If parameterCalledBy = "IsRetirement" Then
                Session("Calculated_RetirementPlanAcctContribution") = l_ContributionDataTable
                Me.CalculateTotal("IsRetirement")
                Me.LoadCalculatedTable("IsRetirement")
                Me.SetSelectedIndex(Me.DataGridAccContributionRetirement, l_ContributionDataTable)
            ElseIf parameterCalledBy = "IsSavings" Then
                Session("Calculated_SavingsPlanAcctContribution") = l_ContributionDataTable
    ...
    Private Function refundActionsForDisplay(ByVal parameterCalledBy As String)
        ...
        Try
            If parameterCalledBy = "IsRetirement" Then
                ...
                '------ Added to implement WebServiece by pavan ---- Begin  -----------
                l_ContributionDataTable = Session("Calculated_DisplayRetirementPlanAcctContribution")
                '------ Added to implement WebServiece by pavan ---- END    -----------
                Me.CalculateTotalForDisplay("IsRetirement")
                Me.LoadCalculatedTable("IsRetirement")
                Me.SetSelectedIndex(Me.DataGridAccContributionRetirement, l_ContributionDataTable)
            ElseIf parameterCalledBy = "IsSavings" Then
                'Comment code Deleted By Sanjeev on 06/02/2012
                '------ Added to implement WebServiece by pavan ---- Begin  -----------
                l_ContributionDataTable = Session("Calculated_DisplaySavingsPlanAcctContribution")
                '------ Added to implement WebServiece by pavan ---- END    -----------
                Me.CalculateTotalForDisplay("IsSavings")
                Me.LoadCalculatedTable("IsSavings")
                Me.SetSelectedIndex(Me.DataGridAccContributionSavings, l_ContributionDataTable)
            ElseIf parameterCalledBy = "IsConsolidated" Then
                Session("CalculatedDataTableDisplay") = l_ContributionDataTable
...
#Region "Events"
    ...
    Private Sub OnCheckChanged(ByVal sender As Object, ByVal e As EventArgs) Handles datagridCheckBox.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-datagridCheckBox.CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub TextboxTaxRate_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextboxTaxRate.TextChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-TextboxTaxRate.TextChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub ButtonCalculate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-ButtonCalculate_Click", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub ButtonSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        Try
            ...
            '------ Added to implement WebServiece by pavan ---- Begin  -----------
            BindDataGrid("IsRetirement", CType(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable))
            BindDataGrid("IsSavings", CType(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable))
            '------ Added to implement WebServiece by pavan ---- END    -----------
            ...
            If objRefundRequest.IsSaveProcessComplete = False Then
                ...
                If (Not drPriorMRD Is Nothing AndAlso drPriorMRD.Length > 0 AndAlso objRefundProcess.IsTerminatedEmployment()) Then  '2015.06.25/SR-  BT 2903/YRS-AT-2542 - YRS bug discovered in which RMD (Required Minimum Distribution) records are being marked as eligible-yes for participants with pre-eligible (PE or RE) Fund statuses.
                    ...
                    Session("PriorYearRMDRecords") = "Yes"
                    Exit Sub
                Else
                    DoBtnSaveProcessing()
                End If
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-ButtonSave_Click", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub CheckboxVoluntryAccounts_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckboxVoluntryAccounts.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxVoluntryAccounts_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub CheckboxHardship_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckboxHardship.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxHardship_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub CheckboxPersonalSide_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            If CheckboxExcludeYMCA.Checked = True Then
                ...
                If Session("OnlyRetirementPlan") = True Then
                    Me.PersonalRefund("RetirementPlan")
                ElseIf Session("OnlySavingsPlan") = True Then
                    Me.PersonalRefund("SavingsPlan")
                ElseIf Session("BothPlans") = True Then
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxPersonalSide_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub CheckboxSpecial_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckboxSpecial.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxSpecial_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub CheckboxDisability_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxDisability.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxDisability_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub DataGridAccContributionRetirement_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGridAccContributionRetirement.ItemDataBound
        Try
            ...
            If e.Item.Cells(2).Text = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)" Then
    ...
    Private Sub datagridCheckBox_Savings_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles datagridCheckBox_Savings.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-datagridCheckBox_Savings_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub CheckboxExcludeYMCA_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxExcludeYMCA.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxExcludeYMCA_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub CheckboxPartialSavings_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxPartialSavings.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxPartialSavings_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
    ...
    Private Sub CheckboxPartialRetirement_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxPartialRetirement.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxPartialRetirement_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub TextboxPartialRetirement_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextboxPartialRetirement.TextChanged
        ...
        Try
            ...
            Else
                ...
                ElseIf TextboxPartialRetirement.Text > 0 Then
                    Session("RetirementAccountTypeAdjusted") = Nothing
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-TextboxPartialRetirement_TextChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub TextboxPartialSavings_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextboxPartialSavings.TextChanged
        ...
        Try
            ...
            Else
                ...
                ElseIf TextboxPartialSavings.Text > 0 Then
                    Session("SavingsAccountTypeAdjusted") = Nothing
                    Me.NumRequestedAmountSavings = TextboxPartialSavings.Text
                    'START: Added By Sanjeev on 31-01-2012 for BT-955
                    'onTextboxPartialSavings()
                    If (Me.SessionStatusType.Trim.ToUpper = "AE" Or Me.SessionStatusType.Trim.ToUpper = "RA") AndAlso CheckboxSavingsVoluntary.Enabled = True Then
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-TextboxPartialSavings_TextChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub CheckboxSavingsVoluntary_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxSavingsVoluntary.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxSavingsVoluntary_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
...
#Region "Modified - Reg Check Box EVent"
    ...
    Private Sub CheckboxRegular_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckboxRegular.CheckedChanged
        ...
        Catch ex As Exception
            ...
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxRegular_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
...
#Region "Plan Split Changes"
    ...
    Private Sub CheckboxRetirementPlan_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxRetirementPlan.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxRetirementPlan_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Function GetConsolidatedAvailableContributions()
        Try
            ...
            If Session("OnlySavingsPlan") = True Then
                If Not Session("SavingsPlanAcctContribution") Is Nothing Then
                    l_DataTable_SavingsPlanAcctContribution = DirectCast(Session("SavingsPlanAcctContribution"), DataTable)
                    Session("AccountContribution") = l_DataTable_SavingsPlanAcctContribution
                    Me.CopyAccountContributionTable()
                End If
            ElseIf Session("OnlyRetirementPlan") = True Then
                If Not Session("RetirementPlanAcctContribution") Is Nothing Then
                    l_DataTable_RetirementPlanAcctContribution = DirectCast(Session("RetirementPlanAcctContribution"), DataTable)
                    Session("AccountContribution") = l_DataTable_RetirementPlanAcctContribution
                    Me.CopyAccountContributionTable()
                End If
            ElseIf Session("BothPlans") = True Then
                If Not Session("InitialAccountContribution") Is Nothing Then
                    l_DataTable_ConsolidatedAcctContribution = DirectCast(Session("InitialAccountContribution"), DataTable)
                    Session("AccountContribution") = l_DataTable_ConsolidatedAcctContribution
                    Me.CopyAccountContributionTable()
                End If
            End If
    ...
    Private Function GetConsolidatedAvailableContributionsForDisplay()
        Try
            ...
            If Session("OnlySavingsPlan") = True Then
                If Not Session("DisplaySavingsPlanAcctContribution") Is Nothing Then
                    l_DataTable_SavingsPlanAcctContribution = DirectCast(Session("DisplaySavingsPlanAcctContribution"), DataTable)
                    Session("AccountContributionForDisplay") = l_DataTable_SavingsPlanAcctContribution
                    'Me.DisplayCopyAccountContributionTable()
                    Me.DisplayCopyAccountContributionTable("Savings")
                End If
            ElseIf Session("OnlyRetirementPlan") = True Then
                If Not Session("DisplayRetirementPlanAcctContribution") Is Nothing Then
                    l_DataTable_RetirementPlanAcctContribution = DirectCast(Session("DisplayRetirementPlanAcctContribution"), DataTable)
                    Session("AccountContributionForDisplay") = l_DataTable_RetirementPlanAcctContribution
                    'Me.DisplayCopyAccountContributionTable()
                    Me.DisplayCopyAccountContributionTable("Retirement")
                End If
            ElseIf Session("BothPlans") = True Then
                If Not Session("InitialAccountContribution") Is Nothing Then
                    l_DataTable_ConsolidatedAcctContribution = DirectCast(Session("InitialAccountContribution"), DataTable)
                    Session("AccountContributionForDisplay") = l_DataTable_ConsolidatedAcctContribution
                    'Me.DisplayCopyAccountContributionTable()
                    Me.DisplayCopyAccountContributionTable("Retirement")
                    Me.DisplayCopyAccountContributionTable("Savings")
                End If
    ...
    Private Sub CheckboxSavingsPlan_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxSavingsPlan.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxSavingsPlan_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
             ...
             Or (CheckboxPartialRetirement.Checked = True And TextboxPartialRetirement.Text.Trim.Length = 0) Then
                    ...
                    If Not l_RetDataTable Is Nothing Then
                        For cnt = 0 To l_RetDataTable.Rows.Count - 1
                            If l_RetDataTable.Rows(cnt)("AccountType").ToString = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)" Then
             ...
             Or (CheckboxPartialSavings.Checked = True And TextboxPartialSavings.Text.Trim.Length = 0) Then
                    ...
                    If Not l_SavingsDataTable Is Nothing Then
                        For cnt = 0 To l_SavingsDataTable.Rows.Count - 1
                            If l_SavingsDataTable.Rows(cnt)("AccountType").ToString = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)" Then
...
#Region "Implementing WebServiece"
    ...
    Private Function SetGlobalFlags(ByVal strPlanType As String)
        Try
            ...
            If strPlanType = "BOTH" Then
                Session("Calculated_DisplayRetirementPlanAcctContribution") = OriginalDataSet.Tables("RetirementPlanTable")
                Session("Calculated_DisplaySavingsPlanAcctContribution") = OriginalDataSet.Tables("SavingPlanTable")
            ...
            Session("CalculatedDataTableDisplay") = OriginalDataSet.Tables("CalculatedDataTableDisplay")
            Session("MemberRefundRequestDetails") = OriginalDataSet.Tables("MemberRefundRequestDetails")
            ' Session("ContributionDataTable") = OriginalDataSet.Tables("ContributionDataTable")
            Session("VoluntryRetirementDatatable") = OriginalDataSet.Tables("VoluntryRetirementDatatable")
            Session("HardshipDatatable") = OriginalDataSet.Tables("HardshipDatatable")
    ...
    Public Sub MakeFinalDataTables(ByVal parameterCalledBy As String)
        ...
        Try
            MarketAccountType = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)"
            If parameterCalledBy = "IsRetirement" Then
                l_CalculatedRetirementDataTable = Session("Calculated_DisplayRetirementPlanAcctContribution")
                ...
                Next
                Session("Calculated_DisplayRetirementPlanAcctContribution_Final") = l_DataTable_RetirementDataTable
            End If
            If parameterCalledBy = "IsSavings" Then
                l_CalculatedSavingsDataTable = Session("Calculated_DisplaySavingsPlanAcctContribution")
                ...
                Next
                Session("Calculated_DisplaySavingsPlanAcctContribution_Final") = l_DataTable_SavingsDataTable
            End If
        Catch
            Throw
        End Try
    ...
    Private Sub ResetGridData()
        ...
        RetRows = CType(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable).Select("Selected=False")
        SavRows = CType(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable).Select("Selected=False")
        If Not DisplaydataSet Is Nothing Then
            Session("Calculated_DisplayRetirementPlanAcctContribution") = DisplaydataSet.Tables("RetirementPlanTable")
            Session("Calculated_DisplaySavingsPlanAcctContribution") = DisplaydataSet.Tables("SavingPlanTable")
        End If
        If RetRows.Length > 0 Then
            For cnt = 0 To RetRows.Length - 1
                CType(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable).Select("AccountType='" & RetRows(cnt)("AccountType").ToString() & "'")(0)("Selected") = False
            Next
        End If
        If SavRows.Length > 0 Then
            For cnt = 0 To SavRows.Length - 1
                CType(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable).Select("AccountType='" & SavRows(cnt)("AccountType").ToString() & "'")(0)("Selected") = False
            Next
        End If
    End Sub
    '------ Added to implement WebServiece by pavan ---- END    -----------
#End Region
    ...
    Private Sub CheckboxMRDRetirement_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxMRDRetirement.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxMRDRetirement_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub CheckboxMRDSavings_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxMRDSavings.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxMRDSavings_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub CheckboxMRDRetirementCurrentYear_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxMRDRetirementCurrentYear.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxMRDRetirementCurrentYear_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub CheckboxMRDSavingsCurrentYear_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxMRDSavingsCurrentYear.CheckedChanged
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-CheckboxMRDSavingsCurrentYear_CheckedChanged", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
    End Sub
    ...
    Private Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        ...
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            l_String_Exception_Message = Server.UrlEncode(ex.Message.Trim.ToString())
            HelperFunctions.LogException("RefundRequestWebForm-Page_PreRender", ex)
            Response.Redirect("ErrorPageForm.aspx?FormType=Popup&Message=" + l_String_Exception_Message)
        End Try
        ' SR | 2016.06.08 | YRS-AT-2962 | If Processing fee applicable then display message
    End Sub
