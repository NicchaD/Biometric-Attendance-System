...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VoidDisbursementReverseManager.aspx.vb"
    Inherits="YMCAUI.VoidDisbursementReverseManager" %>
                                                ...
                                                <table class="Table_WithBorder" border="0" width="700" cellpadding="0" cellspacing="1">
                                                    ...
                                                    <tr>
                                                        <td colspan="4" valign="top">
                                                            ...
                                                            <div style="overflow: auto; width: 688px; height: 200px; text-align: left; valign: top">
                                                            ...
                                                            <table width="690">
                                                                ...
                                                                <tr>
                                                                    <td align="left" colspan="3">
                                                                        <asp:Label ID="LabelFundStatus" runat="server" CssClass="Label_Small"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:DropDownList ID="DropDownStatus" runat="server" CssClass="TextBox_Normal" Width="200">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table class="Table_WithBorder" width="700">
                                                                <tr>
                                                                    ...
                                                                    <td align="right" class="Td_ButtonContainer" width="70px">
                                                                        ...
                                                                        <input type="hidden" id="hdnRequestID" runat="server" name="hdnRequestID" />
                                                                        <input type="hidden" id="hdnCurrentFundStatus" runat="server" name="hdnCurrentFundStatus" />
                                                                        <input type="hidden" id="hdnRecommendedFundStatus" runat="server" name="hdnRecommendedFundStatus" />
                                                                    </td>
