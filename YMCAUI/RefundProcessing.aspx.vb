...
' FileName			:	RefundProcessing..aspx.vb
...
' Changed by			:	
' Changed on			:	
' Change Description	:13/sep/2006 YRSEN-2677
...
'**********************************************************************************************************************  
'Shubhrata             01/19/2007             YREN - 3025              YmcaPreTax was not getting summed up with PersonalPreTax in atsRefunds
'Shubhrata             01/30/2007             YREN-3022                to change the enabling/disabling of radio button Personal Monies option 
...
'Ashutosh Patil        04/11/2007             YREN-3028,YREN-3029		  
'Aparna Samala         04/09/2007             YREN-3022               -AM account doesnot appear on disbursment
'Aparna Samala         04/20/2007                                     Change in the proc called for getting refund config
'Shubhrata             05/25/2007                                      Plan Split Changes
'Aparna                06/08/2007             YREN-3285                -Include YMCA side money
'Aparna                 19/11/2007                                      Change in display of the datagrids.
'Shubhrata            11 Jan,2008             Bug id 356               Total row made bold for datagridcurrentaccts
'Swopna               14 Jan,2008             Bug id 355               On the selection of RollOver option,problem encountered on display of Payee details solved.On togling between rollover option,by default partial amount to be selected.
'Shubhrata           April 17th,2008                                   Implementation of New fund status
'Mohammed Hafiz         21-Apr-2008                                 Issue reported by Raj related to Hardship processing report - through email dt : Fri 4/18/2008 10:36 PM   
'Shubhrata & Priya     21-May-2008              BugId 420             Net amount not properly show while processing     
'Shubhrata & Priya     22-May-2008              BugId 458             Incorrect Amount display while Roll Over Partial Amount
'Shubhrata            22-May-2008               bug id 455            'ML will be non-terminated
'Priya                  03-June-2008            Enhancement         1.Last Payroll Date:     Withdrawal process will read the final payroll date for the participant from atsEmpEvents table to complete the process. This value will not be populated for previously terminated participants.  Therefore, only in the case where a date is found, the process in question will check for a funded MCPR or UPPR transaction for that date.  If the transaction is not found\not funded, a message shall inform the user "Not all contributions have been received\funded, this process cannot be completed."  The above validation will apply in case of Full and Partial Refunds only.
'Priya                  03-June-2008            Enhancement         2.Daily Interest Records:The withdrawal process will be modified to add a new validation. During refund processing, if the interest records do not exist (till the processing date), a warning message will be populated “Interest records do not exist. Do you want to continue with withdrawal?”.
...
'Priya                  12-Dec-2008            YRS 5.0-509           Hardship withdrawal letter logic.
'Priya                  17-Dec-2008            YRS 5.0-509           Reverted changed as per ragesh mail to hafiz
...
'Priya                  22-Jan-2009                               Added trim to name as it displays spaces between name in report. 
'Ganeswar               10-April-2009             BA              Added code for new BA Account. 
'Nikunj Patel			05-June-2009			Integrating code received from Bangalore - Hardship Refund processing changes and sent by 2009.06.24
'07/15/2009			Ashish Srivastava Include fix made by Bangalore team for Gemini Id- 837.
'07/16/2009			Ashish Srivastava Include fix made by Bangalore team for BT- 837.
'07/17/2009			Ashish Srivastava Include fix made by Bangalore team for BT- 837.
'07/20/2009			Nikunj Patel		Merged code received from Bangalore for BT-847, 849 and YRS 5.0-828, 829.
'08/31/2009			Ganesh		      Commented radiobutton code in DisableRadioButtons()
'09/Sep/2009        Neeraj Singh      Commented code lines where ever TextBoxCurrentPIA is used for issue is YRS 5.0-821
'08-oct-2009        Amit Nigam   Set the property value to nothing to initialize the session value after save
'20-Oct-2009        Amit nigam   Gemini 924
'Neeraj Singh                   12/Nov/2009         Added form name for security issue YRS 5.0-940 
'03-Nov-2009        Parveen      Replace the Yes/No RadioButtons with the Checkbox     
'04-Nov-2009        Parveen      Hide the First account if IsMarket is false   
...
'06-Jan-2010        Parveen     In the first Installment grid single row was shown for Personal and YMCA (Legacy Acct)  
'28-01-2010         Amit Nigam   for the MRD issue reported by Mark
'11/APR/2010        Imran        YRS 5.0-1075 Age not being treated correctly in withdrawal processing
'Neeraj Singh                   06/jun/2010         Enhancement for .net 4.0
'Neeraj Singh                   07/jun/2010         review changes done
'08/Sep/2010        Imran       Change "Birefltr" report parameters (only for Hardship )

'29-Sep-2010		Imran       YRS 5.0-1181 :Add validation for Hardhship withdrawal - No YMCA contact

'05-10-2010         Neeraj Singh BT-563 MRD- retirement fund issue
'2010.Nov.23        Neeraj Singh BT-664 : MRD Requirement 
'2010.Jan.28        Imran        BT-724 Refund processing screen Tax Rate allowing -Ve value for MRD    
'2011.Apr.19        Imran       BT:800 -If current balance is greater than $5000 and requested amount<5000 and  not single mrd processed then show informative message      
'2011.Apr.29        Imran       BT:827 and 800  -Informative message change in Bt 827 and message should show when refunt type not equql to 'MRD' and 'PART'
'2011.June.10       Imran       BT:848 -YRS 5.0-1337:MRD issue with rollovers and age < 70 1/2 of end of year 
'2011.July.04       Imran       BT:884-MRD Amount Additional Withholding issue.
'2011.Aug.11        Imran       BT:830-YRS 5.0-1326 : Rollover including non-taxable money.
'2011.Nov.03        Imran       BT:948-  YRS 5.0-1457:must include non-taxable money as well   
'2012.Feb.06        Harshala    BT:884-MRD Amount Additional Withholding issue.
'2012.Feb.22        Harshala    BT:726-Application allowing to create MRD refund for Active participant.
'2012.Feb.28        Harshala    BT:978-YRS 5.0-1519 - 'YMCA acct at request" amt on withdrawal screen is incorrect.
'2012.03.03         Sanjeev     BT-962: YRS 5.0-1492:No RMD if person is actively employed (includes fund status RA)
'2012.03.13         Sanjeev(SG) BT-1010: YRS 5.0-1552 - Withdrawals should include all prior year unsatisfied RMDs
'2012.03.21         Sanjeev(SG) BT-1010: YRS 5.0-1552 - Withdrawals should include all prior year unsatisfied RMDs
'2012.06.19         Sanjeev(SG) BT-1043(Re-open): Additional requirement for gemini id YRS 5.0-1552.
'2013.04.12         Anudeep     Bt-1131:YRS 5.0-1654:Email to finance dept when withdrawal to foreign address
'2013-07-10         Anudeep     BT-1501:YRS 5.0-1745:Capture Beneficiary addresses 
'2013-09-24         Anudeep     BT-1501:YRS 5.0-1745:Capture Beneficiary addresses 
'2013-09-27         Dinesh k    BT:2012:YRS 5.0-2063: Handling RMD candidates 
'2013.11.07         Sanjay R.   BT 2295: Hardship withdrawal process copying duplicate BRIEFLTR.pdf 
'2014.02.18         Dinesh k    BT:2139-YRS 5.0-2165:RMD enhancements - Change in table structure- Used view instead table
'2014.05.06         Shashank    BT-2503\YRS 5.0-2354 - Withdrawal process caused error due to mismatch in termination date and final contribution date. 
'2014.07.25         Sanjay R.   BT 2615/YRS 5.0-2404:Intelli-sense to select rollover institution name 
'2014.09.17         Sanjay S.   BT 2633/YRS 5.0-2403 -  Remove expiration dates from withdrawal requests in YRS 
'2014.10.07         Dinesh k    BT:2672:YRS 5.0-2422:allow rollovoers of pre-tax money only
'2014.10.14         Sanjay R    BT:2672:YRS 5.0-2422:allow rollovoers of pre-tax money only
'2014.11.11         Sanjay R.   BT:2672/YRS 5.0-2422:allow rollovoers of pre-tax money only
'2014.11.14         Sanjay R.   BT:2672/YRS 5.0-2422:allow rollovoers of pre-tax money only
...
'2015.11.16         Anudeep A   YRS-AT-2639: YRS enh: Withdrawals Phase2: Esign Sprint: Refund Process request prepopulate data if available - make it editable by ManagementTeam only
'2015.11.20         Anudeep A   YRS-AT-2639: YRS enh: Withdrawals Phase2: Esign Sprint: Refund Process request prepopulate data if available - make it editable by ManagementTeam only
'2015.12.02         Anudeep A   YRS-AT-2639 - YRS enh: Withdrawals Phase2: Esign Sprint: Refund Process request prepopulate data if available.
'2016.01.14         Gunanithi G YRS-AT-2725: Old code appearing in withdrawal processing screen. Additional controls Rollover Only First Installment and Rollover All Installment(s)
...
'2016.01.28         Gunanithi G YRS-AT-2725: Old code appearing in withdrawal processing screen. Additional controls Rollover Only First Installment and Rollover All Installment(s)
'2016.02.04         Bala        YRS-AT-2725: Old code appearing in withdrawal processing screen. Additional controls Rollover Only First Installment and Rollover All Installment(s)
'2016.06.06         Sanjay GS Rawat YRS-AT-2962 - YRS enh: Configurable Withdrawals project. 
...
'2016.10.04			Sanjay GS Rawat YRS-AT-2962 - YRS enh: Configurable Withdrawals project. 
'2016.11.18			Pramod P. P.    YRS-AT-3146 - YRS enh: Fees - Partial Withdrawal Processing fee 
'2017.05.09         Sanjay GS Rawat YRS-AT-3173 - YRS enh: if RMD amount greater than non-taxable give warning for " Taxable Only" selection (TrackIT 27473) 
'2017.07.03         Sanjay GS Rawat YRS-AT-3161 - YRS bug: Withdrawal process incorrectly updating refund type for QD participant
'2017.10.23         Santosh Bura    YRS-AT-3324 -  YRS enh: Restrict withdrawals and death for 70 1/2 & older if RMDs not yet generated(TrackIT 28857) MORE DETAILS NEEDED   
'2017.11.10         Sanjay GS Rawat YRS-AT-3742 - YRS Bug:(HOT FIX NEEDED) -participants with RMDs more than non-taxable amount are being forced to take excessive amt (TrackIT 31764) 
'2017.12.15         Santosh Bura    YRS-AT-3756 -  YRS enh: Additional calculation requirements for RMDs for beneficiaries(death on/after required RMD start date) (TrackIT 31836) .
'2019.07.24         Santosh Bura    YRS-AT-2169 -  Hardship withdrawal must be available for non-participants
'2019.07.17         Sanjay Singh    YRS-AT-4498 - YRS enh: REQUIRED LIVE 1/1/2020 - Hardship Withdrawals Legal Changes 
'2019.07.29         Sanjay Singh    YRS-AT-3870 - YRS bug-non-taxable TD amount not available for hardship (TrackIT 32820) 
'2019.10.09         Pooja Kumkar    YRS-AT-2670 - YRS enh:Hacienda withholding message - Puerto Rico based YMCA orgs
'*********************************************************************************************************************/ 
...
#Region " Web Form Designer Generated Code "
    ...
    'AA:24.09.2013 : BT-1501: Commented For Displaying address with address control not with textboxes
    ...
    'Protected WithEvents RadioButtonRolloversNo As System.Web.UI.WebControls.RadioButton
    ...
    'Commented by Parveen on 03-Nov-2009 to Replace Yes/No RadioButtons with the CheckBox
    'Protected WithEvents RadioButtonVoluntaryRolloverNo As System.Web.UI.WebControls.RadioButton
    'Protected WithEvents RadioButtonVoluntaryRolloverYes As System.Web.UI.WebControls.RadioButton
    ...
    'commented by dilip on 24-11-2009
    'Protected WithEvents LabelTotalWithdrawalAmount As System.Web.UI.WebControls.Label
    'Protected WithEvents TextBoxTotalWithdrawalAmount As System.Web.UI.WebControls.TextBox
    'commented by dilip on 24-11-2009
    ...
    'commented by dilip on 24-11-2009
    'Protected WithEvents LabelFirstInstallmentRolloverAmount As System.Web.UI.WebControls.Label
    'Protected WithEvents TextboxFirstInstallmentRolloverAmount As System.Web.UI.WebControls.TextBox
    'commented by dilip on 24-11-2009
...
#Region " Form Properties "
    ...
    Public Property SessionGrossAmount() As Decimal
        Get
            If Not (Session("SessionGrossAmount")) Is Nothing Then
                Return Session("SessionGrossAmount")
            Else
                Return 0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("SessionGrossAmount") = Value
        End Set
    End Property

    Private Property l_dec_TDAmount() As Decimal
        Get
            If Not Session("l_dec_TDAmount") Is Nothing Then
                Return (CType(Session("l_dec_TDAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("l_dec_TDAmount") = Value
        End Set
    End Property

    Private Property l_dec_TDRequestedAmount() As Decimal
        Get
            If Not Session("l_dec_TDRequestedAmount") Is Nothing Then
                Return (CType(Session("l_dec_TDRequestedAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("l_dec_TDRequestedAmount") = Value
        End Set
    End Property
    ...
    Public Property VoluntaryWithdrawalTotal() As Decimal
        Get
            If Not Session("VoluntaryWithdrawalTotal") Is Nothing Then
                Return (CType(Session("VoluntaryWithdrawalTotal"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("VoluntaryWithdrawalTotal") = Value
        End Set
    End Property
    Public Property HardshipWithdrawalTotal() As Decimal
        Get
            If Not Session("HardshipWithdrawalTotal") Is Nothing Then
                Return (CType(Session("HardshipWithdrawalTotal"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("HardshipWithdrawalTotal") = Value
        End Set
    End Property
    ...
    Private Property RefundType() As String
        Get
            If Not Session("RefundType") Is Nothing Then
                Return (CType(Session("RefundType"), String)).Trim.ToUpper
            Else
                Return String.Empty
            End If
    ...
    Private Property CurrentBA() As Decimal
        Get
            If Not Session("CurrentBA") Is Nothing Then
                Return (CType(Session("CurrentBA"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        ...
        Set(ByVal Value As Decimal)
            Session("CurrentBA") = Value
        End Set
    End Property

    Private Property TerminationBA() As Decimal
        Get
            If Not Session("TerminationBA") Is Nothing Then
                Return (CType(Session("TerminationBA"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property RefundExpiryDate() As Integer
        Get
            If Not Session("RefundExpiryDate") Is Nothing Then
                Return (CType(Session("RefundExpiryDate"), Integer))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property TaxableAmount() As Decimal
        Get
            If Not (Session("TaxableAmount")) Is Nothing Then
                Return (CType(Session("TaxableAmount"), Decimal))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TaxableAmount") = Value
        End Set
    End Property
    ...
    Private Property MinimumPIAToRetire() As Decimal
        Get
            If Not Session("MinimumPIAToRetire") Is Nothing Then
                Return (CType(Session("MinimumPIAToRetire"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property TotalRetirementPlanMoney() As Decimal
        Get
            If Not Session("TotalRetirementPlanMoney") Is Nothing Then
                Return (CType(Session("TotalRetirementPlanMoney"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TotalRetirementPlanMoney") = Value
        End Set
    End Property
    Private Property TotalSavingsPlanMoney() As Decimal
        Get
            If Not Session("TotalSavingsPlanMoney") Is Nothing Then
                Return (CType(Session("TotalSavingsPlanMoney"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TotalSavingsPlanMoney") = Value
        End Set
    End Property
    ...
    Public Property RefundState() As String
        Get
            If Not Session("RefundState") Is Nothing Then
                Return (CType(Session("RefundState"), String))
            Else
                Return "P"
    ...
    Private Property PartialRollOverMinLimit() As Decimal
        Get
            If Not Session("PartialRollOverMinLimit") Is Nothing Then
                Return (CType(Session("PartialRollOverMinLimit"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("PartialRollOverMinLimit") = Value
        End Set
    End Property
    Private Property NumTotalWithdrawalAmount() As Decimal
        Get
            If Not Session("NumTotalWithdrawalAmount") Is Nothing Then
                Return (CType(Session("NumTotalWithdrawalAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("NumTotalWithdrawalAmount") = Value
        End Set
    End Property
    Private Property NumRequestedAmountPartialRollOver() As Decimal
        Get
            If Not Session("RequestedAmountPartialRollOver") Is Nothing Then
                Return (CType(Session("RequestedAmountPartialRollOver"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("RequestedAmountPartialRollOver") = Value
        End Set
    End Property
    Private Property NumPercentageFactorofMoneyPartialRollOver() As Decimal
        Get
            If Not Session("PercentageFactorofMoneyPartialRollOver") Is Nothing Then
                Return (CType(Session("PercentageFactorofMoneyPartialRollOver"), Decimal))
            Else
                Return 1.0
            End If
        End Get
    ...
    Private Property FirstInstallment() As Decimal
        Get
            If Not Session("FirstInstallment") Is Nothing Then
                Return (CType(Session("FirstInstallment"), Decimal))
            Else
                Return 0.0
            End If
    ...
    Private Property DefferredInstallment() As Decimal
        Get
            If Not Session("DefferredInstallment") Is Nothing Then
                Return (CType(Session("DefferredInstallment"), Decimal))
            Else
                Return 0.0
            End If
    ...
    Public Property ForceToVoluntaryWithdrawal() As Boolean
        Get
            If Not Session("ForceToVoluntaryWithdrawal") Is Nothing Then
                Return (CType(Session("ForceToVoluntaryWithdrawal"), Boolean))
            Else
                Return False
        ...
        End Get
        Set(ByVal Value As Boolean)
            Session("ForceToVoluntaryWithdrawal") = Value
        End Set
    End Property
    'Added by Parveen on 09-Dec-2009 for the Hardship and VOL withdrawal Issue
    'Added by Amit for on 23-11-2009
    ...
    Public Property RolloverOptions() As String
        Get
            If Not Session("RolloverOptions") Is Nothing Then
                Return (CType(Session("RolloverOptions"), String))
            Else
                Return String.Empty
    ...
    Public Property FirstRolloverAmt() As Decimal
        Get
            If Not Session("FirstRolloverAmt") Is Nothing Then
                Return (CType(Session("FirstRolloverAmt"), Decimal))
            Else
                Return 0.0
    ...
    Public Property TotalRolloverAmt() As Decimal
        Get
            If Not Session("TotalRolloverAmt") Is Nothing Then
                Return (CType(Session("TotalRolloverAmt"), Decimal))
            Else
                Return 0.0
    ...
    Public Property MRDTaxrate() As Decimal
        Get
            If Not Session("MRDTaxrate") Is Nothing Then
                Return (CType(Session("MRDTaxrate"), Decimal))
            Else
                Return 0.0
        ...
        End Get
        Set(ByVal value As Decimal)
            Session("MRDTaxrate") = value
        End Set
    End Property
    'Start: AA: 11.20.2015 YRS-AT-2639 Added to use the meta configuration key value 
    Public Property FedaralTaxrate() As Decimal
        Get
            If Not ViewState("FedaralTaxrate") Is Nothing Then
                Return (CType(ViewState("FedaralTaxrate"), Decimal))
            Else
                Return 20.0
            End If
        End Get
        Set(ByVal value As Decimal)
            ViewState("FedaralTaxrate") = value
        End Set
    End Property
    ...
    Public Property FundEventStatus() As String
        Get
            Return ViewState("FundEventStatus")
        End Get
        Set(ByVal Value As String)
            ViewState("FundEventStatus") = Value
        End Set
    End Property
    ...
    Public Property WithdrawalProcessingFee() As String
        Get
            If Not String.IsNullOrEmpty(ViewState("WithdrawalProcessingFee")) Then
                Return ViewState("WithdrawalProcessingFee")
            Else
                Return "0.0"
            End If
        End Get
        Set(ByVal Value As String)
            ViewState("WithdrawalProcessingFee") = Value
        End Set
    End Property
    ...
    Public Property BA_Legacy_combined_Amt_Switch As Boolean
        Get
            If Not String.IsNullOrEmpty(ViewState("BA_Legacy_combined_Amt_Switch")) Then
                Return ViewState("BA_Legacy_combined_Amt_Switch")
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            ViewState("BA_Legacy_combined_Amt_Switch") = Value
        End Set
    End Property
    ...
    Public Property DisplayedParticipantTaxableMoneyMessage As Boolean
        Get
            If Not String.IsNullOrEmpty(ViewState("DisplayedParticipantTaxableMoneyMessage")) Then
                Return ViewState("DisplayedParticipantTaxableMoneyMessage")
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            ViewState("DisplayedParticipantTaxableMoneyMessage") = Value
        End Set
    End Property
    ...
    Private Property CurrentBalance() As DataTable
        Get
            If Not (Session("CurrentBalance")) Is Nothing Then
                Return (DirectCast(Session("CurrentBalance"), DataTable))
            Else
                Return Nothing
            End If
        End Get
        Set(ByVal Value As DataTable)
            Session("CurrentBalance") = Value
        End Set
    End Property
...
#End Region
    ...
    Private Function ValidateHardshipRefundProcess() As Boolean
        ...
        Try
            l_bool_Email = True
            l_DataSet_YmcaContact = YMCARET.YmcaBusinessObject.RefundRequestRegularBOClass.ValidateRefundProcess(Session("RefundRequestID"))
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If Not IsPostBack Then
                Session("DailyInterestValidation") = Nothing
                Session("PayrollValidation") = Nothing
                Session("NeedsNewRequests") = Nothing
                Session("HardshipAmountWithInterest") = Nothing
                Session("CalculatedDataTableForCurrentAccounts_Initial") = Nothing
                'Neeraj BT-563
                Session("MinimumDistributionTable") = Nothing
                Session("dtMrdRecords") = Nothing
                Session("MinimumDistributionAmount") = Nothing
                'IB:BT:800 Get participant's alll mrd record.To check any unsatisfied mrd record is pending at the time of saving 
                Session("dtParticipantAllMrdRecords") = Nothing
                Session("PriorYearRMDRecords") = Nothing
                ' START | SR | 2016.01.22 | YRS-AT-2664 | Clear session
                Session("CurrentAccountsWithMRD") = Nothing
                Session("MinimumDistributionTable_temp") = Nothing
                ...
                Session("ConvertHardToVol") = Nothing
            ...
            Else
                If Not Session("Title") Is Nothing Then
                    ...
                    string_temp = Session("Title").ToString()
                ...
                'If Me.RefundType <> "HARD" Then
                If Me.RefundType <> "HARD" Then
                    Session("CalculatedDataTableForCurrentAccounts") = YMCARET.YmcaBusinessObject.RefundRequest.GetTransactionsForMarket(Me.FundID, Session("RefundRequestID"))
                End If
            ...
            If Not IsPostBack Then
                ...
                If (Me.MinimumDistributionAmount > 0.01) AndAlso (Me.RefundType <> "MRD" And Me.RefundType <> "PART") AndAlso ( _
                    (DirectCast(Session("RequestedAccounts"), DataTable).Select("PlanType = 'RETIREMENT'").Length > 0 AndAlso DirectCast(Session("dtMrdRecords"), DataTable).Select("PlanType = 'RETIREMENT' and IsGreater5kBalance=true").Length > 0 AndAlso DirectCast(Session("RequestedAccounts"), DataTable).Compute("SUM(Total)", "PlanType = 'RETIREMENT'") <= 5000.0) _
                    OrElse (DirectCast(Session("RequestedAccounts"), DataTable).Select("PlanType = 'SAVINGS'").Length > 0 AndAlso DirectCast(Session("dtMrdRecords"), DataTable).Select("PlanType = 'SAVINGS' and IsGreater5kBalance=true").Length > 0 AndAlso DirectCast(Session("RequestedAccounts"), DataTable).Compute("SUM(Total)", "PlanType = 'SAVINGS'") <= 5000.0) _
                ) Then
                ...
                If HelperFunctions.isNonEmpty(Session("ReasonForRestriction")) Then
                    DivMainMessage.InnerHtml = Session("ReasonForRestriction").ToString()
            ...
            If Me.IsPostBack = True Then
                ...
                If Not Session("PriorYearRMDRecords") Is Nothing Then
                    If Not Request.Form("Yes") Is Nothing Then
                        If Request.Form("Yes").Trim.ToUpper = "YES" AndAlso Session("PriorYearRMDRecords") = "Yes" Then
                            ...
                            If Session("DailyInterestValidation") = True OrElse Session("PayrollValidation") = "Yes" Then 'SP 2014.05.06 BT-2503\YRS 5.0-2354 -Added
                                Exit Sub
                            End If
                        End If
                    End If
                ...
                'Priya 2008-Oct-03 :Verifying Last Payroll date validation. & if user wants to continue with it then refunds process should proceed further. as per hafiz mail on 1stOct2008
                If Session("PayrollValidation") = "Yes" Then
                    If Not Request.Form("Yes") Is Nothing Then
                        Session("PayrollValidation") = Nothing
                ...
                If Not Session("DailyInterestValidation") Is Nothing Then
                    If Not Request.Form("Yes") Is Nothing Then
        ...
        Catch ex As Exception
            HelperFunctions.LogException("RefundProcessing_Page_Load", ex) 'PK | 10/01/2019 | YRS-AT-2670 | Added exception logging
        ...
        Try
            ...
            If Not l_DataTable Is Nothing Then
                ...
                ElseIf Me.RefundType = "VOL" Then
                    ...
                    Session("CalculatedDataTableForRefundable") = l_DataTable
                ElseIf Me.RefundType = "HARD" Then
    ...
    Private Function DoRegularRefundForCurrentAccounts()
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("CalculatedDataTableForCurrentAccounts_Initial"), DataTable)
            'Added Ganeswar 10thApril09 for BA Account Phase-V /End
            If Not l_DataTable Is Nothing Then
                '' Do calucation of Current Accounts.
                l_DataTable = Me.DoFullRefund(l_DataTable)
    ...
    Private Function LoadMinDistributionValuesIntoControls()
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("MinimumDistributionTable"), DataTable)
    ...
    Private Function LoadPayee1ValuesIntoControls()
        ...
        Try
            ...
            If Me.RefundType <> "HARD" Or (Me.RefundType = "HARD" And Me.TextboxVoluntaryWithdrawalTotal.Text > "0.00") Then
                ...
                l_DataTable = DirectCast(Session("Payee1DataTable"), DataTable)
                'Hafiz 03Feb06 Cache-Session
    ...
    Private Function LoadPayee3ValuesIntoControls()
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("Payee3DataTable"), DataTable)
            'Hafiz 03Feb06 Cache-Session
            ...
            If Not l_AccountContributionTable Is Nothing Then
                ...
                If Not l_CalculationDataTable Is Nothing Then
                    ...
                    If l_CalculationDataTable.Rows.Count > 0 Then
                        ...
                        Next
                    End If
                    Session("CalculatedDataTableForCurrentAccounts_Initial") = l_CalculationDataTable_VolWithdrawalTotal
    ...
    Private Sub LoadPIA()
        ...
        Try
            ...
            'Added Ganeswar 10thApril09 for BA Account Phase-V /Begin
            Me.TerminationBA = CType(Session("BATermination"), Decimal)
            Me.CurrentBA = CType(Session("BACurrent"), Decimal)
    ...
    Private Function LoadAccountContribution()
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("AccountContribution_NonFund"), DataTable)
    ...
    Private Function LoadCalculatedTableForCurrentAccounts()
        ...
        Try
            'Commented code deleted by SG: 2012.03.16
            l_CalculatedDataTable = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
            'Hafiz 03Feb06 Cache-Session
...
#End Region
        ...
        If Me.RadioButtonRolloverAll.Checked = True Then
            ...
            If (ViewState("AllowRMDAmountToBeRollover") = "True") Then
                If (ViewState("IsRolloverTaxableWasSelected") = "True") Then
                    Session("MinimumDistributionTable") = Session("MinimumDistributionTable_temp")
    ...
    Private Function DoNone()
        ...
        Try
            ...
            Else
                ...
                l_PayeeDataTable = DirectCast(Session("Payee1DataTable"), DataTable)
                ...
                l_PayeeDataTable = DirectCast(Session("Payee2DataTable"), DataTable)
                ...
                l_PayeeDataTable = DirectCast(Session("Payee3DataTable"), DataTable)
                ...
                l_Payee1DataTable = DirectCast(Session("Payee1DataTable"), DataTable)
                l_Payee2DataTable = DirectCast(Session("Payee2DataTable"), DataTable)
                l_Payee3Datatable = DirectCast(Session("Payee3DataTable"), DataTable)
    ...
    Private Function DoFinalCalculation()
        ...
        Try
            ...
            Else
                Me.TextboxTaxableFinal.Text = l_Decimal_Payee1Taxable + l_Decimal_Payee2Taxable + l_Decimal_Payee3Taxable + l_Decimal_MinDisbAmount
                ...
                Me.TextboxTaxFinal.Text = l_Decimal_Payee1Tax + l_Decimal_MinDisbTax
                Me.TextboxNetFinal.Text = (l_Decimal_Payee1Net + l_Decimal_Payee2Net + l_Decimal_Payee3Net + l_decimal_MinDisbNet) - Me.DeductionsAmount
            End If
            'Ganeswar Added  for HardShip rollover on 03-06-2009

            If Me.RefundType = "HARD" And TextboxRequestAmount.Text > "0.00" Then
                Me.TextboxTaxableFinal.Text = l_Decimal_Payee1Taxable + l_Decimal_Payee2Taxable + l_Decimal_Payee3Taxable + CType(Me.TextboxHardShipAmount.Text, Decimal) + l_Decimal_MinDisbAmount
                'START : MMR | 2017.07.30 | YRS-AT-3870 | Adding hardship non-taxable component to net non-taxable amount
                'Me.TextboxNonTaxableFinal.Text = l_Decimal_Payee1NonTaxable + l_Decimal_Payee2NonTaxable + l_Decimal_Payee3NonTaxable + l_Decimal_MinDisbNonTaxable
                Me.TextboxNonTaxableFinal.Text = l_Decimal_Payee1NonTaxable + l_Decimal_Payee2NonTaxable + l_Decimal_Payee3NonTaxable + l_Decimal_MinDisbNonTaxable + CType(Me.textboxHardShipNonTaxableAmount.Text, Decimal)
                'END : MMR | 2017.07.30 | YRS-AT-3870 | Adding hardship non-taxable component to net non-taxable amount
                Me.TextboxTaxFinal.Text = l_Decimal_Payee1Tax + l_Decimal_MinDisbTax + CType(Me.TextboxHardShip.Text, Decimal)
                Me.TextboxNetFinal.Text = (l_Decimal_Payee1Net + l_Decimal_Payee2Net + l_Decimal_Payee3Net + l_decimal_MinDisbNet + CType(Me.TextboxHardShipNet.Text, Decimal)) - Me.DeductionsAmount
            End If
    ...
    Private Function SaveRefundProcess() As String
        ...
        Try
            ...
            l_ProcessMessage = objRefundProcess.SaveRefundRequestProcess(Me.DatagridDeductions, Session("l_dec_TDAmount"), Session("l_dec_TDRequestedAmount"), CDec(l_decimalTaxAmount), CDec(ll_ForcetoPersonalWithdrawal), CDec(TextboxTotalRolloverAmount.Text))
    ...
    Private Sub ButtonSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Try
            ...
            If Me.RefundType = "MRD" Then
                If Not Session("PersonID") Is Nothing And Not Session("PersonInformation") Is Nothing Then
                    Dim dtPersonDetails As DataTable
                    dtPersonDetails = CType(Session("PersonInformation"), DataSet).Tables("Member Details") ' l_DataSet.Tables("Member Details")
            ...
            If Not Session("dtParticipantAllMrdRecords") Is Nothing Then
                dtPriorMRD = Session("dtParticipantAllMrdRecords")
            End If
    ...
    Private Sub DoSaveProcessing()
        ...
        Try
            ...
            Else
                Session("sessionProcessMessage") = l_stringMessage
            End If
            ...
            If Me.RefundType = "HARD" AndAlso IRSOverride <> True AndAlso Not objRefundProcess.IsNonParticipatingPerson Then
                ...
                If (Not objRefundProcess.IsTDContributionsAllowed) Then
                    ...
                    If l_BooleanFlag Then
                        ...
                        Session("R_ReportToLoad_6") = True
                        Session("R_ReportToLoad_3") = Nothing
                        Session("R_ReportToLoad_1") = Nothing
                        Session("R_ReportToLoad_2") = Nothing
                        Session("R_ReportToLoad_4") = Nothing
                        Session("R_ReportToLoad_5") = Nothing
    ...
    Private Sub EnableDisableSaveButton()
        ...
        Try
            ...
            If Not Session("MaritalStatusCode") Is Nothing Then
                If Session("MaritalStatusCode") = "M" Then
    ...
    Private Sub CheckboxAddnlWitholding_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckboxAddnlWitholding.CheckedChanged
        Try
            ...
            Else
                ...
                'End: AA: 11.20.2015 YRS-AT-2639 Added to use the meta configuration key value 
                objRefundProcess.TaxRate = Me.TaxRate
                'BT:884:Harshala-MRD Amount Additional Withholding issue-START.
                'If Me.RefundType = "REG" Then
                '    Me.TextboxTaxRate.ReadOnly = True
                '    'BT:884:Imran-MRD Amount Additional Withholding issue.
                ...
                'BT:884:Harshala-MRD Amount Additional Withholding issue.
    ...
    Private Sub TextboxMinDistTaxRate_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextboxMinDistTaxRate.TextChanged
        ...
        Try
            ...
            ''BT 724-Refund processing screen Tax Rate allowing -Ve value for MRD
            'If Convert.ToDouble(Me.TextboxMinDistTaxRate.Text) > 100 Or Convert.ToDouble(Me.TextboxMinDistTaxRate.Text < 0) Then
            '    MessageBox.Show(Me.MessageBoxPlaceHolder, " YMCA - YRS", "Invalid Tax Rate entered. Tax Rate should between 0% to 100%.", MessageBoxButtons.Stop, False)
            '    Me.TextboxMinDistTaxRate.Text = 10
            'End If

            'START: SB | 2017.12.15 | YRS-AT-3756 | Added new validation not to allow RMD tax amount between 1 to 9. Commenting old validation code as in new validation handles previous validation cases
            'If Convert.ToDouble(Me.TextboxMinDistTaxRate.Text) > 100 Or Convert.ToDouble(Me.TextboxMinDistTaxRate.Text < 0) Then
            '    MessageBox.Show(Me.MessageBoxPlaceHolder, " YMCA - YRS", "Invalid Tax Rate entered. Tax Rate should between 0% to 100%.", MessageBoxButtons.Stop, False)
            ...
            If Not String.IsNullOrEmpty(Me.TextboxMinDistTaxRate.Text) Then
                ...
                End If
            End If
            'END: SB | 2017.12.15 | YRS-AT-3756 |  Added new validation not to allow RMD tax amount between 1 to 9. Commenting old validation code as in new validation handles previous validation cases

            'If Convert.ToDouble(Me.TextboxMinDistTaxRate.Text) <> MRDTaxrate And Convert.ToDouble(Me.TextboxMinDistTaxRate.Text > 0) Then
            '    MessageBox.Show(Me.MessageBoxPlaceHolder, " YMCA - YRS", getmessage("MESSAGE_MRDTAXRATE"), MessageBoxButtons.OK, False)
            'End If
    ...
    Private Function DoVoluntryRefund(Optional ByVal parameterDataTable As DataTable = Nothing) As DataTable
        Try
            ...
            If Not parameterDataTable Is Nothing Then
                Session("CalculatedDataTable") = parameterDataTable
            End If
...
#End Region
    ...
    Private Sub RadiobuttonPersonalMoniesYes_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadiobuttonPersonalMoniesYes.CheckedChanged
        ...
        Try
            If RadiobuttonPersonalMoniesYes.Checked = True Then
                Session("YesClicked") = True
                l_PersonalMoniesDataTable = Session("CalculatedDataTableForPersonalMonies")
                l_CurrentAcctsDataTable = Session("CalculatedDataTableForCurrentAccounts")
                Session("CalculatedDataTableForCurrentAccounts") = l_PersonalMoniesDataTable
                Session("CalculatedDataTableForPersonalMonies") = l_CurrentAcctsDataTable
    ...
    Private Sub RadiobuttonPersonalMoniesNo_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadiobuttonPersonalMoniesNo.CheckedChanged
        ...
        Try
            'Commented code deleted by SG: 2012.03.16
            If RadiobuttonPersonalMoniesNo.Checked = True And Session("YesClicked") = True Then
                Session("YesClicked") = False
                'Commented code deleted by SG: 2012.03.16

                l_CurrentAcctsDataTable = Session("CalculatedDataTableForPersonalMonies")
                l_PersonalMoniesDataTable = Session("PermanentDataTableForPersonalMonies")
                Session("CalculatedDataTableForCurrentAccounts") = l_CurrentAcctsDataTable
                Session("CalculatedDataTableForPersonalMonies") = l_PersonalMoniesDataTable
...
#Region "Hard Ship Functions"
    ...
    Private Function SetVolWithdrawalTotal()
        Dim l_ContributionDataTable As DataTable
        Try
            If Not Session("CalculatedDataTableForCurrentAccounts_Initial") Is Nothing Then
                l_ContributionDataTable = CType(Session("CalculatedDataTableForCurrentAccounts_Initial"), DataTable)
                l_ContributionDataTable = objRefundProcess.DoFlagSetForVoluntryRefund(l_ContributionDataTable, True)
...
#End Region
    ...
    Private Sub TextboxTotalRolloverAmount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextboxTotalRolloverAmount.TextChanged
        ...
        If Me.RadioButtonNone.Checked = True Then
            ...
            Else
                ...
                ElseIf CType(TextboxTotalRolloverAmount.Text, Decimal) > CType(Session("DefferredInstallmentAmount"), Decimal) Then
                    'Modified by Amit Nigam to check the validation for the total rollover amount which should be more then the total withdrawal amount 11/11/2009
                    MessageBox.Show(MessageBoxPlaceHolder, "YMCA-YRS", "Rollover Request Amount should Not be greater than  " & l_string_dollar & "" & Session("DefferredInstallmentAmount") & ". ", MessageBoxButtons.Stop)
                    TextboxTotalRolloverAmount.Text = String.Empty
                    Me.NumRequestedAmountPartialRollOver = 0.0
                    Me.NumPercentageFactorofMoneyPartialRollOver = 1.0
    ...
    Private Sub RadiobuttonRolloverAllInstallment_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadiobuttonRolloverAllInstallment.CheckedChanged
        Try
            ...
            TextboxRemainingMoneyinMKT.Text = CType(Session("DefferredPaymentAmount"), Decimal)
            TextboxDeferedInstallmentAmount.Text = CType(Session("DefferredInstallmentAmount"), Decimal)
            EnableDisablePartialRolloverControl(True)
        Catch ex As Exception
    ...
    Public Sub CheckCountryName()
        ...
        Try
            ...
            If Not Session("ds_PrimaryAddress") Is Nothing Then
                l_dataset = Session("ds_PrimaryAddress")
    ...
    Public Sub CreateExpiredRequestWarning()
        ...
        Try
            dtRefundRequestDataTable = DirectCast(Session("RefundRequestTable"), DataTable)
...
#End Region
    ...
    Public Sub Payee1BalanceWithRMD(ByVal payee1Balance As DataTable)
        ...
        Try
            ...
            If HelperFunctions.isNonEmpty(Session("MinimumDistributionTable")) Then
                RMD = HelperFunctions.DeepCopy(Of DataTable)(DirectCast(Session("MinimumDistributionTable"), DataTable))
    ...
    Private Sub ClearHardshipSessions()
        Session("hardshipWithdrawalTaxable") = Nothing
        Session("hardshipWithdrawalNonTaxable") = Nothing
    End Sub
