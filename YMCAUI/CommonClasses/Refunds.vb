...
' Unit Test Plan Name			:	
' Description					: This class has derived from RefundRequestWebForm.aspx.vb to generalize the functions 
'                               : of refunds requests and processing. This class will help to generate refund request as and when 
'                               : required from other modules. 
'Modification History

'** Date(MM/DD/YYYY)            Author          Description
'** 01/28/2008                  Shubhrata       YRSPS 4212 
'**01/30/2008                   Shubhrata       YRSPS 4212
'**05/19/2008                   Shubhrata       to include SR,AC and AM(YMCA Side) account for personal total acc to Mark Posey's email
'dated May 12,2008
'21-Nov-2008                    Priya           BugId - YRS 5.0-576 Apply functionality to send email after hardship withdrawal.
' 17-Dec-2008                   Priya           Bug Id - YRS 5.0-576 changes made to send mail to default mail id
'19-Dec-2008                    Priya           Bug ID - YRS 5.0-529 Incorrect atsRefRequestDetails records
'5-Jan-2008                     Priya           YRS 5.0-634 : SHIRA refund request for non-vested participant 
'06-Jan-2009                    Priya           YRS 5.0-529 Incorrect atsRefRequestDetails records for SS account   
'09-Jan-2009                    Priya           YRS 5.0-576 check for participant name.
'22-Jan-2009                    Priya           YRS 5.0-666 get hardship renewal month from atsMetaConfiguration DB table.
'09-Feb-09                      Priya           YRS 5.0-695 Email to YMCA after Hardship withdrawal
'Begin Code Merge by Dilip on 07-05-2009
'16-March-2009                  Priya           Change Time of Customer Service Department 8:45 AM to 6:00 previously it was 8:45 AM to 8:00 as per Hafiz mail on March 13, 2009 
'17-March-2009                  Priya           Made changes into MailMessage, message selected from database as per hafiz mail on 16-March-2009
'End Code Merge by Dilip on 07-05-2009
'03/04/2009                     Dilip           Modification for New BA Account 
'06/05/2009			Ganeswar 		For HardShip RollOver To avoid TD Account
'07/02/2009			Nikunj P.       'Include or exclude the selected YMCA Account-30/06/09
'07/08/2009			Nikunj Patel	Include fix made by Bangalore team for not including SA, RG money into the TD amount field - sent via email - 2009.07.08
'07/15/2009			Ashish Srivastava Include fix made by Bangalore team for Gemini Id- 837.
'07/17/2009			Ashish Srivastava Include fix made by Bangalore team for Gemini Id- 837.
'08/11/2009         Dilip Yadav - YRS 5.0-859 - In case of hardship withdrawal mail text(as provided) is modified.
'2009.09.25         Amit Nigam   Modified as per the additional partial request for the reports
...
'08-oct-2009        Amit Nigam   Set the property value to nothing to initialize the session value after save
'16-Nov-2009        Parveen Kumar 'Design Changes For Market Based Withdrawal
'07-Dec-2009        Parveen Kumar 'Changes Done For Market Based Withdrawal issues
'08-Dec-2009        Parveen Kumar 'Changes Done For Market Based Withdrawal issues
'09-Dec-2009        Parveen     Changes for the Hardship and VOL withdrawal Issue
'15-Dec-2009        Parveen     To Set RolloverOptions and Rollover Amount incase of Rollover
'16-Dec-2009        Parveen     Fix issues For RolloverOptions and Rollover Amount
'28-01-2010         Amit Nigam   for the MRD issue reported by Mark
'02-03-2010         Amit Nigam   Commented the code and modified the same for MRD issue
'15-04-2010         Imran         Rounding Issue generated in Total field is not updated in Datatable 
...
'23/Aug/2010        Imrab       BT:567 Direct cast issue. Decimal to string ,Guidto string
'05-10-2010         Neeraj Singh        BT-563 MRD- retirement fund issue
'2010.Nov.23           Neeraj Singh        BT-664 : MRD Requirement 
'2010.Dec.04        Imran           BT.688 Refund process screen showing total MRD amount if requested is less than MRD
'2010.Dec.04        Nikunj      Bug:690  In AtsMrdRecordsDisbursements table SAVINGS plan MRD amount not updating in mnyPaidAmount
'2011.Feb.23        Imran       BT:760- Taxable amount showing wrong When refund taken with exclude YMCA.
'2011.Apr.19        Sanket      BT:808 -YRS 5.0-1304 : Hardship withdrawal email- verbiage change
'2011.Apr.28        Imran        'IB:BT:800 Get participant's alll mrd record.To check any unsatisfied mrd record is pending at the time of saving 
'2011.June.09       Imran       'BT:853-Application giving yellow page on Withdrawal Re-Issue
'2011.Nov.03        Imran        BT:948-  YRS 5.0-1457:must include non-taxable money as well   
'2012.Feb.22        Harshala    BT:726-Application allowing to create MRD refund for Active participant.
'2012.03.03         Sanjeev(SG) BT-962: YRS 5.0-1492:No RMD if person is actively employed (includes fund status RA)
'2012.03.14         Sanjeev(SG) BT-2010: YRS 5.0-1552 - Withdrawals should include all prior year unsatisfied RMDs
'28.09.2012			Priya		BT:-960,YRS 5.0-1489:Add process for cash outs of $50.01 to $5,000
'2012.Jan.11         Dinesh      BT:1135:YRS 5.0-1659:New Configuration value for hardship withdrawal email sender
'2013.Jul.14        Dinesh Kanojia(DK)   BT-1502: YRS 5.0-1746:Include partial withdrawals
...
'2013.10.28         Sanjay Rawat         BT-2247/YRS 5.0-2229:Change the TD termination and 6 month resumption date
'2015.05.05         Anudeep A            BT-2699:YRS 5.0-2441 : Modifications for 403b Loans 
'2015.06.24         Sanjay Singh         BT 2903/YRS-AT-2542 - YRS bug discovered in which RMD (Required Minimum Distribution) records are being marked as eligible-yes for participants with pre-eligible (PE or RE) Fund statuses.
...
'2016.01.22         Sanjay S.            YRS-AT-2664 - YRS enh: allow rollover of taxable only if non-taxable amount exceeds total RMD (TrackIT 24207) 
'2016.08.25         Sanjay GS Rawat      YRS-AT-3084 - YRS enh: PART 4 of 4:RMD's for alternate payees (QDRO recipients) (TrackIT 22284) 
'2016.08.31         Santosh Bura         YRS-AT-3028 -  YRS enh-RMD Utility - married to married Spouse beneficiary adjustment(TrackIT 25233) 
'2016.09.23         Sanjay GS Rawat      YRS-AT-3164 - YRS enh: Hot Fix:special Hardship Withdrawal - how to allow contributions to continue temporarily 
'2016.10.05         Sanjay GS Rawat      YRS-AT-2962 - YRS enh: Configurable Withdrawals project. 
'2017.07.03         Sanjay GS Rawat      YRS-AT-3161 - YRS bug: Withdrawal process incorrectly updating refund type for QD participant
'2017.11.29         Manthan Rajguru      YRS-AT-3415 -  YRS REPORTS enh: update to hardship letter (TrackIT 29702) 
'2017.12.12         Sanjay GS Rawat      YRS-AT-3742 - YRS Bug:(HOT FIX NEEDED) -participants with RMDs more than non-taxable amount are being forced to take excessive amt (TrackIT 31764) 
'2019.06.10         Megha Lad            YRS-AT-4461 - YRS bug: HOT FIX NEEDED- portability bug- request-disbursement is for less than amount request (TrackIT38439)
'2019.07.24         Santosh Bura         YRS-AT-2169 -  Hardship withdrawal must be available for non-participants
'2019.07.17         Sanjay GS Rawat      YRS-AT-4498 - YRS enh: REQUIRED LIVE 1/1/2020 - Hardship Withdrawals Legal Changes 
'2019.07.23         Sanjay GS Rawat      YRS-AT-3870 - YRS bug-non-taxable TD amount not available for hardship (TrackIT 32820) 
'2019.08.22         Sanjay GS Rawat      YRS-AT-4551 - YRS Bug: Hardship Withdrawals - request date for hardship withdrawals should not change upon disbursement (TrackIT 39313) 
'2019.08.28         Sanjay GS Rawat      YRS-AT-4498 - YRS enh: REQUIRED LIVE 1/1/2020 - Hardship Withdrawals Legal Changes 
'**********************************************************************************************************************************************************
...
#Region "General Utility Functions"
    ...
    Public Property IsTDContributionsAllowed() As Boolean
        Get
            If Not Session("isTDContributionsAllowed") Is Nothing Then
                Return (CType(Session("isTDContributionsAllowed"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("isTDContributionsAllowed") = Value
        End Set
    End Property

    Public Property IsLoanCriteriaNotRequired() As Boolean
        Get
            If Not Session("isLoanCriteriaNotRequired") Is Nothing Then
                Return (CType(Session("isLoanCriteriaNotRequired"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("isLoanCriteriaNotRequired") = Value
        End Set
    End Property

    Public Property IsInterestAllowed() As Boolean
        Get
            If Not Session("isInterestAllowed") Is Nothing Then
                Return (CType(Session("isInterestAllowed"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("isInterestAllowed") = Value
        End Set
    End Property

    Public Property HardshipWithdrawalTaxable() As Decimal
        Get
            If Not Session("hardshipWithdrawalTaxable") Is Nothing Then
                Return (CType(Session("hardshipWithdrawalTaxable"), Decimal))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("hardshipWithdrawalTaxable") = Value
        End Set
    End Property

    Public Property HardshipWithdrawalNonTaxable() As Decimal
        Get
            If Not Session("hardshipWithdrawalNonTaxable") Is Nothing Then
                Return (CType(Session("hardshipWithdrawalNonTaxable"), Decimal))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("hardshipWithdrawalNonTaxable") = Value
        End Set
    End Property
        ...
        Try
            If parameterCalledBy = "IsRetirement" Then
                If Not Session("Calculated_RetirementPlanAcctContribution") Is Nothing Then
                    l_ContributionDataTable = DirectCast(Session("Calculated_RetirementPlanAcctContribution"), DataTable)
                End If
            ElseIf parameterCalledBy = "IsSavings" Then
                If Not Session("Calculated_SavingsPlanAcctContribution") Is Nothing Then
                    l_ContributionDataTable = DirectCast(Session("Calculated_SavingsPlanAcctContribution"), DataTable)
                End If
        ...
        Try
            If parameterCalledBy = "IsRetirement" Then
                If Not Session("Calculated_DisplayRetirementPlanAcctContribution") Is Nothing Then
                    l_ContributionDataTable = DirectCast(Session("Calculated_DisplayRetirementPlanAcctContribution"), DataTable)
                End If
            ElseIf parameterCalledBy = "IsSavings" Then
                If Not Session("Calculated_DisplaySavingsPlanAcctContribution") Is Nothing Then
                    l_ContributionDataTable = DirectCast(Session("Calculated_DisplaySavingsPlanAcctContribution"), DataTable)
                End If
            ElseIf parameterCalledBy = "IsConsolidated" Then
                If Not Session("CalculatedDataTableDisplay") Is Nothing Then
                    l_ContributionDataTable = DirectCast(Session("CalculatedDataTableDisplay"), DataTable)
                End If
            End If
                        ...
                        If Not (DirectCast(l_DataRow("AccountGroup"), String).Trim = "Total") Then
                            ...
                            Select Case (l_AccountGroup.Trim.ToUpper)
                                ...
                                Case m_const_SavingsPlan_TD
                                    ...
                                    Session("HardshipAmountWithInterest") = l_DataRow("Total")
...
#Region " OLD MRD CODE"
        ...
        Try
            ...
            If Me.CheckForTerminationDate = True Then
                ...
                If MRDforPartialorMarket = False Then
                    ...
                    'l_DataTable = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
                ...
                Session("MinimumDistributionTable") = Nothing
                If MRDforPartialorMarket = False Then
                ...
                Else
                    ...
                    Using dtTemp As DataTable = CType(Session("MinimumDistributionTable"), DataTable)
    ...
    Public Sub CalculateMinimumDistributionAmount()
        ...
        Try
            ' dtCalculatedDataTableForCurrentAccounts = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
            l_RequestedAmounts_DataTable = DirectCast(Session("RequestedAccounts"), DataTable)
            ...
            If Not dtMrdRecords Is Nothing AndAlso dtMrdRecords.Rows.Count > 0 Then
                Session("dtParticipantAllMrdRecords") = dtMrdRecords.Copy()
            End If
            ...
            If Not dtMrdRecords Is Nothing AndAlso dtMrdRecords.Rows.Count > 0 Then
                Session("dtMrdRecords") = dtMrdRecords
            End If
            ...
            If ((IsTerminatedEmployment() Or SessionStatusType.Trim() = "QD") AndAlso HelperFunctions.isNonEmpty(dtMrdRecords)) Then 'SR/2015.06.24-BT 2903/YRS-AT-2542 - YRS bug discovered in which RMD (Required Minimum Distribution) records are being marked as eligible-yes for participants with pre-eligible (PE or RE) Fund statuses.
                ...
                Session("MinimumDistributionTable") = Nothing
                Session("CurrentAccountsWithMRD") = Nothing ' SR | 2016.01.25 | YRS-AT-2664 - Clear session because this method has been called twice
    ...
    '            l_MinimumDistributionTable = CType(Session("MinimumDistributionTable"), DataTable)
    '        Else
    ...
    '        l_CurrentAccountDataTable = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
    ...
    '        Session("CalculatedDataTableForCurrentAccounts") = l_CurrentAccountDataTable
    ...
    Public Function DoMinimumDistributionCalculation(ByVal paramRMDDataTable As DataTable, ByVal paramPlanType As String) As String
        ...
        Try
            ...
            If (Session("CurrentAccountsWithMRD")) Is Nothing Then
                Session("CurrentAccountsWithMRD") = l_CurrentAccountDataTable.Copy
            End If
...
#End Region 'Calculation of Minimum Distribution Amount
    Public Function CreatePayees()
        ...
        Try
            l_RequestedDataTable = DirectCast(Session("RequestedAccounts"), DataTable)
            ...
            'Else
            '    l_CurrentDataTable = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
            'End If
            'Commnented By Parveen on 07-Dec-2009 to get the data according to the withdrawal Type from Database
            ...
            'l_CurrentDataTable = YMCARET.YmcaBusinessObject.RefundRequest.GetTransactionsForMarket(Me.FundID, Session("RefundRequestID"))
            'commented for the MRD issue reported by Mark-28 jan,2010
            l_CurrentDataTable = Session("CalculatedDataTableForCurrentAccounts")
            ...
            l_PayeeDataTable = DirectCast(Session("AtsRefund"), DataTable)
            ...
            If requestedamount.GetType.ToString <> "System.DBNull" Then
                For datarow = 0 To DatatableToBeFixed.Rows.Count - 1
                    ...
                    If (DatatableToBeFixed.Rows(datarow).Item("Total").GetType.ToString <> "System.DBNull") AndAlso (DatatableToBeFixed.Rows(datarow).Item("AccountType").ToString.ToUpper.Trim <> "LN") AndAlso (DatatableToBeFixed.Rows(datarow).Item("AccountType").ToString.ToUpper.Trim <> "LD") Then
                        ...
                        'If (DirectCast(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim <> "Total") And ((DirectCast(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim) <> "Market Based (" + DirectCast(Session("MarketBasedFirstInstPercentage"), String) + "%)") Then
                        'Added by Dinesh on 29/07/2013
                        'Start: Dinesh Kanojia(DK)     2013.07.14      BT-943: YRS 5.0-1746:Include partial withdrawals
                        'If bIsPartial Then
                        '    If (CType(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim <> "Total") And ((CType(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim) <> "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)") And (CType(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim <> "TD") Then
                        '        totalReqAmount += DatatableToBeFixed.Rows(datarow).Item("Total")
                        '    End If
                        'Else
                        '    If (CType(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim <> "Total") And ((CType(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim) <> "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)") Then
                        '        totalReqAmount += DatatableToBeFixed.Rows(datarow).Item("Total")
                        '    End If
                        'End If
                ...
                If RoundingValue <> 0 Then
                    ...
                    For datarow = 0 To DatatableToBeFixed.Rows.Count - 1
                        ...
                        If (DatatableToBeFixed.Rows(datarow).Item("Total").GetType.ToString <> "System.DBNull") AndAlso (DatatableToBeFixed.Rows(datarow).Item("AccountType").ToString.ToUpper.Trim <> "LN") AndAlso (DatatableToBeFixed.Rows(datarow).Item("AccountType").ToString.ToUpper.Trim <> "LD") Then
                            ...
                            '    If (DirectCast(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim <> "Total") And ((DirectCast(DatatableToBeFixed.Rows(datarow).Item("AccountType"), String).Trim) <> "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)") Then
                    ...
                    If parameterPlanType = "Retirement" Then
                        Session("RetirementAccountTypeAdjusted") = l_dr_NewRowRefundRequestTable("AccountType").ToString().Trim()
                    ElseIf parameterPlanType = "Savings" Then
                        Session("SavingsAccountTypeAdjusted") = l_dr_NewRowRefundRequestTable("AccountType").ToString().Trim()
                    End If
                Else
                    Me.Session("RoundingAmount") = Nothing
                End If
            End If
            Return DatatableToBeFixed
        Catch ex As Exception
    ...
    Public Function LoadRefundableDataTable()
        ...
        Try
            ...
            Session("RefundableDataTable") = l_RefundableDataTable
    ...
    Public Function LoadCalculatedTableForPersonalMonies()
        ...
        Try
            ...
            l_CalculatedDataTableForCurrentAccounts = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
            ...
            Next
            Session("CalculatedDataTableForPersonalMonies") = l_CalculatedDataTableForPersonal
            Session("PermanentDataTableForPersonalMonies") = l_CalculatedDataTableForPersonal
...
#Region " Save Refund Request"
    ...
    Public Function UpdateRefundRequestTable(ByVal parameterdatatable As DataTable, ByVal blnPartial As Boolean, ByVal PrameterPlanType As String, ByVal PartialAmount As Decimal, ByVal bool_SaveRefund As Boolean, ByVal bool_IncludeYMCAAcct As Boolean, ByVal bool_IncludeYMCALegacyAcct As Boolean, ByVal ParameterProcessId As String, ByVal bool_bitIsMarket As Boolean, ByVal ParameterMarketPercentage As Decimal, ByVal ParameterMarketDefferedPmtPercentage As Decimal, ByVal FlagIsMarketPerPlan As Boolean, ByVal Bool_NotIncludeAMMatched As Boolean, ByVal Bool_NotIncludeTMMatched As Boolean) As Boolean
        ...
        Session("OnlyYmcaSideforAM") = Nothing
        ...
        Try
                ...
                If l_ContributionDataRow.RowState <> DataRowState.Deleted Then ' If the row is deleted then Don;t cont the values
                    ...
                    If l_bool_Selected = True Then
                        If Not (l_ContributionDataRow("AccountType").GetType.ToString = "System.DBNull") Then
                            ...
                            ' If Not (DirectCast(l_ContributionDataRow("AccountType"), String) = "Total") And Not (DirectCast(l_ContributionDataRow("AccountType"), String) = "Market Based (" + DirectCast(Session("MarketBasedFirstInstPercentage"), String) + "%)") Then
                            If Not (DirectCast(l_ContributionDataRow("AccountType"), String) = "Total") And Not (DirectCast(l_ContributionDataRow("AccountType"), String) = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)") Then
                                ...
                                Session("TotalAmtForReleaseBlnk") = l_Decimal_OtherAmount
                                Session("inOtherAmount") = l_Decimal_OtherAmount
                                ...
                                Do While (l_Decimal_PersonalTotal + l_Decimal_YMCATotal) > 0.0
                                    ...
                                    If l_String_AccountGroup = m_const_RetirementPlan_AM And l_Decimal_PersonalTotal = 0.0 Then
                                        Session("OnlyYmcaSideforAM") = True
                                    ...
                                    If DirectCast(l_ContributionDataRow("YMCATotal"), Decimal) > 0.0 Then
                                        If Not Session("OnlyYmcaSideforAM") Is Nothing Then
                                        Else
                                            l_String_AccountBreakDownType = Me.GetAccountBreakDownType(l_String_AccountGroup, False, True, False, False)
                                            l_Integer_SortOrder = Me.GetAccountBreakDownSortOrder(l_String_AccountBreakDownType)
                                            l_DataRow = Me.GetDataRow(l_String_AccountBreakDownType, l_Integer_SortOrder, l_RefundRequestDetailsDataTable, l_String_AccountType)
            ...
            Session("RefundRequestIDs") = StringUniqueId
        ...
        Try
            ...
            If parameter_RefundRequestDataTable.Rows(0)("PlanType") = "RETIREMENT" And parameter_RefundRequestDataTable.Rows(0)("RefundType") = "PART" Then
                If l_decimaltotal <> Me.NumRequestedAmountRetirement Then
                    ...
                    If Not Session("RetirementAccountTypeAdjusted") Is Nothing Then
                        l_AcctType = Session("RetirementAccountTypeAdjusted")
                    End If
                    ll_round = True
                End If
            ElseIf parameter_RefundRequestDataTable.Rows(0)("PlanType") = "SAVINGS" And parameter_RefundRequestDataTable.Rows(0)("RefundType") = "PART" Then
                If l_decimaltotal <> Me.NumRequestedAmountSavings Then
                    ...
                    If Not Session("SavingsAccountTypeAdjusted") Is Nothing Then
                        l_AcctType = Session("SavingsAccountTypeAdjusted")
                    End If
                    ll_round = True
                End If
            End If
    ...
    ''                            '    Session("TotalAmtForReleaseBlnk") = l_Decimal_TDAmount
    ''                            '    'Shubhrata Mar 2nd,2007 YREN-3118
    ''                            'Else
    ''                            '    l_Decimal_OtherAmount += l_Decimal_Total
    ''                            '    'Shubhrata Mar 2nd,2007 YREN-3118
...
#Region "Refund Processing Functions"
    Public Function SaveRefundRequestProcess(ByVal parameterDataGridDeductions As DataGrid, ByVal l_dec_TDAmount As Decimal, ByVal l_dec_TDRequestedAmount As Decimal, ByVal l_decimalTaxAmount As Decimal, ByVal l_ForcetoPersonalWithdrawal As Boolean, ByVal l_dec_DeferedRollOverAmount As Decimal) As String
        ...
        Try
            ...
            '09-Dec-2009        Parveen     Changes for the Hardship and VOL withdrawal Issue
            If Me.RefundType = "HARD" Or CType(Session("ForceToVoluntaryWithdrawal"), Boolean) = True Then
                ...
                Session("Initial_RefRequestId") = Me.SessionRefundRequestID
    ...
    Private Sub CreateMrdDisbursementLinkage()
        ...
        Try
            l_dtMrdRecords = CType(Session("dtMrdRecords"), DataTable)

            If HelperFunctions.isEmpty(l_dtMrdRecords) Then
                Exit Sub
            End If
            l_DisbursementsDataTable = DirectCast(Session("R_Disbursements"), DataTable)
            l_DisbursementDetailssDataTable = DirectCast(Session("R_DisbursementDetails"), DataTable)

            l_dtMrdRecordsDisbursements = DirectCast(Session("R_MrdRecordsDisbursements"), DataTable)
            ...
            If Not l_DisbursementsDataTable Is Nothing AndAlso l_DisbursementsDataTable.Rows.Count > 0 AndAlso l_dtMrdRecords.Rows.Count > 0 Then
                ...
                l_dtMrdRecordsDisbursements.AcceptChanges()
                Session("R_MrdRecordsDisbursements") = l_dtMrdRecordsDisbursements
            End If
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Function CreateDataForMarketWithdrawal() As DataTable
        Try
            ...
            l_currentDatable = DirectCast(Session("ArrayRefundableDataTable"), DataTable).Copy()
            l_requestedDatable = DirectCast(Session("AvailableBalance"), DataTable)
            ...
            Session("MarketDataTable") = l_marketDatable
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Private Function HardShipCalculation()
        ...
        Try
            ...
            l_CurrentAccountDataTable = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
            l_Payee1DataTable = DirectCast(Session("Payee1DataTable"), DataTable)
            'Hafiz 03Feb06 Cache-Session
    ...
    Private Function GetTransactionDetails(ByVal parameterFundID As String, ByVal parameterForcetoPersonalWithdrawal As Boolean) As String
        ...
        Try
            If Me.RefundType = "PART" Or Me.RefundType = "MRD" Then
                l_DataTablePartial = YMCARET.YmcaBusinessObject.RefundRequest.GetPartialWithdrawalTransaction(Session("RefundRequestID"))
            End If

            l_DataTableCurrentBalance = YMCARET.YmcaBusinessObject.RefundRequest.GetTransactions(parameterFundID)

            l_DataTableforMarket = YMCARET.YmcaBusinessObject.RefundRequest.GetTransactionsForMarketForSaveProcess(parameterFundID, Session("RefundRequestID"))
            Session("DataforIsMarketCheck") = l_DataTableforMarket
            ...
            End If
            Session("ForceToVoluntaryWithdrawal") = Nothing
            ...
            Session("AvailableBalance") = l_DataTable
            ...
            If parameterForcetoPersonalWithdrawal = True Then
                ...
                l_DataTable = DirectCast(Session("CalculatedDataTableForRefundable"), DataTable)
    ...
    Public Function GetTransactionofDefferedPayment(ByVal parameterFundID As String) As Decimal
        ...
        Try
            ...
            l_RefundableDataTable = DirectCast(Session("RefundableDataTable"), DataTable)
            'Added By Parveen on 7-Nov-2009 for Calculating Deferred payments
    ...
    Public Function CreateDeferedTaxablePercentage() As Decimal
        ...
        l_DataTableMarket = DirectCast(Session("DataforIsMarketCheck"), DataTable)
        l_DataTable = DirectCast(Session("Payee2DataTable"), DataTable)
        For Each l_DataRow In l_DataTable.Rows
    ...
    Private Function ReduceAvailableBalance()
        ...
        Try
            ...
            l_AnnuityBasisArray = DirectCast(Session("AnnuityBasisTypeArray"), String())

            l_RefundableDataTable = DirectCast(Session("RefundableDataTable"), DataTable) 'DirectCast(Session("RequestedAccounts"), DataTable)   'DirectCast(Session("RefundableDataTable"), DataTable) '
            ...
            Session("ArrayRefundableDataTable") = l_ArrayRefundDataTable
            If Me.ISMarket = -1 Then
            ...
            l_AvailableBalanceDataTable = DirectCast(Session("AvailableBalance"), DataTable)
    ...
    Private Function CreateRowsForDisbursements(ByVal l_dec_TDAmount As Decimal, ByVal l_dec_TDRequestedAmount As Decimal)
        ...
        Try
            ...
            Next
            l_AvailableBalanceDataTable = DirectCast(Session("AvailableBalance"), DataTable)
            ' l_dt_TransactionDataTable = Session("ArrayRefundableDataTable")
            ...
            l_AnnuityBasisTypeArray = DirectCast(Session("AnnuityBasisTypeArray"), String())
                                    ...
                                    If (l_Decimal_PersonalPostTax + l_Decimal_PersonalPreTax + l_Decimal_YMCAPreTax) > 0.0 Then
                                        ...
                                        For l_PayeeCounter = 1 To 4
                                            ...
                                            Select Case l_PayeeCounter
                                                Case 1
                                                    l_SelectDataTable = DirectCast(Session("Payee1DataTable"), DataTable)

                                                Case 2
                                                    l_SelectDataTable = DirectCast(Session("Payee2DataTable"), DataTable)

                                                Case 3
                                                    l_SelectDataTable = DirectCast(Session("Payee3DataTable"), DataTable)

                                                Case 4
                                                    l_SelectDataTable = DirectCast(Session("MinimumDistributionTable"), DataTable)
                                            End Select
...
#End Region     'Hardship Principle 
    Private Function SetDisbursementDataRow(ByVal parameterIndex As Integer, ByVal parameterCurrencyCode As String) As DataRow '-- SetDisbArray - in FoxPro application.
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("R_Disbursements"), DataTable)
            ...
            If Not l_DataTable Is Nothing Then
                ...
                If l_DataRow Is Nothing Then
                    ...
                    l_DataRow("PayeeEntityTypeCode") = IIf((parameterIndex = 1 Or parameterIndex = 4), "PERSON", "ROLINS")  '&& Payee Entity Type
    ...
    Private Function SetDisbursementDetailsDataRow(ByVal parameterAccountType As String, ByVal parameterAcctBreakdownType As String, ByVal parameterDisbursementID As String, ByVal parameterSortOrder As String, ByVal parameterPalnType As String) As DataRow
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("R_DisbursementDetails"), DataTable)
    ...
    Private Function SetTransactionDataRow(ByVal parameterAvailableBalance As DataRow, ByVal parameterIndex As Integer, ByVal parameterTransactionType As String) As DataRow
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("R_Transactions"), DataTable)
    ...
    Private Function SetRefundsDataRow(ByVal parameterTransactionID As String, ByVal paramterSelectedDataRow As DataRow, ByVal parameterAccountType As String, ByVal parameterDisbursementID As String, ByVal parameterAnnuityBasisType As String)
        ...
        Try
            ...
            l_DataTable = DirectCast(Session("R_Refunds"), DataTable)
            ...
            If (l_Decimal_SelectedTaxableAmount > 0.0 And l_Decimal_YMCAPreTax > 0.0) Then
                ...
                If True Then
                    ...
                    If Me.IsVested = True Or l_AccountGroup = m_const_RetirementPlan_AM Or l_AccountGroup = m_const_SavingsPlan_TM Then
                        ...
                        If Not Session("HasPersonalSideForAM") Is Nothing Then
...
#End Region 'Refund Interest
    ...
    Private Function SetTransactTypeForMarketWithdrawal()
        ...
        l_TransactionsDataTable = DirectCast(Session("R_Transactions"), DataTable)
        l_requestedDatable = DirectCast(Session("AvailableBalance"), DataTable)
    ...
    Private Function MakeTablesToUpdate(ByVal l_decimalTaxAmount As Decimal)
        ...
        Try
            ...
            l_RefundsDataTable = DirectCast(Session("R_Refunds"), DataTable)
            l_TransactionsDataTable = DirectCast(Session("R_Transactions"), DataTable)
            l_DisbursementsDataTable = DirectCast(Session("R_Disbursements"), DataTable)
            l_DisbursementDetailsDataTable = DirectCast(Session("R_DisbursementDetails"), DataTable)
            l_DisbursementWithholdingDataTable = DirectCast(Session("R_DisbursementWithholding"), DataTable)
            l_DisbursementRefundsDataTable = DirectCast(Session("R_DisbursementRefunds"), DataTable)
            ...
            l_RefundRequestDataTable = DirectCast(Session("RefundRequestTable"), DataTable)
            'Hafiz 03Feb06 Cache-Session
    ...
    Private Function SaveAllTable(ByVal l_decimalTaxAmount As Decimal, ByVal l_decDeferedRollOverAmount As Decimal, ByVal l_Decimal_DeferedTaxablePercentage As Decimal, ByVal l_Decimal_DeferedNonTaxablePercentage As Decimal) As String
        ...
        Try
            ...
            l_UpdateAvailableBalance = Session("ArrayRefundableDataTable")
            If Me.ISMarket = -1 Then
                l_MarketDataTable = Session("MarketDataTable")
            End If
            ...
            If Not Session("RefundsDataSetForNewRequests") Is Nothing Then

                l_ds_NewRequests = DirectCast(Session("RefundsDataSetForNewRequests"), DataSet)
            End If
            l_BooleanFlag = YMCARET.YmcaBusinessObject.RefundRequest.SaveRefundRequestProcess(l_DataSet, Me.PersonID, Me.FundID, Me.RefundType, Me.IsVested, Me.IsTerminated, Me.IsTookTDAccount, Me.SessionStatusType, l_ds_NewRequests, Session("NeedsNewRequests"), Session("Initial_RefRequestId"), IIf(Me.ISMarket = -1, True, False), Me.TaxRate, Me.Payee1Name, Me.Payee2ID, l_decDeferedRollOverAmount, Me.ISMarket, l_Decimal_DeferedTaxablePercentage, l_Decimal_DeferedNonTaxablePercentage, IRSOverride) 'SR | 2016.09.23 | YRS-AT-3164 - Send IRSOverride flag.
    ...
    Private Function ProcessSendMail()
        ...
        Try
            ...
            dtYMCAInformation = Session("Member Employment")
    ...
    Public Function SendMail(ByVal string_MailID)
        ...
        Try
            ...
            'If isNonEmpty(Session("PersonInformation")) Then
            dsPersonInformation = Session("PersonInformation")

            'SR:2013.10.28 : BT-2247/YRS 5.0-2229: Get TD Locking period for person
            dtLockingPeriod = YMCARET.YmcaBusinessObject.RefundRequest.GetTDLockingPeriod(Session("RefundRequestID"))
            ...
            If HelperFunctions.isNonEmpty(dsPersonInformation) Then 'MMR | 2017.11.29 | YRS-AT-3415 | Used common method instead of local method 'isNonEmpty' to check empty object value
                'If (Session("PersonInformation").Tables(0).Rows.Count > 0) Then
                'With Session("PersonInformation").Tables(0).Rows(0)
                With dsPersonInformation.Tables(0).Rows(0)
                    ...
                    End If
                End With
                'string_ParticipantName = Session("PersonInformation").Tables(0).Rows(0)(2) + " " + Session("PersonInformation").Tables(0).Rows(0)(3) + " " + Session("PersonInformation").Tables(0).Rows(0)(1)
                ' End If
    ...
    Private Function SetWithholdingDeductionProperties(ByVal parameterDataGridDeductions As DataGrid)
        ...
        Dim l_WithHoldingDataRow As DataRow
        Try
            dt_WithholdingDeductionProperties = DirectCast(Session("R_DisbursementWithholding"), DataTable)
...
#End Region
    Public Function PrepareTableforHardshipProcessing() As DataTable
        ...
        Try
            If Not Session("CalculatedDataTableForCurrentAccounts") Is Nothing Then
                l_CalculatedDataTableForCurrentAccounts = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
                l_ContributionTableforHardshipProcessing = l_CalculatedDataTableForCurrentAccounts.Clone()
            End If

            If Not Session("Payee1DataTable") Is Nothing Then
                l_Payee1DataTable = DirectCast(Session("Payee1DataTable"), DataTable)
    ...
    Private Function MakeTableforRefundRequest(ByVal paramaterCalculatedDataTable As DataTable, ByVal PrameterPlanType As String) As Boolean
        ...
        Try
            ...
            '09-Dec-2009        Parveen     Changes for the Hardship and VOL withdrawal Issue
            If PrameterPlanType = "SAVINGS" Or CType(Session("ForceToVoluntaryWithdrawal"), Boolean) = True Then
                'l_DataRow("HardShipAmt") = Me.Session("TDTotalAmount") ' "0.00"
                l_DataRow("HardShipAmt") = "0.00"
            End If
            'l_DataRow("HardShipAmt") = "0.00"
            ...
            If l_StringUniqueId <> "" Then
                ...
                l_RefundRequestDataTable.AcceptChanges()
                l_RefundRequestDetailsDataTable.AcceptChanges()
                Session("RefundRequestID") = l_StringUniqueId
                Session("AtsRefRequests") = l_RefundRequestDataTable

                Session("AtsRefRequestDetails") = l_RefundRequestDetailsDataTable
                l_RefundDataSet.Tables.Add(l_RefundRequestDataTable)
                l_RefundDataSet.Tables.Add(l_RefundRequestDetailsDataTable)
                Session("RefundsDataSetForNewRequests") = l_RefundDataSet
                Dim l_dt_NewRefundRequestTable As DataTable
                Dim l_dr_NewRowRefundRequestTable As DataRow
                If Not Session("RefundRequestTable") Is Nothing Then
                    l_dt_NewRefundRequestTable = DirectCast(Session("RefundRequestTable"), DataTable).Clone
                    ...
                    Session("RefundRequestTable") = l_dt_NewRefundRequestTable
                End If
...
#Region "Properties "
    ...
    Public Property FirstInstallment() As Decimal
        Get
            If Not Session("FirstInstallment") Is Nothing Then
                Return (DirectCast(Session("FirstInstallment"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("FirstInstallment") = Value
        End Set
    End Property
    Public Property DefferredInstallment() As Decimal
        Get
            If Not Session("DefferredInstallment") Is Nothing Then
                Return (DirectCast(Session("DefferredInstallment"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("DefferredInstallment") = Value
        End Set
    End Property
    'Added by Amit on 23-11-2009
    ...
    Public Property DefferredPaymentAmount() As Decimal
        Get
            If Not Session("DefferredPaymentAmount") Is Nothing Then
                Return (DirectCast(Session("DefferredPaymentAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("DefferredPaymentAmount") = Value
        End Set
    End Property
    Public Property DefferredInstallmentAmount() As Decimal
        Get
            If Not Session("DefferredInstallmentAmount") Is Nothing Then
                Return (DirectCast(Session("DefferredInstallmentAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("DefferredInstallmentAmount") = Value
        End Set
    End Property
    Public Property DefferredInstallmentAmountTaxable() As Decimal
        Get
            If Not Session("DefferredInstallmentAmountTaxable") Is Nothing Then
                Return (DirectCast(Session("DefferredInstallmentAmountTaxable"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("DefferredInstallmentAmountTaxable") = Value
        End Set
    End Property
    Public Property DefferredInstallmentAmountNonTaxable() As Decimal
        Get
            If Not Session("DefferredInstallmentAmountNonTaxable") Is Nothing Then
                Return (DirectCast(Session("DefferredInstallmentAmountNonTaxable"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("DefferredInstallmentAmountNonTaxable") = Value
        End Set
    End Property
    'Added by Dilip  on 23-11-2009 for Defered Rollover
    ...
    Public Property DisplayMessageForLetters() As Boolean
        Get
            If Not Session("DisplayMessageForLetters") Is Nothing Then
                Return (CType(Session("DisplayMessageForLetters"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("DisplayMessageForLetters") = Value
        End Set
    End Property
    ...
    Public Property IsSaveProcessComplete() As Boolean
        Get
            If Not Session("IsSaveProcessComplete") Is Nothing Then
                Return (CType(Session("IsSaveProcessComplete"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("IsSaveProcessComplete") = Value
        End Set
    End Property
    'Added the Property to check the save is done or not-Amit 09-09-2009
    ...
    Public Property RefundState() As String
        Get
            If Not Session("RefundState") Is Nothing Then
                Return (DirectCast(Session("RefundState"), String))
            Else
                Return "R"
    ...
    Public Property PlanTypeChosen() As String
        Get
            If Not Session("PlanTypeChosen") Is Nothing Then
                Return (DirectCast(Session("PlanTypeChosen"), String))
            Else
                Return String.Empty
            End If
    ...
    Public Property Payee1Name() As String
        Get
            If Not Session("Payee1Name") Is Nothing Then
                Return (DirectCast(Session("Payee1Name"), String))
            Else
                Return String.Empty
            End If
    ...
    Private Property RoundingAmount() As Decimal
        Get
            If Not Session("RoundingAmount") Is Nothing Then
                Return (DirectCast(Session("RoundingAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("RoundingAmount") = Value
        End Set
    End Property
    ...
    Private Property TDTotalAmount() As Decimal
        Get
            If Not Session("TDTotalAmount") Is Nothing Then
                Return (DirectCast(Session("TDTotalAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TDTotalAmount") = Value
        End Set
    End Property
    'Added By Ganeswar on 2009 Aug 04
    ...
    Private Property ChangedRefundType() As String
        Get
            If Not Session("ChangedRefundType") Is Nothing Then
                Return (DirectCast(Session("ChangedRefundType"), String))
            Else
                Return String.Empty
            End If
    ...
    Private Property SessionRefundRequestID() As String
        Get
            If Not (Session("RefundRequestID")) Is Nothing Then
                Return (DirectCast(Session("RefundRequestID"), String))
            Else
                Return String.Empty
            End If
        End Get
    ...
    Private Property HardshipAmount() As Decimal
        Get
            If Not Session("HardshipAmount") Is Nothing Then
                Return (DirectCast(Session("HardshipAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property HardShipTaxRate() As Decimal
        Get
            If Not Session("HardShipTaxRate") Is Nothing Then
                Return (DirectCast(Session("HardShipTaxRate"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property TDUsedAmount() As Decimal
        Get
            If Not Session("TDUsedAmount") Is Nothing Then
                Return (DirectCast(Session("TDUsedAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property RetirementPlan_MinDistributionAmount() As Decimal
        Get
            If Not Session("RetirementPlan_MinDistributionAmount") Is Nothing Then
                Return (CType(Session("RetirementPlan_MinDistributionAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("RetirementPlan_MinDistributionAmount") = Value
        End Set
    End Property
    Private Property Saving_MinDistributionAmount() As Decimal
        Get
            If Not Session("Saving_MinDistributionAmount") Is Nothing Then
                Return (CType(Session("Saving_MinDistributionAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("Saving_MinDistributionAmount") = Value
        End Set
    End Property
    ...
    Private Property MaximumBAAmount() As Decimal
        Get
            If Not Session("MaximumBAAmount") Is Nothing Then
                Return (DirectCast(Session("MaximumBAAmount"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("MaximumBAAmount") = Value
        End Set
    End Property
    ...
    Private Property BATerminationPIA() As Decimal
        Get
            If Not Session("BATerminationPIA") Is Nothing Then
                Return (DirectCast(Session("BATerminationPIA"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("BATerminationPIA") = Value
        End Set
    End Property
    ...
    Public Property HasPersonalMoney() As Decimal
        Get
            If Not Session("HasPersonalMoney") Is Nothing Then
                Return (DirectCast(Session("HasPersonalMoney"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("HasPersonalMoney") = Value
        End Set
    End Property
    ' To get / set VoluntryAmount
    Public Property VoluntryAmountForProcessing() As Decimal
        Get
            If Not Session("VoluntryAmountForProcessing") Is Nothing Then
                Return (DirectCast(Session("VoluntryAmountForProcessing"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("VoluntryAmountForProcessing") = Value
        End Set
    End Property
    ...
    Public Property VoluntryAmount_Retirement() As Decimal
        Get
            If Not Session("VoluntryAmount_Retirement") Is Nothing Then
                Return (DirectCast(Session("VoluntryAmount_Retirement"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("VoluntryAmount_Retirement") = Value
        End Set
    End Property
    Public Property VoluntryAmount_Savings() As Decimal
        Get
            If Not Session("VoluntryAmount_Savings") Is Nothing Then
                Return (DirectCast(Session("VoluntryAmount_Savings"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("VoluntryAmount_Savings") = Value
        End Set
    End Property
    ...
    Private Property ISMarket() As Int16
        Get
            If Not Session("ISMarket") Is Nothing Then
                Return (CType(Session("ISMarket"), Int16))
            Else
                Return 1
            End If
    ...
    Private Property SessionStatusType() As String
        Get
            If Not (Session("StatusType")) Is Nothing Then
                Return (Trim(DirectCast(Session("StatusType"), String))) '--SR | 2016.08.25 | YRS-AT-3084 - Remove unnecessary spaces.
            Else
                Return String.Empty
            End If
        End Get
    ...
    Public Property RetirementPlan_TotalAmount() As Decimal
        Get
            If Not Session("RetirementPlan_TotalAmount") Is Nothing Then
                ...
                Return (CType(Session("RetirementPlan_TotalAmount"), String))
            Else
                Return 0.0
            End If
    ...
    Public Property SavingsPlan_TotalAmount() As Decimal
        Get
            If Not Session("SavingsPlan_TotalAmount") Is Nothing Then
                Return (DirectCast(Session("SavingsPlan_TotalAmount"), String))
            Else
                Return 0.0
            End If
    ...
    Public Property AddressId() As Integer
        Get
            If Not Session("AddressId") Is Nothing Then
                Return (DirectCast(Session("AddressId"), Integer))
            Else
                Return 0.0
            End If
    ...
    Public Property TaxAmount() As Decimal
        Get
            If Not Session("TotalTaxAmount") Is Nothing Then
                Return (DirectCast(Session("TotalTaxAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("TotalTaxAmount") = Value
        End Set
    End Property
    Public Property TaxedAmount() As Decimal
        Get
            If Not Session("TaxedAmount") Is Nothing Then
                Return (DirectCast(Session("TaxedAmount"), Decimal))
            Else
                Return 0.0
            End If
        ...
        End Get
        Set(ByVal Value As Decimal)
            Session("TaxedAmount") = Value
        End Set
    End Property
    Public Property NonTaxedAmount() As Decimal
        Get
            If Not Session("NonTaxedAmount") Is Nothing Then
                Return (DirectCast(Session("NonTaxedAmount"), Decimal))
            Else
                Return 0.0
            End If
    ...
    Private Property NumRequestedAmountRetirement() As Decimal
        Get
            If Not Session("RequestedAmountRetirement") Is Nothing Then
                Return (DirectCast(Session("RequestedAmountRetirement"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Public Property RolloverOptions() As String
        Get
            If Not Session("RolloverOptions") Is Nothing Then
                Return (DirectCast(Session("RolloverOptions"), String))
            Else
                Return String.Empty
        ...
        End Get
        Set(ByVal Value As String)
            Session("RolloverOptions") = Value
        End Set
    End Property

    Public Property FirstRolloverAmt() As Decimal
        Get
            If Not Session("FirstRolloverAmt") Is Nothing Then
                Return (DirectCast(Session("FirstRolloverAmt"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("FirstRolloverAmt") = Value
        End Set
    End Property

    Public Property TotalRolloverAmt() As Decimal
        Get
            If Not Session("TotalRolloverAmt") Is Nothing Then
                Return (DirectCast(Session("TotalRolloverAmt"), Decimal))
            Else
                Return 0.0
            End If
        End Get
        Set(ByVal Value As Decimal)
            Session("TotalRolloverAmt") = Value
        End Set
    End Property
    'Added by Parveen on 15-Dec-2009 for the RolloverOptions
...
#Region "properties for Hardship_Create Payees"
    Public Property inTaxable() As Decimal
        Get
            If Not Session("inTaxable") Is Nothing Then
                Return (DirectCast(Session("inTaxable"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Public Property inNonTaxable() As Decimal
        Get
            If Not Session("inNonTaxable") Is Nothing Then
                Return (DirectCast(Session("inNonTaxable"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Public Property inGross() As Decimal
        Get
            If Not Session("inGross") Is Nothing Then
                Return (DirectCast(Session("inGross"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Public Property inVolAcctsUsed() As Decimal
        Get
            If Not Session("inVolAcctsUsed") Is Nothing Then
                Return (DirectCast(Session("inVolAcctsUsed"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Public Property inVolAcctsAvailable() As Decimal
        Get
            If Not Session("inVolAcctsAvailable") Is Nothing Then
                Return (DirectCast(Session("inVolAcctsAvailable"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property ReCalculatedRMDValues() As DataSet
        Get
            If Not (Session("ReCalculatedRMDValuesForWithDrawal")) Is Nothing Then

                Return (DirectCast(Session("ReCalculatedRMDValuesForWithDrawal"), DataSet))
            Else
                Return Nothing
            End If
        End Get
        Set(ByVal Value As DataSet)
            Session("ReCalculatedRMDValuesForWithDrawal") = Value
        End Set
    End Property
    ...
    Public Function DoFullOrPersRefundForDisplay(ByVal parameterCalledBy As String)
        ...
        Try
            If parameterCalledBy = "IsRetirement" Then
                ...
                If Not Session("Calculated_DisplayRetirementPlanAcctContributionforMarket") Is Nothing And Session("blnMarketCheck") = False Then
                    l_ContributionDataTable = DirectCast(Session("Calculated_DisplayRetirementPlanAcctContributionforMarket"), DataTable)
                End If
                'New Modification for Market Based Withdrawal Amit Nigam 06/oct/2009        
            ElseIf parameterCalledBy = "IsSavings" Then
                If Not Session("Calculated_DisplaySavingsPlanAcctContribution") Is Nothing Then
                                ...
                                ElseIf Me.RefundType = "REG" Then
                                    ...
                                    If Me.SessionStatusType.ToUpper.Trim = "QD" Then
                                        If Not Session("QDROParticipantAge") Is Nothing Then
                                            l_integer_QDROParticipantAge = DirectCast(Session("QDROParticipantAge"), Integer)
    ...
    Public Function CalculateTotalForDisplay(ByVal l_CalculatedDataTable As DataTable, ByVal bool_check As Boolean) As DataTable
        ...
        Try
            ...
            If Not l_CalculatedDataTable Is Nothing Then
                ...
                'IB:As on 21/June/2010 BT-545:Casting problem
                'MarketAccountType = "Market Based (" + DirectCast(Session("MarketBasedFirstInstPercentage"), String) + "%)"
                ...
                If Me.RefundType <> "SPEC" Or Me.RefundType <> "DISAB" Or Me.RefundType = "HARD" Then
                    ...
                    If l_TotalDataRow.Length > 0 Then
                        If DirectCast(l_TotalDataRow(0)("Total"), Decimal) > DirectCast(Session("MarketBasedThreshold"), Decimal) And Me.AllowMarketBased = True And Me.RefundType <> "HARD" Then
                            ...
                            If l_MarketRow.Length = 0 Then
                                ...
                                'IB:As on 21/June/2010 BT-545:Casting problem
                                'l_MarketDataRow("AccountType") = "Market Based (" + DirectCast(Session("MarketBasedFirstInstPercentage"), String) + "%)"
                                l_MarketDataRow("AccountType") = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)"
                                l_MarketDataRow("Taxable") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Taxable") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                                l_MarketDataRow("Non-Taxable") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Non-Taxable") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                                l_MarketDataRow("Interest") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Interest") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))

                                If bool_check = True Then
                                    l_MarketDataRow("TaxWithheld") = Convert.ToDecimal(Format(l_TotalDataRow(0)("TaxWithheld") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                                End If
                                'commented and modified to adjust the rounding issues-17/11/2009 Amit
                                '_MarketDataRow("Total") = l_TotalDataRow(0)("Total") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100)
                                'l_MarketDataRow("Total") = l_MarketDataRow("Taxable") + l_MarketDataRow("Non-Taxable") + l_MarketDataRow("Interest")
                                l_MarketDataRow("Total") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Total") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                            ...
                            Else
                                'l_MarketRow(0)("AccountType") = "Market Based (" + DirectCast(Session("MarketBasedFirstInstPercentage"), String) + "%)"
                                l_MarketRow(0)("AccountType") = "Market Based (" + CType(Session("MarketBasedFirstInstPercentage"), String) + "%)"
                                l_MarketRow(0)("Taxable") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Taxable") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                                l_MarketRow(0)("Non-Taxable") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Non-Taxable") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                                l_MarketRow(0)("Interest") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Interest") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                                If bool_check = True Then
                                    l_MarketRow(0)("TaxWithheld") = Convert.ToDecimal(Format(l_TotalDataRow(0)("TaxWithheld") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                                End If
                                'commented and modified to adjust the rounding issues-17/11/2009 Amit
                                'l_MarketRow(0)("Total") = l_TotalDataRow(0)("Total") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100)
                                'l_MarketRow(0)("Total") = l_MarketRow(0)("Taxable") + l_MarketRow(0)("Non-Taxable") + l_MarketRow(0)("Interest")
                                l_MarketRow(0)("Total") = Convert.ToDecimal(Format(l_TotalDataRow(0)("Total") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
            ...
            For Each drow As DataRow In l_CalculatedDataTable.Rows
                If drow("Selected").GetType.ToString() <> "System.DBNull" Then
                    If drow("AccountType").ToString.Trim() <> "Market Based (10%)" And drow("AccountType").ToString.ToUpper.Trim() = "TOTAL" And drow("AccountType").GetType.ToString() <> "System.DBNull" And drow("Selected") = True Then
                        totalamount += Convert.ToDecimal(Format(drow("Taxable") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00")) + Convert.ToDecimal(Format(drow("Non-Taxable") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00")) + Convert.ToDecimal(Format(drow("Interest") * (DirectCast(Session("MarketBasedFirstInstPercentage"), Decimal) / 100), "0.00"))
                    End If
                End If
            Next
            Return totalamount
                    ...
                    If drow("AccountGroup").GetType.ToString <> "System.DBNull" Then
                        ...
                        Else
                            ...
                            If l_dr_DisplaySavingsPlan("AccountType") = "TD" Then
                                ...
                                Me.Session("TDTotalAmount") = Math.Round(drow("Total"), 2)
                            End If
                            l_dr_DisplaySavingsPlan("Taxable") = Math.Round((drow("Taxable") * parameterNumPercentageFactorSavingsPlan), 2)
                            l_dr_DisplaySavingsPlan("Non-Taxable") = Math.Round((drow("Non-Taxable") * parameterNumPercentageFactorSavingsPlan), 2)
                            l_dr_DisplaySavingsPlan("Interest") = Math.Round((drow("Interest") * parameterNumPercentageFactorSavingsPlan), 2)
...
#Region "YRSPS 4212"
    ...
    Private Function PrepareDisbursementDetailsAfterTaxes()
        Try
            ...
            If Not Session("R_DisbursementDetails") Is Nothing Then
                l_DisbursementDetailsDataTable = DirectCast(Session("R_DisbursementDetails"), DataTable)
            Else
                Exit Function
            End If

            If Session("R_DisbursementWithholding") Is Nothing Then Exit Function
            ...
            Session("R_DisbursementDetails") = l_DisbursementDetailsDataTable
        Catch ex As Exception
            Throw ex
        End Try
    End Function
#End Region
    ...
    Public Function IsTerminatedEmployment() As Boolean
        ...
        Try
            dtEmployment = CType(Session("Member Employment"), DataTable)
    ...
    Public Function IsNonParticipatingPerson() As Boolean
        ...
        Dim fundStatus As String = Session("StatusType")
    ...
    ''' <summary>
    ''' This function returns Prorate requested amount for Payee 1 from Session("CalculatedDataTableForCurrentAccounts") for Hardship processing.
    ''' </summary>
    ''' <param name=""></param>
    ...
    Private Function ProrateHardshipAmountForPayee1()
        ...
        Try
            ...
            currentAccountDataTable = DirectCast(Session("CalculatedDataTableForCurrentAccounts"), DataTable)
            payee1DataTable = DirectCast(Session("Payee1DataTable"), DataTable)
    ...
    ''' <summary>
    ''' This function returns Prorate data available in Session("CalculatedDataTableForCurrentAccounts") for Hardship processing.
    ''' </summary>
    ''' <param name=""></param>
    ''' <returns>void</returns>
    ''' <remarks></remarks>
    ...
    Private Function GetRefundRequestTableValue(ByVal columnName As String, ByVal defaultValue As String) As String
        ...
        If Not Session("RefundRequestDataTable") Is Nothing Then
            refundRequest = DirectCast(Session("RefundRequestDataTable"), DataTable)
