...
#End Region
        ...
        Try
            ...
            If (Not IsNothing(g_dataset_dsContact)) Then
                ...
                Else
                    ...
                    DataGridList.DataSource = g_dataset_dsContact
                    DataGridList.DataBind()
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub DataGridList_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridList.SelectedIndexChanged
        ...
        Try
            ...
            End If
            ' SM.YMCAMaintenance = New YMCAUI.SessionManager.YMCAMaintenance
            SM.YMCAMaintenance.ContactSearchCancel = False
            ...
            ' Me.SearchContact(Me.TextBoxListFundNo.Text.Trim, Me.TextBoxLastName.Text.Trim, Me.TextBoxFirstName.Text.Trim)
            l_FundNo = DataGridList.SelectedItem.Cells(1).Text.Trim
            ...
            SM.YMCAMaintenance.ContactType = String.Empty
            SM.YMCAMaintenance.ContactNote = String.Empty
        ...
        Try
            ...
            If HelperFunctions.isNonEmpty(g_dataset_dsContact) Then
                ...
                Else
                    ...
                    ViewState("previousSearchSortExpression") = e.SortExpression
                End If
                BindGrid(DataGridList, g_dataset_dsContact.Tables(0).DefaultView)
...
#Region "Local Variable Persistence mechanism"
    ...
    Private Sub InitializeLocalVariablesFromCache(ByRef obj As Object)
        ...
        g_dataset_dsContact = Session("DC_g_dataset_dsContact")
    End Sub
    Private Function StoreLocalVariablesToCache() As Object
        ...
        Session("DC_g_dataset_dsContact") = g_dataset_dsContact
    End Function
#End Region
