...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RefundRequestForm_C19.aspx.vb" Inherits="YMCAUI.RefundRequestForm_C19" %>
...
<form id="Form1" method="post" runat="server">  
    ...
    <div class="Div_Center">
        <table width="698">
            ...
            <tr>
                <%--START : Suvarna B. : 2020.05.05 : YRS-AT-4854 : Added Covid label at header--%>
               <td>
                    <table style="width: 100%">
                        <tr>
                             <td class="Td_HeadingFormContainer" align="left" style="width:85%">
                              ...
                              <td align="left" style="background-color: red; width:15%;font-weight:normal;">
                                <font color="white">COVID19 screen</font>
                            </td>
                        </tr> 
                    </table>
                </td>
                <%--END : Suvarna B. : 2020.05.05 : YRS-AT-4854 : Added Covid label at header--%>
            </tr>
