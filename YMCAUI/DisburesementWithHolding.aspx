<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DisburesementWithHolding.aspx.vb" Inherits="YMCAUI.DisburesementWithHolding"%>
								...
								<tr>
									<td>
										<DIV style="OVERFLOW: auto; WIDTH: 680px; HEIGHT: 100px; TEXT-ALIGN: center">
											...
											<asp:BoundColumn DataField="DisbursementNumber" HeaderText="Number" visible=false></asp:BoundColumn>
											<asp:BoundColumn DataField="chrAcctType" HeaderText="Acct Type"></asp:BoundColumn>
											<asp:BoundColumn DataField="chrAcctBreakDownType" HeaderText="chrAcctBreakDownType"></asp:BoundColumn>
											<asp:BoundColumn DataField="TaxablePrincipal" HeaderText="Taxable Principal"></asp:BoundColumn>
											<asp:BoundColumn DataField="TaxableInterest" HeaderText="Taxable Interest"></asp:BoundColumn>
											<asp:BoundColumn DataField="NonTaxablePrincipal" HeaderText="NonTaxable Principal"></asp:BoundColumn>
											<asp:BoundColumn DataField="WithheldPrincipal" HeaderText="Withheld Principal"></asp:BoundColumn>
											<asp:BoundColumn DataField="WithheldInterest" HeaderText="Withheld Interest"></asp:BoundColumn>		
												</Columns>
											</asp:DataGrid>
										</DIV>
									</td>
