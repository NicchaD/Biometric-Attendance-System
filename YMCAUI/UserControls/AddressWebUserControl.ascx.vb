...
'Bhavna Shrivastava 17-May-2012     YRS 5.0-1470: Link to Address Edit program from Person Maintenance
'Manthan Rajguru    2015.09.16      YRS-AT-2550: YRS data cleanup: copyright comments and namespace (Changed the Namespace reference from 'Infotech' to 'YMCARET')
'********************************************************************************************************************************
Public Class AddressWebUserControl
    ...
    'BS:2012.05.16:YRS 5.0-1470
    Protected WithEvents Is_QASMatched As System.Web.UI.WebControls.HiddenField
...
#Region " Custom Methods "
    ...
    Public Function ValidateAddress() As String
        ...
        If (IsPrimary = "1" AndAlso TextBoxAddress1.Text = String.Empty _
          ...
          AndAlso DropDownListState_hid.Value = String.Empty AndAlso TextBoxCity.Text = String.Empty) Then
        ...
        If (TextBoxAddress1.Text <> String.Empty OrElse TextBoxAddress2.Text <> String.Empty _
         ...
         OrElse TextBoxCity.Text <> String.Empty) Then
    ...
    End Function
    'BS:2012.05.16:YRS 5.0-1470:Validate Address is verified or not
    Public Function IsValidateAddress() As String
        If Is_QASMatched.Value = "false" Then
            Return "Address is not yet verified Do you want to continue to save the changes"
        End If
        Return String.Empty
    End Function
