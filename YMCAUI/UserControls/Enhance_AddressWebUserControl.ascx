<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Enhance_AddressWebUserControl.ascx.vb"
    Inherits="YMCAUI.Enhance_AddressWebUserControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<p>
    <table id="Table1" style="width: 360px; height: 192px" cellspacing="1" cellpadding="1"
        ...
        <tr>
            <td align="left">
                <asp:Label ID="LabelAddress1" CssClass="Label_Small" runat="server">Address1</asp:Label>
            </td>
            <td colspan="2" valign="middle">
                <asp:TextBox ID="TextBoxAddress1" CssClass="TextBox_Normal Warn" runat="server" Width="216px"
                    MaxLength="60"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="reqAddress" runat="server"
                        ErrorMessage="Please enter Address1" ControlToValidate="TextBoxAddress1" Display="Dynamic">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td align="left">
            ...
            <td colspan="2" valign="middle">
                <asp:TextBox ID="TextBoxAddress2" CssClass="TextBox_Normal Warn" runat="server" Width="216px"
        ...
        <tr>
            ...
            <td colspan="2" valign="middle">
                <asp:TextBox ID="TextBoxAddress3" CssClass="TextBox_Normal Warn" runat="server" Width="216px"
                    MaxLength="60"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2" valign="middle">
                <asp:TextBox ID="TextBoxCity" CssClass="TextBox_Normal Warn" runat="server" Width="216px"
                    MaxLength="30"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="rqCity" runat="server"
                        ErrorMessage="Please enter the city" ControlToValidate="TextBoxCity" Display="Dynamic">*</asp:RequiredFieldValidator>&nbsp;
            </td>
        </tr>
        <tr>
            <td align="left">
        ...
        <tr>
            ...
            <td valign="middle">
                <asp:TextBox ID="TextBoxZip" CssClass="TextBox_Normal Warn" runat="server" Width="120px"
        ...
        <tr>
            <td nowrap align="left">
                <asp:Label ID="IsBadAddress" runat="server" CssClass="Label_Small">Bad Address</asp:Label>
            </td>
            <td nowrap align="left" colspan="2" valign="middle">
                <asp:CheckBox ID="CheckboxIsBadAddress" runat="server" CssClass="CheckBox_Normal Warn"
...
<div id="divNotes" style="display: none;">
    ...
    <table border="0" class="AddressLabels" cellspacing="10" >
        <tr>
...
<script language="javascript">
    ...
    function initializeAddressControl2(drdCountry, drdState, txtCountry_hid, txtState_hid, txtZip, txtAddress1, txtAddress2, txtAddress3, txtCity, txtEffDate, chkbadAddress, txtNote, chkImp) {
        ...
        $('#' + txtEffDate).parent().after('<span class="Label_Small dummy">' + $('#' + txtEffDate).val() + '</span>');
        ...
        $('#' + drdCountry + ',#' + drdState + ',#' + txtZip + ',#' + txtAddress1 + ',#' + txtAddress2 + ',#' + txtAddress3 + ',#' + txtCity + ',#' + chkbadAddress).each(function () {
            ...
            if ($(this).is('select')) {
                ...
                if ($('option:selected', this).text() == '- Select one -') {
                    $('#' + $(this)[0].id + '_hid').after('<span class="Label_Small dummy">' + '' + '</span>');
                }
                else {
                    $('#' + $(this)[0].id + '_hid').after('<span class="Label_Small dummy">' + $('option:selected', this).text() + '</span>');
                }
            } else if ($(this).is(':checkbox')) {
                $(this).after('<span class="Label_Small dummy">' + IsBad_Address($(this).is(':checked')) + '</span>');
            } else {
                $(this).after('<span class="Label_Small dummy">' + $(this).val() + '</span>');
            }
        }
               );
...
<script language='javascript' type="text/javascript">
    ...
    function HandleQASCompletedEvent(address) {
        ...
        if ($('#QASMatched').val() == 'true') {
            $('#IsbadAddress').removeAttr('checked');
        }
        $('#state,#country').show();
    }
    ...
    function EditAddressOk_Click() {
        ...
        $('#' + arr_controls["TextBoxAddress2"]).val($("#linetwo").val());
        $('#' + arr_controls["TextBoxAddress3"]).val($("#linethree").val());
        $('#' + arr_controls["TextBoxCity"]).val($("#city").val());
        //$('#' + arr_controls["DropDownListState"]).val($("#state").val());
        $('#' + arr_controls["DropDownListState"] + "_hid").val($("#state_hid").val());
        //$('#' + arr_controls["DropDownListCountry"]).val($("#country").val());
        $('#' + arr_controls["DropDownListCountry"] + "_hid").val($("#country_hid").val());
        ...
        $('#' + arr_controls["TextBoxZip"]).val(($("#zip").val()).replace("-", ""));    //.replace("-", "")
        ...
        if ($("#IsbadAddress").filter(':checked').length == 1) {
    ...
    function OpenAddress(TextBoxAddress1, TextBoxAddress2, TextBoxAddress3, TextBoxCity, DropDownListCountry, DropDownListState, TextBoxZip, CheckboxIsBadAddress, TextBoxEffDate, txtFinalNotes, chkNotes) {
        ...
        if ($('#' + CheckboxIsBadAddress).filter(':checked').length == 1) {
            $('#IsbadAddress').attr('checked', 'checked');
        }
        else {
            $('#IsbadAddress').removeAttr('checked');
        }
