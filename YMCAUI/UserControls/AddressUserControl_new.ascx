<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AddressUserControl_new.ascx.vb"
    Inherits="YMCAUI.AddressUserControlNew" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
    ...
    <p>
        <table id="Table1" style="width: 100%;" cellspacing="1" cellpadding="1" border="0" class="Table_WithoutBorder">
            ...
            <tr valign="top">
                ...
                <td  nowrap width="120px" align="left">
                    <asp:Label ID="LabelAddress1" CssClass="Label_Small" width="60px" runat="server">Address</asp:Label><img id="imgBadAddress" runat="server" alt="Bad Address" width="15" height="15" src="../images/bad address.jpg"/>
                    
                    <%--<asp:Label ID="LabelNoAddressFound" runat="server" CssClass="Normaltext">
                    No Address information defined. </br>
                    Please click on ‘Edit icon’ to add or edit Address.</asp:Label>--%>
                </td>
                <td width="65%" class="Normaltext" >
                    ...
                    <span class="Normaltext" >
                        ...
                        <asp:TextBox ID="TextBoxAddress1" style="display:none;" CssClass="Normaltext" runat="server" Width="216px" MaxLength="60"></asp:TextBox>
                        <asp:TextBox ID="TextBoxAddress2" style="display:none;" CssClass="Normaltext" runat="server" Width="216px" MaxLength="60"></asp:TextBox>
                        <asp:TextBox ID="TextBoxAddress3" style="display:none;" CssClass="Normaltext" runat="server" Width="216px" MaxLength="60"></asp:TextBox><br />
                        <asp:TextBox ID="TextBoxCity" style="display:none;" CssClass="Normaltext" runat="server" Width="216px" MaxLength="30"></asp:TextBox>
                        <input type="hidden" runat="server" id="DropDownListState_hid" /><div>
                            <select id="DropDownListState" runat="server" class="Normaltext" style="width: 218px;display:none;">
                            </select></div>
                        <asp:TextBox ID="TextBoxZip" style="display:none;" CssClass="Normaltext"  runat="server" Width="120px" MaxLength="10"></asp:TextBox><br>
                        <div>
                            <select id="DropDownListCountry" runat="server" class="Normaltext" style="width: 218px;display:none;">
                            </select></div>
                ...
                <td align="right" width="20px">
                    ...
                    <%-- START: MMR | 2018.11.23 | YRS-AT-4018 | Added to show error message if not allowed to update address--%>
                        <%If not Me.IsPIIInformationAllowedToChange() Then %>
                        <input  type="image" src="<%= Me.ResolveClientUrl("~/images/Edit-Record.jpg") %>" style="width:15px; height:15px;" id="btnEditaddressPII" alt="Add/Edit Address"  
                            onclick="javascript:return ShowPIIErrorMessageFromAddressControl();" />
                        <%Else%>
                    <%-- END: MMR | 2018.11.23 | YRS-AT-4018 | Added to show error message if not allowed to update address--%>
                            ...
                            onclick="javascript:  OpenAddress('<%= TextBoxAddress1.ClientId %>', 
                                                              ...
                                                              '<%= LabelAddress1.ClientId %>',
                                                              '<%= LabelEffDate.ClientId %>',
                        ...
                        />
                        <%End If%> <%-- MMR | 2018.11.23 | YRS-AT-4018 | Added to show error message if not allowed to update address--%>
                    <%End If%>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="left" width="140">
                    <asp:Label ID="LabelEffDate" runat="server" Width="120" CssClass="Label_Small">Effective Date</asp:Label>
                </td>
...
<div id="divNotes" style="display: none;">
    ...
    <!-- Anudeep:25.10.2013:BT:2264 - Commented below hidden variables because it should not access to other usercontrol  -->
...
//            else {
    ...
    function OpenAddress(TextBoxAddress1, TextBoxAddress2, TextBoxAddress3, TextBoxCity, DropDownListCountry, DropDownListState, TextBoxZip, CheckboxIsBadAddress, TextBoxEffDate, txtFinalNotes, chkNotes, imgBadAddress, LabelAddress1, LabelEffDate, LabelNoAddressFound, LabelUpdateAddress, hdnChangesExist, hdnReasons, QASMatched, hasAddress, Addressmode) {
        var NotesReason;
        checkIEVersion('none');
...
//    	);
    ...
    function ShowPIIErrorMessageFromAddressControl() {
        var messageText, divError;
        var result = true;
        messageText = '<%= Me.PIIInformationRestrictionMessageTextAddressControl%>';
        divError = $(<%= Me.DivPIIErrorControlID%>);
        if (messageText != null && messageText != '') {
            divError.html(messageText);
            divError.addClass("error-msg");
