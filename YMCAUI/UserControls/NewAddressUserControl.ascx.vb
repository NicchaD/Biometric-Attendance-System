...
' FileName			:	NewAddressUserControl.ascx.vb
' Author Name		:	Dinesh Kanojia
' Employee ID		:	52767
' Email				:	dinesh.kanojia@3i-infotech.com
' Contact No		:	
' Creation Time		:	12/13/2012 12:40:52 PM
'
'********************************************************************************************************************************
...
'Anudeep           24-jun-2012     Error occured for when redirecting retiree information to particiapant information
'Manthan Rajguru   2015.09.16      YRS-AT-2550: YRS data cleanup: copyright comments and namespace (Changed the Namespace reference from 'Infotech' to 'YMCARET')
'********************************************************************************************************************************
Public Class NewAddressUserControl
    ...
    'Protected WithEvents CheckboxIsBadAddress As System.Web.UI.WebControls.CheckBoxAddressWebUserControl1
...
#Region " Custom Methods "
        ...
        If (TextBoxAddress1.Text <> String.Empty OrElse TextBoxAddress2.Text <> String.Empty _
         ...
         OrElse TextBoxCity.Text <> String.Empty OrElse TextBoxEffDate.Text <> String.Empty) Then 'BS:2012.03.09:-restructure Address Control
            ...
            If (DropDownListCountry_hid.Value = "US" Or DropDownListCountry_hid.Value = "CA") Then
                ...
                TextBoxZip.Text = TextBoxZip.Text.Replace(",", "").Replace(", ", "").Replace(",", "")
                ...
                ElseIf DropDownListCountry_hid.Value = "CA" And (System.Text.RegularExpressions.Regex.IsMatch(TextBoxZip.Text.Trim(), "^([a-zA-Z])([0-9])([a-zA-Z]) ([0-9])([a-zA-Z])([0-9])$")) = False Then
    ...
    Private Function LoadDataToConrols() As String
        ...
        Try
            ...
            'Code Added by Dinesh.k on 20/06/2013
            'DInesh.k          20-Jun-2013     BUGID:2088:Comma value gets inserted in to the database.
            If (Not String.IsNullOrEmpty(m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Address1").ToString().Trim)) Then
                Me.TextBoxAddress1.Text = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Address1").ToString().Trim.Replace(",", "")
                Me.TextBoxAddress1.Text = Me.TextBoxAddress1.Text + ", "
            End If

            If (Not String.IsNullOrEmpty(m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Address2").ToString().Trim)) Then
                Me.TextBoxAddress2.Text = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Address2").ToString().Trim.Replace(",", "")
                Me.TextBoxAddress2.Text = Me.TextBoxAddress2.Text + ", "
            End If


            If (Not String.IsNullOrEmpty(m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Address3").ToString().Trim)) Then
                Me.TextBoxAddress3.Text = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Address3").ToString().Trim.Replace(",", "")
                Me.TextBoxAddress3.Text = Me.TextBoxAddress3.Text + ", "
            End If


            If (Not String.IsNullOrEmpty(m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("City").ToString().Trim)) Then
                Me.TextBoxCity.Text = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("City").ToString().Trim.Replace(",", "")
                Me.TextBoxCity.Text = Me.TextBoxCity.Text + ", "
            End If
            ...
            If m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Country").ToString.Trim() = "CA" Then
                ...
                If (Not String.IsNullOrEmpty(m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Zip").ToString().Trim)) Then
                    If Me.DropDownListState_hid.Value = String.Empty Then
                        l_str_zipcode = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Zip").ToString().Trim.Replace(",", "")
                        l_str_zipcode = l_str_zipcode + ", "
                    Else
                        l_str_zipcode = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Zip").ToString().Trim.Replace(",", "")
                        l_str_zipcode = ", " + l_str_zipcode + ", "
                    End If
                ...
                Else
                    ...
                    'TextBoxZip.Text = l_str_zipcode.Substring(0, l_str_zipcode.Length - 1)
                    TextBoxZip.Text = l_str_zipcode
                End If
                '----------------------------------------------------------------------------------------------------
            Else
                'Condition Added By Dinesh kanojia
                'DInesh.k          20-Jun-2013     BUGID:2088:Comma value gets inserted in to the database.
                ...
                If (Not String.IsNullOrEmpty(m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Zip").ToString().Trim)) Then
                    If Me.DropDownListState_hid.Value = String.Empty Then
                        Me.TextBoxZip.Text = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Zip").ToString().Trim.Replace(",", "")
                        Me.TextBoxZip.Text = Me.TextBoxZip.Text + ", "
                    Else
                        Me.TextBoxZip.Text = m_dataset_AddressInfo.Tables("AddressInfo").Rows(0).Item("Zip").ToString().Trim.Replace(",", "")
                        Me.TextBoxZip.Text = ", " + Me.TextBoxZip.Text + ", "
                    End If
        ...
        If Not l_ds_Address Is Nothing Then
            If l_ds_Address.Tables("AddressInfo").Rows.Count > 0 Then
                ...
                If l_ds_Address.Tables("AddressInfo").Rows(0).Item("Address1").ToString.Trim() <> Address1 Then
                    l_ds_Address.Tables("AddressInfo").Rows(0).Item("Address1") = Address1.Replace(",", "").Trim
                End If
                If l_ds_Address.Tables("AddressInfo").Rows(0).Item("Address2").ToString.Trim() <> Address2 Then
                    l_ds_Address.Tables("AddressInfo").Rows(0).Item("Address2") = Address2.Replace(",", "").Trim
                End If
                If l_ds_Address.Tables("AddressInfo").Rows(0).Item("Address3").ToString.Trim <> Address3 Then
                    l_ds_Address.Tables("AddressInfo").Rows(0).Item("Address3") = Address3.Replace(",", "").Trim
                End If
                If l_ds_Address.Tables("AddressInfo").Rows(0).Item("City").ToString.Trim <> City Then
                    l_ds_Address.Tables("AddressInfo").Rows(0).Item("City") = City.Replace(",", "").Trim
                End If
                ...
                If l_ds_Address.Tables("AddressInfo").Rows(0).Item("Country").ToString.Trim <> DropDownListCountryValue Then
                    l_ds_Address.Tables("AddressInfo").Rows(0).Item("Country") = DropDownListCountryValue.Trim
                End If
                ' Added space between the quotation by Anudeep for Bt-1245:Address issue replication and analysis on client machine on 08-10-2012
                ...
                If l_ds_Address.Tables("AddressInfo").Rows(0).Item("State").ToString.Trim <> DropDownListStateValue Then
                    l_ds_Address.Tables("AddressInfo").Rows(0).Item("State") = DropDownListStateValue.Trim
                End If
                'Dim l_zipCode As String = IIf(DropDownListCountryValue.ToString = "CA", Replace(ZipCode, " ", ""), ZipCode)
                Dim l_zipCode As String = ZipCode
                If l_ds_Address.Tables("AddressInfo").Rows(0).Item("Zip").ToString.Trim <> l_zipCode Then
                    ...
                    If l_str_Country.ToString = "CA" Then
                        l_ds_Address.Tables("AddressInfo").Rows(0).Item("Zip") = l_zipCode.Replace(",", "").Trim
                    Else
                        l_ds_Address.Tables("AddressInfo").Rows(0).Item("Zip") = l_zipCode.Replace(",", "").Trim
                    End If
                Else
            ...
            Else
                ...
                If Address1 <> "" Or Address2 <> "" Or Address3 <> "" Or City <> "" Or ZipCode <> "" Then
                    ...
                    l_AddressRow.Item("Address1") = Address1.Replace(",", "").Trim
                    l_AddressRow.Item("Address2") = Address2.Replace(",", "").Trim
                    l_AddressRow.Item("Address3") = Address3.Replace(",", "").Trim
                    l_AddressRow.Item("City") = City.Replace(",", "").Trim
                    l_AddressRow.Item("Country") = DropDownListCountryValue.Trim
                    l_AddressRow.Item("State") = DropDownListStateValue.Trim
                    l_str_Country = String.Empty
                    l_str_Country = DropDownListCountryValue
                    'If l_str_Country.ToString = "CA" Then
                    'l_AddressRow.Item("Zip") = Replace(ZipCode, " ", "")
                    l_AddressRow.Item("Zip") = ZipCode.Trim().Replace(",", "").Trim
                    'Else
        ...
        If Not dtNotes Is Nothing Then
            If Not dtNotes.GetChanges Is Nothing Then
                If dtNotes.GetChanges.Rows.Count > 0 Then
                    ...
                    Session("AddNotesByAddressVerify") = True
                End If
            End If
        End If
    End Function
    ...
    Public Sub RefreshAddressDetail(ByVal dsAddress As DataSet)
        If dsAddress IsNot Nothing Then
            ...
            If HelperFunctions.isNonEmpty(dsAddress.Tables("AddressInfo")) Then
                ' Condition Added by Dinesh Kanoijia on 20/06/2013 hotfix 13.0.3
                'DInesh.k          20-Jun-2013     BUGID:2088:Comma value gets inserted in to the database.
                If dsAddress.Tables("AddressInfo").Rows.Count > 0 Then
                    If dsAddress.Tables("AddressInfo").Rows(0)("Address1").ToString().Trim <> "" Then
                        Address1 = dsAddress.Tables("AddressInfo").Rows(0)("Address1").ToString().Trim.Replace(",", "")
                        Address1 = Address1 + ", "
                    Else
                        Address1 = ""
                    End If

                    If dsAddress.Tables("AddressInfo").Rows(0)("Address2").ToString().Trim <> "" Then
                        Address2 = dsAddress.Tables("AddressInfo").Rows(0)("Address2").ToString().Trim.Replace(",", "")
                        Address2 = Address2 + ", "
                    Else
                        Address2 = ""
                    End If

                    If dsAddress.Tables("AddressInfo").Rows(0)("Address3").ToString().Trim <> "" Then
                        Address3 = dsAddress.Tables("AddressInfo").Rows(0)("Address3").ToString().Trim.Replace(",", "")
                        Address3 = Address3 + ", "
                    Else
                        Address3 = ""
                    End If
                    ...
                    If dsAddress.Tables("AddressInfo").Rows(0)("City").ToString().Trim <> "" Then
                        City = dsAddress.Tables("AddressInfo").Rows(0)("City").ToString().Trim.Replace(",", "")
                        City = City + ", "
                    Else
                        City = ""
                    End If

                    If dsAddress.Tables("AddressInfo").Rows(0)("State").ToString().Trim <> "" Then
                        DropDownListStateValue = dsAddress.Tables("AddressInfo").Rows(0)("State").ToString().Trim
                    Else
                        DropDownListStateValue = ""
                    End If


                    If dsAddress.Tables("AddressInfo").Rows(0)("Country").ToString().Trim <> "" Then
                        DropDownListCountryValue = dsAddress.Tables("AddressInfo").Rows(0)("Country").ToString().Trim
                    End If

                    If dsAddress.Tables("AddressInfo").Rows(0)("Zip").ToString().Trim <> "" Then
                        If DropDownListStateValue.Trim <> "-Select State-" Then
                            ZipCode = dsAddress.Tables("AddressInfo").Rows(0)("Zip").ToString().Trim.Replace(",", "")
                            ZipCode = ", " + ZipCode + ", "
                        Else
                            ZipCode = dsAddress.Tables("AddressInfo").Rows(0)("Zip").ToString().Trim.Replace(",", "")
                            ZipCode = ZipCode + ", "
                    ...
                    If dsAddress.Tables("AddressInfo").Rows(0)("EffDate").ToString().Trim <> "" Then
                        EffectiveDate = dsAddress.Tables("AddressInfo").Rows(0)("EffDate").ToString().Trim
                    Else
                        EffectiveDate = ""
                    End If

                    If dsAddress.Tables("AddressInfo").Rows(0)("bitBadAddress").ToString().Trim <> "" Then
                        IsBadAddress = Convert.ToBoolean(dsAddress.Tables("AddressInfo").Rows(0)("bitBadAddress").ToString().Trim)
                    Else
                        IsBadAddress = False
                    End If
                End If
