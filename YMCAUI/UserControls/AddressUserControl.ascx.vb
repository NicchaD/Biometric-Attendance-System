...
'Pramod P. Pokale   2017.01.04      YRS-AT-3145 -  YRS enh: Fees - QDRO fee processing 
'                                   YRS-AT-3265 -  YRS enh:improve usability of QDRO split screens (TrackIT 28050) 
'****************************************************************************************************************************************************
Public Class AddressUserControl
...
#Region " Properties "
    ...
    End Sub
    Dim m_AllowNotes As Boolean = True
...
#Region " Custom Methods "
    ...
    'START: PPP | 01/04/2017 | YRS-AT-3145 & 3265 | After selecting recipient from "1. Define Recipient" tab then still "No Address information defined." being displayed on screen, So using this function hiding it
    Public Sub HideNoAddressDefinedLabel()
        LabelNoAddressFound.Style("display") = "none"
        LabelUpdateAddress.Style("display") = "none"
    End Sub
    'END: PPP | 01/04/2017 | YRS-AT-3145 & 3265 | After selecting recipient from "1. Define Recipient" tab then still "No Address information defined." being displayed on screen, So using this function hiding it
