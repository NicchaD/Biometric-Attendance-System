<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SelectYmca.aspx.vb" Inherits="YMCAUI.SelectYmca"%>
...
<form id="Form1" method="post" runat="server">
		...
		<table width="700" border="0" cellspacing="0">
			<tr>
				<td class="Td_HeadingFormContainer" align="left"><IMG title="image" height="10" alt="image" src="images/spacer.gif" width="10">
					Select a Metro or Independent YMCA</td>
			</tr>
			<tr>
				<td>&nbsp;
				</td>
	...
	<div class="Div_Center">
		<table class="Table_WithBorder" width="700" cellspacing="0" border="0">
			<tr>
				<td align="left">
					<div style="OVERFLOW: auto; WIDTH: 350px; BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; HEIGHT: 200px; BORDER-BOTTOM-STYLE: none">
						<asp:datagrid id="DataGridYMCAMetro" runat="server" Allowsorting="true" width="330px" cellpadding="1"
				...
				<td align="left">
					<table style="WIDTH: 328px; HEIGHT: 156px">
						...
						<tr>
							<td align="center" width="138"><asp:button id="ButtonFind" CssClass="Button_Normal" Width="80" Runat="server" Text="Find"></asp:button></td>
							<td align="center"><asp:button id="ButtonClear" CssClass="Button_Normal" Width="80" Runat="server" Text="Clear"></asp:button></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				...
				<td class="Td_ButtonContainer" align="right" width="100%">
					<table cellspacing="0" border="0">
						<tr>
							<td class="Td_ButtonContainer" align="left" width="100%"><asp:button id="ButtonCancel" CssClass="Button_Normal" Width="80" Runat="server" Text="Cancel"></asp:button></td>
						</tr>
					</table>
				</td>
			</tr>
