...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RefundRequestWebForm.aspx.vb" Inherits="YMCAUI.RefundRequestWebForm"%>
...
<%--Chandra sekar|2016.09.23|YRS-AT-3164 TI display the Rules of IRS Override as tool tip while mouse over on IRS OverRide Image icon----%>
...
<form id="Form1" method="post" runat="server">
    ...
    <div id="DivMainMessage" class="warning-msg" runat="server" style="text-align: left;" enableviewstate="true" height="10">  </div> <%-- SR | 2016.06.09 | YRS-AT-2962 | Add div for displaying Processing Fee message--%>
	<div class="Div_Center">
		<table class="Table_WithoutBorder" cellSpacing="0" width="100%" > <%--START | SR | YRS-AT-4055 | Increase width to accomodate Aggregate balance of BA & Legacy at Request.--%>
			<tr>
	...
	<table class="Table_WithBorder" cellSpacing="0" width="700">
		...
		<tr>
			...
			<td class="Td_SubText" noWrap align="left" width="170"><asp:checkbox id="CheckboxSavingsVoluntary" runat="server" CssClass="CheckBox_Normal" Text="Voluntary"
					AutoPostBack="True"></asp:checkbox></td>
            <%--START - Chandra sekar|2016.09.23|YRS-AT-3164 To Controls of IRS Override and tool tip --%>
			<td class="Td_SubText" align="left"  colSpan="2" width="170" >
                <table>
					...
					AutoPostBack="True"></asp:checkbox></td><td  style="white-space: nowrap;" >
               ...
               <%--END - Chandra sekar|2016.09.23|YRS-AT-3164 To Controls of IRS Override and tool tip --%>
    ...
    <%--Chandra sekar|2016.09.23|YRS-AT-3164 To display the Rules of IRS Override as tool tip while mouse over on IRS OverRide Image icon--%>
