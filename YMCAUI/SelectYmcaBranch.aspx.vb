...
'*******************************************************************************
Public Class SelectYmcaBranch
    Inherits System.Web.UI.Page
    'below line is Added by Neeraj for issue id YRS 5.0-940 
    Dim strFormName As String = New String("SelectYmcaBranch.aspx")
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'If Session("Ymca") = "Branch" Then
        If Session("LoggedUserKey") Is Nothing Then
            Response.Redirect("Login.aspx", False)
        End If
        If Not IsPostBack Then
            Dim l_DataSet_Branch As DataSet
            l_DataSet_Branch = YMCARET.YmcaBusinessObject.ParticipantsInformationBOClass.SearchYMCABranch(Session("UniqueIdM"))
            Me.DataGridYMCAMetro.DataSource = l_DataSet_Branch
    ...
    Private Sub ButtonFind_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonFind.Click
        Try
            ...
            l_DataSet_Metro = YMCARET.YmcaBusinessObject.ParticipantsInformationBOClass.SearchYMCABranchOnCriteria(TextBoxYMCANo.Text, TextBoxName.Text, TextBoxCity.Text, TextBoxState.Text, Session("UniqueIdM"))
