...
' FileName			:	RefundRequestForm.aspx.vb
' Author Name		:	SrimuruganG
' Employee ID		:	32365
' Email				:	srimurugan.ag@icici-infotech.com    
' Contact No		:	8744
' Creation Time		:	6/13/2005 12:47:58 PM
...
'  preeti          10thFeb06           IssueId:YRST-2092 start
'  Preeti          10th Feb 06         Issue :YMCA-1858 
'  Rahul           13th Feb 06         Issue :YMCA-1858 
'  Shubhrata       14th Feb 06         YREN 2607 Reason:Enhancement checks for unfunded transactions depending on Refund Type
'  Rahul           28th Feb 06         Issue:SSN on all screens.
'  Shubhrata       01st Mar 07         YREN-3095 not to check for unfunded transaction in hardship except for negative unfunded transaction.
'  Aparna          22 Jan-2007         Issue-YREN-3027
'Modification History
'********************************************************************************************************************************
'Modified By        Date            Description
'********************************************************************************************************************************
'Ashutosh Patil     05-Apr-2007         YREN-3028,YREN-3029 
'by Aparna          03/07/2007 -        YREN-3658-To send only the Pend row for processing. As per the Mail-To avoid the DBNull value in mnyDeductions
'  aparna                               check age of the QD partiicpant -PS Change
'Aparna Samala      11/26/2007          Change in the Annuity Check 
'Shubhrata          04/17/2008          New fund event status changes
'Dilip              03/04/2009          Modification for New BA Account 
'Dilip Yadav        2009.09.18          To restrict the text display till only 50 characters in notes grid : As per mail 17-Sep-09 
'neeraj singh       25/Sep/2009         to hide return type column in request tab YRS 5.0-899
'29/Sep/2009        Neeraj Singh        modified the code in function LoadGeneralInfoToControls for issue no. YRS 5.0-820 (1st given for request processing page only)
...
'07-oct-2009        Amit Nigam          YRS 5.0-913  
'27-Oct-2009        Neeraj Singh        for issue id YRS 5.0-932 :  to make Session("MinimumDistributionTable") as null
'31/oct/2009        Amit Nigam          New Modification for Market Based Withdrawal      
'Neeraj Singh       12/Nov/2009         Added form name for security issue YRS 5.0-940 
'15-12-2009         Amit Nigam          Modified the column name to fetch the status from teh header table
'17-Dec-2009        Parveen Kumar       To set the RefundType From RequestHeader Table on  Bug ID-1073
'30-Dec-2009        Amit Kumar Nigam    Added to update the session og status type
'02-Feb-2009        Parveen Kumar       Added for the issue in hardship when being done after processing of terminated person
'12/Feb/2010        Shashi Shekhar      Restrict Data Archived Participants To proceed in Find list Except Person 
'12-March-2010      Priya               YRS 5.0-1029:Cannot withdraw a Hardship withdrawal(When we process Hardship withdrawal it is suppose to generate a letter "birefltr.rpt' letter.It is not generating this letter. )
'25-03-2010         Amit Nigam          Added to hide SSN and Name  in Withdrawal Request Maintenance screen. 
'Neeraj Singh       06/jun/2010         Enhancement for .net 4.0
'Neeraj Singh       07/jun/2010         review changes done
'Neeraj Singh       22-July-10          Issue fixed id YRS 5.0-1108 fixed .. date format
'Neeraj Singh       29-Jul-2010         'MRD issue YRS 5.0-1132
'23/Aug/2010        Imran               BT: 568 Age shows wrong for exact one year.
'03-09-2010         Neeraj Singh        BT-577 casting error
'04/sep/201         Imran               BT-576 call copytoserver method for hardship refund.

'06/Oct/2010        Imran               YRS 5.0-1181 : Generate harship report with passing parameter Ymca id 
...
'Shashi Shekhar     27 - May -2011      For YRS 5.0-1298 To implement the cancel reason functionality.
'Imran Bedrekar     08/08/2011          YRS 5.0-1362 : allow withdrawal when unfunded transctions exist
'Sanjeev            14/12/2011          BT:955 - YRS 5.0-1482:Allow partial withdrawal by active person against Savings Plan
...
'Anudeep            2013.02.12          Bt-650:YRS 5.0-521 : Program ignoring negative amount
'Anudeep            2013.07.02          Bt-1501:YRS 5.0-1745:Capture Beneficiary addresses 
'Sanjay R           2013.08.21          BT 2157:Error message (Fund # 105080393, Latisha Davis) for salutaion code in Withdrawal Request.
'Anudeep            2013.08.22          YRS 5.0-1862:Add notes record when user enters address in any module.
'Dinesh k           2013.08.20          BT: incorrect wording in YRS for automated note for hardship withdrawals
...
'Sanjay R.          2013.12.06          BT2275/YRS 5.0-2235:Incorrect message in withdrawal process
'Anudeep            2014.02.03          BT:2292:YRS 5.0-2248 - YRS Pin number
'Sanjay S.          2014.09.17          BT 2633/YRS 5.0-2403 -  Remove expiration dates from withdrawal requests in YRS 
'Anudeep A          2015.05.05          BT-2699:YRS 5.0-2441 : Modifications for 403b Loans 
'Manthan Rajguru    2015.09.16          YRS-AT-2550: YRS data cleanup: copyright comments and namespace/reference (Changed the Namespace/reference from 'Infotech' to 'YMCARET')
'Manthan Rajguru    2015.10.06          YRS-AT-2595: Restrict withdrawals for Deceased participants 
...
'Gunanithi.G        2016.01.27          YRS-AT-2725: Old code appearing in withdrawal processing screen. Additional controls Rollover Only First Installment and Rollover All Installment(s)
'Bala               2016.02.04          YRS-AT-2725: Old code appearing in withdrawal processing screen. Additional controls Rollover Only First Installment and Rollover All Installment(s)
...
'Bala               2016.03.02          YRS-AT-2821 - YRS enh-cancel of SHIRA requests and change to SHIRA functionality (TrackIT 25191)
'Sanjay GS Rawat    2016.03.07          YRS-AT-2524: Give Customer Service the ability to unexpire an expired withdrawal request
'Bala               2016.03.14          YRS-AT-2821 - YRS enh-cancel of SHIRA requests and change to SHIRA functionality (TrackIT 25191)
...
'Shilpa N           2019.02.28          YRS-AT-4248 -  YRS enh: YRS read-only access during MonthEnd Processing (TrackIT 35547) 
'Santosh Bura       2019.07.24          YRS-AT-2169 -  Hardship withdrawal must be available for non-participants
'Pooja Kumkar       2019.08.30          YRS-AT-2670 - YRS enh:Hacienda withholding message - Puerto Rico based YMCA orgs
'Pooja Kumkar       2020.05.05          YRS-AT-4854 -  COVID - Special withdrawal functionality needed due to CARE Act/COVID-19 (Track IT - 41688) 
'suvarna B          2020.05.05          YRS-AT-4854 -  COVID - Special withdrawal functionality needed due to CARE Act/COVID-19 (Track IT - 41688). 
'********************************************************************************************************************************
...
#Region " Form Properties "
    ...
    Private Property VoluntaryWithdrawalTotal() As Decimal
        Get
            If Not Session("VoluntaryWithdrawalTotal") Is Nothing Then
                Return (DirectCast(Session("VoluntaryWithdrawalTotal"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Private Property HardshipWithdrawalTotal() As Decimal
        Get
            If Not Session("HardshipWithdrawalTotal") Is Nothing Then
                Return (DirectCast(Session("HardshipWithdrawalTotal"), Decimal))
            Else
                Return 0.0
            End If
        End Get
    ...
    Public Property SessionAccessRights() As String
        Get
            If Not (Session("l_integer_AccPermission")) Is Nothing Then
                Return Session("l_integer_AccPermission")
            Else
                Return Session("l_integer_AccPermission") = String.Empty
            End If
        End Get
        Set(ByVal Value As String)
            Session("l_integer_AccPermission") = Value
        End Set
    End Property
    ...
    Private Property DeathDate() As String
        Get
            If Not Session("DeathDate") Is Nothing Then
                Return (DirectCast(Session("DeathDate"), String))
            Else
                Return String.Empty
            End If
        End Get
        Set(ByVal Value As String)
            Session("DeathDate") = Value
        End Set
    End Property
    ...
    Private Property SessionStatusType() As String
        Get
            If Not (Session("StatusType")) Is Nothing Then
                Return (DirectCast(Session("StatusType"), String))
            Else
                Return String.Empty
            End If
        End Get
    ...
    Private Property ISMarket() As Int16
        Get
            If Not Session("ISMarket") Is Nothing Then
                Return (DirectCast(Session("ISMarket"), Int16))
            Else
                Return 1
            End If
    ...
    Private Property RefundStatus() As String
        Get
            If Not Session("RefundStatus") Is Nothing Then
                Return (DirectCast(Session("RefundStatus"), String))
            Else
                Return String.Empty
            End If
    ...
    Private Property IsSavingPartial() As Boolean
        Get
            If Not Session("IsSavingPartial") Is Nothing Then
                Return (CType(Session("IsSavingPartial"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("IsSavingPartial") = Value
        End Set
    End Property
    Private Property IsRetirementPartial() As Boolean
        Get
            If Not Session("IsRetirementPartial") Is Nothing Then
                Return (CType(Session("IsRetirementPartial"), Boolean))
            Else
                Return False
            End If
        End Get
        Set(ByVal Value As Boolean)
            Session("IsRetirementPartial") = Value
        End Set
    End Property
    ...
    Public Property IsPersonEligibleForRMD() As Boolean
        Get
            If Session("WithdrawalAllowedForRMDEligibleParticipants") Is Nothing Then
                Session("WithdrawalAllowedForRMDEligibleParticipants") = Validation.IsRMDExist(YMCAObjects.Module.Withdrawal, Session("FundId"), Me.ReasonForRestriction)
            End If
            Return CType(Session("WithdrawalAllowedForRMDEligibleParticipants"), Boolean)
        End Get
        Set(ByVal Value As Boolean)
            Session("WithdrawalAllowedForRMDEligibleParticipants") = Value
        End Set
    End Property
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        l_int_UpdateButtonhit = Session("Updatebuttonhit")
        ...
        Try
            ...
            If Me.SessionIsRefundRequest = False Then
                Session("ServiceRequestReport") = Nothing
            End If
            ...
            If Page.IsPostBack() Then
                ...
                If Not Session("bool_RefundRequest") Is Nothing Then
                    If CType(Session("bool_RefundRequest"), Boolean) = True Then
                        If Request.Form("OK") = "OK" Then
                            If Not Session("CancelSelect") Is Nothing Then
                                'Shashi Shekhar:27-05-2011: For YRS 5.0-1298
                                Me.CancelRefundRequest(Session("CancelSelect"), "YRS")
                                ...
                                ViewState("RefCanReasonCode") = Nothing 'Shashi Shekhar:27-05-2011: For YRS 5.0-1298
                                Session("bool_RefundRequest") = False
                ...
                If Request.Form("Yes") = "Yes" Then
                    ...
                    If Not Session("CancelSelect") Is Nothing Then
                        ...
                        If Not ViewState("CanReq") Is Nothing And ViewState("CanReq").ToString.ToUpper.Trim = "TRUE" And Not ViewState("RefCanReasonCode") Is Nothing Then
                            'Shashi Shekhar:27-05-2011: For YRS 5.0-1298
                            Me.CancelRefundRequest(Session("CancelSelect"), ViewState("RefCanReasonCode").ToString.Trim)
                            ViewState("RefCanReasonCode") = Nothing 'Shashi Shekhar:27-05-2011: For YRS 5.0-1298
                    ...
                    ElseIf Not Session("ProcessSelect") Is Nothing Then
                ...
                ElseIf Request.Form("OK") = "OK" Then
                    ...
                    End If
                Else
                    If Not Session("CancelSelect") Is Nothing And ViewState("CanReq") = Nothing Then
                        Me.CancelRefundRequest(Session("CancelSelect"), "YRS")
                        Session("CancelSelect") = Nothing
                        Session("RefCanReasonCode") = Nothing 'Shashi Shekhar:2011-25-05: YRS 5.0-1298: For Cancel code reason implementation
                        ViewState("RefCanReasonCode") = Nothing 'Shashi Shekhar:27-05-2011: For YRS 5.0-1298
                ...
                If Session("HardshipMessage") <> Nothing Then
                    Dim popupScript1 As String
                    Dim l_stringMessage As String
                    l_stringMessage = Session("HardshipMessage")
                    Session("HardshipMessage") = Nothing
                ...
                Select Case (Me.SessionFormMode)
                    ...
                    Case Else
                        ...
                        If Me.SessionIsRefundRequest = True Then
                            ...
                            If Not Session("sessionProcessMessage") Is Nothing Then
                                MessageBox.Show(MessageBoxPlaceHolder, "YMCA_YRS", Session("sessionProcessMessage").ToString(), MessageBoxButtons.OK, False)
                                Session("sessionProcessMessage") = Nothing
                            End If
                        End If
                        If Not Session("VolRequestCreated") Is Nothing Then
                            If Session("VolRequestCreated") = True Then
                                Me.LoadRefundRequestDetails(Me.SessionPersonID, Me.SessionFundID)
                                Session("VolRequestCreated") = Nothing
            ...
            If Not Session("IndexFileWriteError") Is Nothing Then
                If Session("IndexFileWriteError").GetType.ToString().Length > 0 Then
                    MessageBox.Show(MessageBoxPlaceHolder, "Release Blank", Session("IndexFileWriteError"), MessageBoxButtons.Stop)
                    Session("IndexFileWriteError") = Nothing
                End If
            End If
            'Start:AA:02.17.2016 YRS-AT-2640 Added to open the withdrawal processing pop-up window
            If Not IsPostBack Then
                If Session("Seamless_refrequestid") IsNot Nothing Then
                    RefundTabStrip.SelectedIndex = 3
                    RefundMultiPage.SelectedIndex = 3
                    Session("Seamless_refrequestid") = Nothing
                End If
                'End:AA:02.17.2016 YRS-AT-2640 Added to open the withdrawal processing pop-up window
            End If
        Catch ex As Exception
            Dim l_String_Exception_Message As String
            HelperFunctions.LogException("RefundRequestForm_Page_Load", ex) 'PK | 10/01/2019 | YRS-AT-2670 | Added exception logging
    ...
    Private Function LoadGeneralInformation(ByVal parameterPersonID As String, ByVal parameterFundEventID As String)
        ...
        Try
            ...
            If Me.SessionStatusType.ToUpper.Trim() = "QD" Then
                ...
                Session("QDROParticipantAge") = l_integer_QDROParticipantAge
                ' End If
            End If
            'Aparna 25/10/2007
    ...
    Private Function LoadAccountContribution(ByVal parameterFundID As String)
        ...
        Try
            ...
            Session("RetirementTotal") = "0.00"
            Session("SavingsTotal") = "0.00"
            'by Aparna 28/11/2007
            ...
            Next
            Session("AcctContributionInitial") = l_dt_AcctContributionInitial
            ' we need original Acct contribution data table to be used for converting Hard to Vol
            ...
            'Shubhrata YREN 2607
            Session("l_dataTable_AccountContribution_NonFunded") = l_dataTable_AccountContribution_NonFunded
            'Shubhrata YREN 2607
            ...
            If Not l_DataSet Is Nothing Then
                ...
                End If
                Session("RetirementPlanAcctContribution") = l_datatable_RetirementPlan
                ...
                End If
                Session("SavingsPlanAcctContribution") = l_datatable_SavingsPlan
                ...
                If l_datatable_RetirementPlanTotal.Rows.Count > 0 Then
                    ...
                    Session("RetirementTotal") = l_RetirementTotalDataRow("Total")
                Else
                    Session("RetirementTotal") = "0.00"
                End If
                ...
                If l_datatable_SavingsPlanTotal.Rows.Count > 0 Then
                    ...
                    Session("SavingsTotal") = l_SavingsTotalDataRow("Total")
                Else
                    Session("SavingsTotal") = "0.00"
                End If
                ...
                Session("RetirementPlan_UnfundedContributions") = l_datatable_RetirementPlan_Unfunded
                Session("SavingsPlan_UnfundedContributions") = l_datatable_SavingsPlan_Unfunded
            End If
    ...
    Private Function LoadRefundRequestDetails(ByVal parameterPersonID As String, ByVal parameterFundID As String)
        ...
        Try
            ...
            Session("RefundRequestTable") = l_DataTable
            Session("RefundRequestDataTable") = l_DataTable 'by APARNA 08/08/07 -to avoid Error records dont exist as same Session is used in processing
                        ...
                        If CType(l_DataRow.Item("RequestStatus"), String).Trim.ToUpper = "PEND" Then
                            ...
                            Else
                                ...
                                If l_DataRow.Item("PlanType").ToString() <> "System.DBNull" And l_DataRow.Item("PlanType").ToString() <> String.Empty Then
                                    ...
                                    If CType(l_DataRow.Item("PlanType"), String).Trim.ToUpper = "SAVINGS" Or Session("SavingsTotal") <= 0 Then
                                        l_bool_Savings = True
                                    End If
                                End If

                                If l_DataRow.Item("PlanType").ToString() <> "System.DBNull" And l_DataRow.Item("PlanType").ToString() <> String.Empty Then
                                    If CType(l_DataRow.Item("PlanType"), String).Trim.ToUpper = "RETIREMENT" Or Session("RetirementTotal") <= 0 Then
            ...
            If Not Session("GenerateErrors") Is Nothing Then
    ...
    Private Function PreviewWSRefundReport() As Boolean
        ...
        Try
            ...
            If Not Session("ServiceRequestReport") Is Nothing Then
            ...
            ElseIf CType(Session("R_ReportToLoad_6"), Boolean) = True Then
                ...
                Session("R_ReportToLoad_6") = Nothing
    ...
    Private Function PreviewRefundReport() As Boolean
        ...
        Try
            ...
            If CType(Session("R_ReportToLoad"), Boolean) = True Then
            ...
            If CType(Session("R_ReportToLoad_1"), Boolean) = True Then
            ...
            If CType(Session("R_ReportToLoad_2"), Boolean) = True Then
                popupScript = "<script language='javascript'>" & _
            ...
            If CType(Session("R_ReportToLoad_4"), Boolean) = True Then
                Dim l_popupScript As String
                l_popupScript = "<script language='javascript'>" & _
            ...
            If CType(Session("R_ReportToLoad_5"), Boolean) = True Then
                Dim l_popupScript As String
                l_popupScript = "<script language='javascript'>" & _
            ...
            If CType(Session("R_ReportToLoad_6"), Boolean) = True Then
                Dim l_popupScript As String
                l_popupScript = "<script language='javascript'>" & _
                "window.open('FT\\ReportViewer.aspx', 'ReportPopUp_4', " & _
                "'width=1024,height=768, menubar=no, resizable=yes,top=0,left=0, scrollbars=yes, status=yes')" & _
            ...
            If CType(Session("R_ReportToLoad"), Boolean) = True Or _
                CType(Session("R_ReportToLoad_1"), Boolean) = True Or _
                CType(Session("R_ReportToLoad_2"), Boolean) = True Or _
                CType(Session("R_ReportToLoad_3"), Boolean) = True Or _
                CType(Session("R_ReportToLoad_4"), Boolean) = True Or _
                CType(Session("R_ReportToLoad_5"), Boolean) = True Or _
                CType(Session("R_ReportToLoad_6"), Boolean) = True Then
    ...
    Private Sub ButtonAddItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonAddItem.Click
        ...
        Try
            ...
            Else
                ...
                strFormName = "FindInfo.aspx?Name=Refund"
                checkSecurity = SecurityCheck.Check_Authorization(strFormName, Convert.ToInt32(Session("LoggedUserKey")))
            End If
            ...
            If Me.SessionStatusType.ToUpper.Trim = "QD" Then
                If Not Session("QDROParticipantAge") Is Nothing Then
                    l_integer_QDROParticipantAge = CType(Session("QDROParticipantAge"), Integer)
            ...
            RegisterScript = "PopupScriptRR" + Convert.ToString(Session("Count"))
            ...
            If q.Count > 0 Then
                ...
                Session("TermDateDataTabel") = l_TermDateDataTabel
            End If
    ...
    Private Sub DataGridRequests_ItemDataBound(sender As Object, e As DataGridItemEventArgs) Handles DataGridRequests.ItemDataBound
        Try
            ...
            If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.SelectedItem Then
                ...
                End If
                'END :Suvarna B | 2020.04.30 | YRS-AT 4854 | Added backcolor to row for highlighting covid reques
            End If
        Catch ex As Exception
    ...
    Private Function ProcessRefundRequest(ByVal parameterSelectedIndex As Integer)
        ...
        Try
            ...
            Else
                l_DataTable_RefundRequest = DirectCast(Session("RefundRequestDataTable"), DataTable)
                    ...
                    If l_DataTable_RefundRequest.Rows.Count >= parameterSelectedIndex Then
                        ...
                        If Not l_DataRow Is Nothing Then
                            ...
                            If Me.CheckForUnfundedTransaction(Me.RefundType.ToUpper.Trim, Me.PlanTypeChosen.ToUpper.Trim) = False And Request.Form("Yes") <> "Yes" Then
                                ...
                                Session("ProcessSelect") = parameterSelectedIndex
                                Session("CancelSelect") = Nothing
                                ...
                                If l_String_RequestStatus.Trim = "PEND" Then
                                    ...
                                    ElseIf (Me.IsYmcaPuertoRico() = False) Then
                                        ...
                                        Dim popupScript As String = "<script language='javascript'>" & _
                                                                                            "window.open('RefundProcessing.aspx', 'YMCAYRS', " & _
    ...
    Private Sub DataGridRequests_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGridRequests.ItemCommand
        ...
        Try
            ...
            If e.CommandName = "ProcessSelect" Or e.CommandName = "CancelSelect" Then
                ...
                Dim strFormName As String = "FindInfo.aspx?Name=Refund" 'Added by Shashi Shekhar:2009-12-31
            ...
            If e.CommandName = "ExtendExpireSelect" Then
                ...
                If refRequestID <> String.Empty Then
                    If (IsRequestCovid(refRequestID)) Then
                        Dim message As String = YMCARET.YmcaBusinessObject.MetaMessageBO.GetMessageByMessageNo(YMCAObjects.MetaMessageList.MESSAGE_WITHDRAWAL_EXTEND_NON_COVID_SCREEN).DisplayText
            ...
            End If
                ...
                refRequestID = Me.getSelectedRefRequestID(e.Item.ItemIndex)
                If refRequestID <> String.Empty Then
                    If (Me.IsRequestCovid(refRequestID)) Then
                        Dim message As String = YMCARET.YmcaBusinessObject.MetaMessageBO.GetMessageByMessageNo(YMCAObjects.MetaMessageList.MESSAGE_WITHDRAWAL_PROCESS_NON_COVID_SCREEN).DisplayText
                        MessageBox.Show(Me.MessageBoxPlaceHolder, " YMCA - YRS", message, MessageBoxButtons.Stop, False)
                        Exit Sub
                    End If
                Else
                ...
                'END: PK | 05/05/2020 | YRS-AT-4854 | Validation to check requested refund withdrawal is covid or not.
                    ...
                    If l_String_RequestStatus.Trim = "PEND" Then
                        ...
                        If l_String_Message.Trim <> "" Then
                            Session("bool_RefundRequest") = True
                            Session("CancelSelect") = e.Item.ItemIndex
            ...
            ElseIf e.CommandName = "CancelSelect" Then
                ...
                If refRequestID <> String.Empty Then
                    If (IsRequestCovid(refRequestID)) Then
                        Dim message As String = YMCARET.YmcaBusinessObject.MetaMessageBO.GetMessageByMessageNo(YMCAObjects.MetaMessageList.MESSAGE_WITHDRAWAL_CANCEL_NON_COVID_SCREEN).DisplayText
                        MessageBox.Show(Me.MessageBoxPlaceHolder, " YMCA - YRS", message, MessageBoxButtons.Stop, False)
                        Exit Sub
                    End If
                Else
    ...
    Private Sub ButtonOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        Try
            Session("RefundRequest_Sort") = Nothing
            Session("l_emptotal") = Nothing
            Session("l_grossamt") = Nothing
            Session("ProcessSelect") = Nothing
            Session("CancelSelect") = Nothing
            ...
            Session("WithdrawalAllowedForRMDEligibleParticipants") = Nothing
            'END: SB | 2017.08.08 | YRS-AT-3324 | Clearing session variables 

            If Page.Request.QueryString("RT") Is Nothing Then
                Response.Redirect("FindInfo.aspx?Name=Refund", False)
            Else
    ...
    Private Function CheckForUnfundedTransaction(ByVal parameterRefundType As String, ByVal parameterPlanType As String)
        Try
            ...
            If Not Session("RetirementPlan_UnfundedContributions") Is Nothing Then
                l_datatable_RetirementPlan_Unfunded = DirectCast(Session("RetirementPlan_UnfundedContributions"), DataTable)
            End If
            If Not Session("SavingsPlan_UnfundedContributions") Is Nothing Then
                l_datatable_SavingsPlan_Unfunded = DirectCast(Session("SavingsPlan_UnfundedContributions"), DataTable)
            End If
    ...
    Public Function CheckNegativeamounts() As String
        ...
        Try
            ...
            If (Not Session("RetirementPlanAcctContribution") Is Nothing) And (Not Session("SavingsPlanAcctContribution") Is Nothing) Then
                l_datatable_retirement = Session("RetirementPlanAcctContribution")
                l_datatable_savings = Session("SavingsPlanAcctContribution")
    ...
    Public Sub ClearSession()
        ...
        Session("MaritalStatusCode") = Nothing
        Session("Member Employment") = Nothing
        Session("TermDateDataTabel") = Nothing
        Session("QDROParticipantAge") = Nothing
        Session("PersonInformation") = Nothing
        Session("AccountContribution_NonFund") = Nothing
        Session("AccountContribution") = Nothing
        Session("AccountContribution_NonFunded_Total") = Nothing
        Session("l_dataTable_AccountContribution_NonFunded") = Nothing
        Session("AcctContributionInitial") = Nothing

        Session("RefundRequestTable") = Nothing
        Session("RefundRequestDataTable") = Nothing

        Session("MemberNotes") = Nothing
        Session("CurrentPIA") = Nothing
        Session("TerminationPIA") = Nothing
        Session("BACurrent") = Nothing
        Session("BATermination") = Nothing
    ...
    Private Sub btnConfirmDialogOK_Click(sender As Object, e As EventArgs) Handles btnConfirmDialogOK.Click
        Try
            If (Me.IsYmcaPuertoRico() = True) Then
                ...
                ClientScript.RegisterStartupScript(Me.GetType(), "Process", "window.open('RefundProcessing.aspx', 'YMCAYRS', 'width=1000, height=750, menubar=no, status=Yes,Resizable=Yes,top=0,left=0, scrollbars=yes')", True)
            End If
        Catch ex As Exception
            Dim l_String_Exception_Message As String
