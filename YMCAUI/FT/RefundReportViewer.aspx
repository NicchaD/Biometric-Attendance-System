<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RefundReportViewer.aspx.vb" Inherits="YMCAUI.RefundReportViewer" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
            ...
            <CR:CrystalReportViewer ID="CrystalReportViewer1"  style="Z-INDEX: 107; LEFT: 0px; POSITION: absolute; TOP: 8px"
				runat="server" AutoDataBind="true" Width="350px" Height="50px"  PrintMode="ActiveX" />
