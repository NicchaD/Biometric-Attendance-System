...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DisbursementsRevese.aspx.vb" Inherits="YMCAUI.DisbursementsRevese"%>
				...
				<td><iewc:multipage id="MultiPageBreakDown" runat="server">
						<iewc:PageView>
							<table class="Table_WithBorder" width="690">
								...
								<tr>
									<td>
										<DIV style="OVERFLOW: auto; WIDTH: 680px; HEIGHT: 300px; TEXT-ALIGN: center">
											<asp:DataGrid ID="DataGridTransacts" Runat="server" Width="680" CssClass="DataGrid_Grid" CellPadding="0"
												...
												<Columns>
													<asp:TemplateColumn>
														<ItemTemplate>
															<asp:CheckBox  AutoPostBack="True" Checked="false" OnCheckedChanged="CheckBox_CheckedChanged"
													Runat="server" ID="chkTrans"></asp:CheckBox>
														</ItemTemplate>
													</asp:TemplateColumn>
												</Columns>
											</asp:DataGrid>
