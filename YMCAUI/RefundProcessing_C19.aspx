...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RefundProcessing_C19.aspx.vb" Inherits="YMCAUI.RefundProcessing_C19" %>
...
function CheckAllowRollover() {
    ...
    <%-- START : SC | 05/05/2020 | YRS-AT-4874 | Added methods to open and close change COVID Amount--%>
    function showChangeRequestedCOVIDAmountDialog() {
        $('#divChangeRequestedCOVIDAmount').dialog('open');
        return false;
    }
    function CloseChangeRequestedCOVIDAmountDialog() {
        $('#divChangeRequestedCOVIDAmount').dialog('close');
        return false;
    }
    <%-- END : SC | 05/05/2020 | YRS-AT-4874 | Added methods to open and close change COVID Amount--%>
$(document).ready(function () {
   ...
   <%-- START : SC | 05/05/2020 | YRS-AT-4854 | Set properties to Change COVID Amount dialog--%>
        $('#divChangeRequestedCOVIDAmount').dialog({
            autoOpen: false,
            draggable: false, modal: true,
            width: 500, 
            "position": "fixed",
            padding: 20,
            title: "Change COVID Amount",
            open: function (type, data) {
                $(this).parent().appendTo("form");
            }
        });
    <%-- END : SC | 05/05/2020 | YRS-AT-4854 | Set properties to Change COVID Amount dialog--%>
});
...
<form id="Form1" method="post" runat="server">
	<div class="Div_Center">
		<table width="100%">
			<tr>
                ...
                <%--START : SC | 05/05/2020 | YRS-AT-4874 | Added covid 19 label identifier---%>
                <td align="left" style="background-color: red; width:15%;font-weight:normal;">
                                <font color="white">COVID19 screen</font></td>
                <%--END : SC | 05/05/2020 | YRS-AT-4874 | Added covid 19 label identifier---%>
			</tr>			
		</table>
	</div>
			...
			<tr>
				<td><iewc:multipage id="MultiPageVoluntaryRefund" runat="server">
						...
						<iewc:PageView>
                            ...
                            <%--START : SC | 05/05/2020 | YRS-AT-4874 | Added Requested COVID amount section--%>
                            <table  class="Table_WithoutBorder" width="698" style="background-color:#c9dbed;">
                                <tr>
                                    <td align="left" nowrap>
										<asp:label id="lblRequestedCovidAmountText">Requested COVID Amount</asp:label>&nbsp;
                                        <%-- <asp:label id="lblRequestedCovidAmount" runat="server">0.0</asp:label>--%>
                                        <asp:textbox id="txtCovidAmountRequested" readonly="true" runat="server" width="70px" CssClass="TextBox_Disabled"></asp:textbox>&nbsp;
                                        <asp:button id="btnUpdateRequestedCovidAmount" Text="Update" cssClass="Button_Normal"  runat="server" OnClientClick="javascript:return showChangeRequestedCOVIDAmountDialog();"></asp:button>
                                    </td>
                                    <td align="left" nowrap>
                                        <asp:label id="lblCovidAmountUsed" cssClass="Text_Normal">Amount Used</asp:label>&nbsp;
			                            <asp:textbox id="txtCovidAmountUsed" readonly="true" runat="server" CssClass="TextBox_Disabled" width="70px"></asp:textbox>&nbsp;                                                
                                        <asp:label id="lblCovidAmountAvailable" cssClass="Text_Normal">Amount Available</asp:label>&nbsp;
			                            <asp:textbox id="txtCovidAmountAvailable" readonly="true" runat="server" CssClass="TextBox_Disabled" width="70px"></asp:textbox>
                                        </td>
                                    </tr>
                                </table>
                                <%--END : SC | 05/05/2020 | YRS-AT-4874 | Added Requested COVID amount section--%>  
							<table  class="Table_WithoutBorder" width="698">
								<tr>
	...
	<table class="Table_WithoutBorder" width="100%" id="TablePartialRollOver">
		<tr>
			<td colspan="3" align="left"><asp:label id="LabelPayee1" runat="server" Width="50">Payee1</asp:label>
		...
		<tr>
			...
			<td align="left" style="text-align :left;vertical-align:top" colspan="2"> <asp:Label id="Label7" runat="server" CssClass="Error_Message">NON-COVID</asp:Label></td>
		...
		<tr>
			<td align="left" style="text-align :left;vertical-align:top" colspan="2"> <asp:Label id="Label9" runat="server" CssClass="Error_Message">COVID</asp:Label></td>
			<td align="left" valign="top">
				<asp:textbox id="txtTaxRateC19" runat="server" Width="40"
					cssClass="TextBox_Normal" autoPostback="true"></asp:textbox></td>
			<td align="left" valign="top">
				<asp:textbox id="txtTaxableC19" runat="server"  Width="60" cssClass="TextBox_Normal"></asp:textbox></td>            
			<td align="left" valign="top">
                <asp:textbox id="txtNonTaxableC19" runat="server"  Width="60" cssClass="TextBox_Normal"></asp:textbox> 
			</td>
			<td align="left" valign="top">
				<asp:textbox id="txtTaxC19" runat="server" Width="60" MaxLength="15" autoPostback="true"
					cssClass="TextBox_Normal"></asp:textbox></td>
			<td align="left" valign="top">
				<asp:textbox id="txtNetC19" runat="server"  Width="60" cssClass="TextBox_Normal"></asp:textbox></td>
		</tr>
       
        <%--END : ML | 22.04.20 | YRS-AT-4874 | Display COVID benefit breakup--%>
		<tr>
			<td style="text-align :left;vertical-align:top" width="40px" colspan="2"><asp:label id="Label3" runat="server" visible="false">TD Amount</asp:label></td>
			<td align="left" valign="top">
		...
		<tr>
			<td align="left" style="text-align :left;vertical-align:top" colspan="2"> <asp:Label id="LabelRequiredMinDisbAmount" runat="server" CssClass="Error_Message">RMD</asp:Label></td>
		...
		<tr>
			<td class="Td_InLineBorder" align="left" colSpan="9" height="0"></td>
		</tr>
		<tr>
...
<!--
	<table>
		...
		-->
	</iewc:PageView> </iewc:multipage></TD></TR></TBODY></TABLE><asp:textbox id="TextBox1" runat="server" EnableViewState="true" visible="false"></asp:textbox><asp:placeholder id="MessageBoxPlaceHolder" runat="server"></asp:placeholder>
    <%-- START : SC | 05/05/2020 | YRS-AT-4874 |Added new popup to Change COVID Amount--%>
          <div id="divChangeRequestedCOVIDAmount" runat="server" style="display: none; overflow: auto;">
            <table class="Table_WithoutBorder" cellspacing="0" cellpadding="0" width="95%">
                ...
                <tr>
                    <td align="left">
                        <asp:label id="lblCOVIDamount">COVID Amount</asp:label>&nbsp;&nbsp;
                        <asp:textbox id="txtNewCovidAmount" runat="server" width="120px" cssclass="TextBox_Normal" align="left"></asp:textbox>
                         <%-- START : SN | 05/12/2020 | YRS-AT-4874 |Added Validation--%>
                        <asp:requiredfieldvalidator id ="ReqFieldValidatorNewCovidAmount" runat="server" validationgroup="NewCovidAmountValidationGroup" ControlToValidate="txtNewCovidAmount" Display="Dynamic"  errormessage="*" ></asp:requiredfieldvalidator>
                        
                        <br />
                        <asp:RangeValidator id="RangeValidatorNewCovidAmount" runat="server" ErrorMessage="Requested COVID amount is greater than available COVID amount" ControlToValidate="txtNewCovidAmount"
								MinimumValue="0" Type="Double" validationgroup="NewCovidAmountValidationGroup"></asp:RangeValidator>
                        <br />
                        
                         <%-- END : SN | 05/12/2020 | YRS-AT-4874 |Added Validation--%>
                         </td>
                </tr>                
                <tr>
                    <td align="left">
                        <div style ="font-weight:normal;" >
                            ...
                            Changing the COVID amount will result in screen changes being reset to initial values. You may be required to reselect Rollover options , please verify all details after you change COVID amount.
                            <br />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="right">
                        <asp:button id="btnChangeAmount" Width="80" Text="Update" runat="server" cssClass="Button_Normal" validationgroup="NewCovidAmountValidationGroup"></asp:button>&nbsp;&nbsp;
                        <asp:button class="Button_Normal" ID="btnCancelAmount" Width="80" Text="Cancel" runat="server" OnClientClick="javascript:return CloseChangeRequestedCOVIDAmountDialog();"></asp:button>
                    </td>
                </tr>
            </table>
        </div>
        <%-- END : SC | 05/05/2020 | YRS-AT-4874 |Added new popup to Change COVID Amount--%>
</form>
<script language="javascript">
		if (objRequestAmount){
			document.all("TextboxRequestAmount").focus();
